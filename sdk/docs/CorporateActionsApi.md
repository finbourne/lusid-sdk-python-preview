# lusid.CorporateActionsApi

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**batch_upsert_corporate_actions**](CorporateActionsApi.md#batch_upsert_corporate_actions) | **POST** /api/corporateactionsources/{scope}/{code}/corporateactions | [BETA] Upsert corporate actions
[**create_corporate_action_source**](CorporateActionsApi.md#create_corporate_action_source) | **POST** /api/corporateactionsources | [BETA] Create Corporate Action Source
[**delete_corporate_action_source**](CorporateActionsApi.md#delete_corporate_action_source) | **DELETE** /api/corporateactionsources/{scope}/{code} | [BETA] Delete a corporate action source
[**get_corporate_actions**](CorporateActionsApi.md#get_corporate_actions) | **GET** /api/corporateactionsources/{scope}/{code}/corporateactions | [BETA] Get corporate actions
[**list_corporate_action_sources**](CorporateActionsApi.md#list_corporate_action_sources) | **GET** /api/corporateactionsources | [BETA] Get corporate action sources
...
api_instance = lusid.CorporateActionsApi(lusid.ApiClient(configuration))
...
try:
    ...
    print("Exception when calling CorporateActionsApi->batch_upsert_corporate_actions: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling CorporateActionsApi->create_corporate_action_source: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling CorporateActionsApi->delete_corporate_action_source: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling CorporateActionsApi->list_corporate_action_sources: %s\n" % e)
```
