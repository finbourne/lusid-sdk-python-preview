...
run_date = '2013-10-20T19:20:30+01:00' # datetime | The date of the run associated with the break
version = 56 # int | The version number of the run associated with the break
upsert_reconciliation_break_request = {"leftFields":{"Type":"Buy","Instrument Name":"Legal & General Group plc (Ordinary Shares)","Transaction Price":"8","Units":"100,000.00"},"rightFields":{"Type":"Buy","Instrument Name":"Legal & General Group plc (Ordinary Shares)","Transaction Price":"8","Units":"90,000.00"},"diff":"1,000.00"} # UpsertReconciliationBreakRequest | The definition of the reconciliation break request (optional)
