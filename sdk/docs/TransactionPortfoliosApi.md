...
[**get_portfolio_cash_statements**](TransactionPortfoliosApi.md#get_portfolio_cash_statements) | **GET** /api/transactionportfolios/{scope}/{code}/cashstatements | [EXPERIMENTAL] Get the set of cash flows that occur in a window for the given portfolio instruments.
...
> ResourceListOfInstrumentCashFlow get_portfolio_cash_statements(scope, code, from_effective_at, to_effective_at, as_at=as_at, filter=filter, recipe_id_scope=recipe_id_scope, recipe_id_code=recipe_id_code)
