...
workspace_item_creation_request = {"format":1,"name":"example-name","description":"example-description","content":{"model":"fixed","weights":{"VOD":23,"TESC":45}},"type":"rebalance-config"} # WorkspaceItemCreationRequest | The item to be created. (optional)
...
workspace_item_update_request = {"format":2,"description":"updated-example-description","content":{"model":"fixed","weights":{"VOD":23,"TESC":45}},"type":"rebalance-config"} # WorkspaceItemUpdateRequest | The new item details. (optional)
