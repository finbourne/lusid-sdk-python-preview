...
class InstrumentsApi(object):
    ...
    def delete_instruments(self, request_body, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] DeleteInstruments: Soft or hard delete multiple instruments  # noqa: E501
    ...
    def get_instrument_capabilities(self, identifier, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] GetInstrumentCapabilities: Given an lusid instrument id provides instrument capabilities, outlining features, and, given the model, the capabilities also include supported addresses as well as economic dependencies.  # noqa: E501
        ...
        >>> thread = api.get_instrument_capabilities(identifier, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_instrument_capabilities_with_http_info(identifier, **kwargs)  # noqa: E501

    def get_instrument_capabilities_with_http_info(self, identifier, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] GetInstrumentCapabilities: Given an lusid instrument id provides instrument capabilities, outlining features, and, given the model, the capabilities also include supported addresses as well as economic dependencies.  # noqa: E501
        ...
        >>> thread = api.get_instrument_capabilities_with_http_info(identifier, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_instrument_capabilities" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('identifier' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `identifier` when calling `get_instrument_capabilities`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('identifier' in local_var_params and  # noqa: E501
                                                        len(local_var_params['identifier']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `identifier` when calling `get_instrument_capabilities`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'identifier' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['identifier']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `identifier` when calling `get_instrument_capabilities`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if self.api_client.client_side_validation and ('model' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `model` when calling `get_instrument_capabilities`, length must be less than or equal to `256`")  # noqa: E501
        if self.api_client.client_side_validation and ('model' in local_var_params and  # noqa: E501
                                                        len(local_var_params['model']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `model` when calling `get_instrument_capabilities`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and ('instrument_scope' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `instrument_scope` when calling `get_instrument_capabilities`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('instrument_scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['instrument_scope']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `instrument_scope` when calling `get_instrument_capabilities`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'instrument_scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['instrument_scope']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `instrument_scope` when calling `get_instrument_capabilities`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if self.api_client.client_side_validation and ('recipe_scope' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `recipe_scope` when calling `get_instrument_capabilities`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('recipe_scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['recipe_scope']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_scope` when calling `get_instrument_capabilities`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'recipe_scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['recipe_scope']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_scope` when calling `get_instrument_capabilities`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if self.api_client.client_side_validation and ('recipe_code' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `recipe_code` when calling `get_instrument_capabilities`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('recipe_code' in local_var_params and  # noqa: E501
                                                        len(local_var_params['recipe_code']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_code` when calling `get_instrument_capabilities`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'recipe_code' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['recipe_code']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_code` when calling `get_instrument_capabilities`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def post_instrument_capabilities(self, lusid_instrument, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] PostInstrumentCapabilities: Given an example instrument provides instrument capabilities, outlining features, and, given the model, the capabilities also include supported addresses as well as economic dependencies.  # noqa: E501

        Returns instrument capabilities containing useful information about the instrument and the model. This includes  - features corresponding to the instrument e.g. Optionality:American, Other:InflationLinked  - supported addresses (if model provided) e.g. Valuation/Pv, Valuation/DirtyPriceKey, Valuation/Accrued  - economic dependencies (if model provided) e.g. Cash:USD, Fx:GBP.USD, Rates:GBP.GBPOIS  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.post_instrument_capabilities(lusid_instrument, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.post_instrument_capabilities_with_http_info(lusid_instrument, **kwargs)  # noqa: E501

    def post_instrument_capabilities_with_http_info(self, lusid_instrument, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] PostInstrumentCapabilities: Given an example instrument provides instrument capabilities, outlining features, and, given the model, the capabilities also include supported addresses as well as economic dependencies.  # noqa: E501
        ...
        >>> thread = api.post_instrument_capabilities_with_http_info(lusid_instrument, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_instrument_capabilities" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('lusid_instrument' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `lusid_instrument` when calling `post_instrument_capabilities`")  # noqa: E501

        if self.api_client.client_side_validation and ('model' in local_var_params and  # noqa: E501
                                                        len(local_var_params['model']) > 256):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `model` when calling `post_instrument_capabilities`, length must be less than or equal to `256`")  # noqa: E501
        if self.api_client.client_side_validation and ('model' in local_var_params and  # noqa: E501
                                                        len(local_var_params['model']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `model` when calling `post_instrument_capabilities`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and ('recipe_scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['recipe_scope']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_scope` when calling `post_instrument_capabilities`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('recipe_scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['recipe_scope']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_scope` when calling `post_instrument_capabilities`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'recipe_scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['recipe_scope']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_scope` when calling `post_instrument_capabilities`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if self.api_client.client_side_validation and ('recipe_code' in local_var_params and  # noqa: E501
                                                        len(local_var_params['recipe_code']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_code` when calling `post_instrument_capabilities`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('recipe_code' in local_var_params and  # noqa: E501
                                                        len(local_var_params['recipe_code']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_code` when calling `post_instrument_capabilities`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'recipe_code' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['recipe_code']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_code` when calling `post_instrument_capabilities`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        collection_formats = {}
