...
class InstrumentsApi(object):
    ...
    def delete_instruments(self, request_body, **kwargs):  # noqa: E501
        ...
        :type request_body: list[str]
        :param delete_mode: The delete mode to use, currently only 'soft' is supported, if left unspecified, this argument is optional.
    ...
    def get_instrument_payment_diary(self, identifier_type, identifier, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_instrument_payment_diary(identifier_type, identifier, async_req=True)
        >>> result = thread.get()
        ...
        :type identifier: str
        :param recipe_scope: The scope of the valuation recipe being used to generate the payment diary
        :type recipe_scope: str
        :param recipe_code: The code of the valuation recipe being used to generate the payment diary
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_instrument_payment_diary_with_http_info(identifier_type, identifier, **kwargs)  # noqa: E501

    def get_instrument_payment_diary_with_http_info(self, identifier_type, identifier, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] GetInstrumentPaymentDiary: Get instrument payment diary  # noqa: E501
        ...
        >>> thread = api.get_instrument_payment_diary_with_http_info(identifier_type, identifier, async_req=True)
        >>> result = thread.get()
