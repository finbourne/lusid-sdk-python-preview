...
class InstrumentsApi(object):
    ...
    def get_instrument_properties(self, identifier_type, identifier, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Get instrument properties  # noqa: E501

        List all the properties of a single instrument.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param str identifier_type: The identifier being supplied e.g. \"Figi\". (required)
        :param str identifier: The value of the identifier for the requested instrument. (required)
        :param str effective_at: The effective datetime or cut label at which to list the instrument's properties. Defaults to the current LUSID system datetime if not specified.
        :param datetime as_at: The asAt datetime at which to list the instrument's properties. Defaults to return the latest version of each property if not specified.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def get_instrument_properties_with_http_info(self, identifier_type, identifier, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InstrumentProperties, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        all_params = ['identifier_type', 'identifier', 'effective_at', 'as_at']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='InstrumentProperties',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def get_instrument_property_time_series(self, identifier_type, identifier, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Get the time series of an instrument property  # noqa: E501

        List the complete time series of an instrument property, ordered by effective datetime.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param str identifier_type: The identifier type of the instrument, e.g., \"Figi\" (required)
        :param str identifier: The identifier of the instrument to delete properties from. (required)
        :param str property_key: The property key of the property that will have its history shown.
        :param str identifier_effective_at: The effective datetime at which to list the property history. Defaults to the current LUSID system datetime if not specified.
        ...
        :param str page: The pagination token to use to continue listing properties from a previous call to get property timeseries.              This value is returned from the previous call. If a pagination token is provided the filter, effectiveAt, and asAt fields              must not have changed since the original request.
