...
class InstrumentsApi(object):
    ...
    def delete_instrument(self, identifier_type, identifier, **kwargs):  # noqa: E501
        """Delete instrument  # noqa: E501

        Attempt to delete one or more \"client\" instruments.    The response will include those instruments that could not be deleted (as well as any available details).                It is important to always check the 'Failed' set for any unsuccessful results.  # noqa: E501
        ...
        :param str identifier_type: The type of identifier being supplied (required)
        :param str identifier: The instrument identifier (required)
    ...
    def get_instrument(self, identifier_type, identifier, **kwargs):  # noqa: E501
        """Get instrument definition  # noqa: E501

        Get an individual instrument by the one of its unique instrument identifiers. Optionally, it is possible to decorate each instrument with specified property data.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool: execute request asynchronously
        :param str identifier_type: The type of identifier being supplied (required)
        :param str identifier: The identifier of the requested instrument (required)
        :param str effective_at: Optional. The effective date of the query
        :param datetime as_at: Optional. The AsAt date of the query
        :param list[str] instrument_property_keys: Optional. Keys of the properties to be decorated on to the instrument
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def get_instrument_with_http_info(self, identifier_type, identifier, **kwargs):  # noqa: E501
        ...
        all_params = ['identifier_type', 'identifier', 'effective_at', 'as_at', 'instrument_property_keys']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_instrument_identifiers(self, **kwargs):  # noqa: E501
        """Get allowable instrument identifiers  # noqa: E501

        Returns a collection of instrument identifier type descriptors. Each descriptor specifies the properties  of a particular instrument identifier - its name, its cardinality (whether or not multiple instruments can  share the same identifier value), and its corresponding PropertyKey.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_instrument_identifiers(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_instrument_identifiers_with_http_info(**kwargs)  # noqa: E501

    def get_instrument_identifiers_with_http_info(self, **kwargs):  # noqa: E501
        """Get allowable instrument identifiers  # noqa: E501

        Returns a collection of instrument identifier type descriptors. Each descriptor specifies the properties  of a particular instrument identifier - its name, its cardinality (whether or not multiple instruments can  share the same identifier value), and its corresponding PropertyKey.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_instrument_identifiers_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_instrument_identifiers" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
    ...
    def get_instruments(self, identifier_type, identifiers, **kwargs):  # noqa: E501
        ...
        Get a collection of instruments by a set of identifiers. Optionally, it is possible to decorate each instrument with specified property data.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool: execute request asynchronously
        :param str identifier_type: The type of identifiers being supplied (required)
        :param list[str] identifiers: The identifiers of the instruments to get (required)
        :param str effective_at: Optional. The effective date of the request
        :param datetime as_at: Optional. The as at date of the request
        :param list[str] instrument_property_keys: Optional. Keys of the properties to be decorated on to the instrument
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
    ...
    def get_instruments_with_http_info(self, identifier_type, identifiers, **kwargs):  # noqa: E501
        ...
        all_params = ['identifier_type', 'identifiers', 'effective_at', 'as_at', 'instrument_property_keys']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def list_instruments(self, **kwargs):  # noqa: E501
        """Get all of the currently mastered instruments in LUSID  # noqa: E501

        Lists all instruments that have been mastered within LUSID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool: execute request asynchronously
        :param datetime as_at: Optional. The AsAt time
        :param datetime effective_at: Optional. The effective date of the query
        :param str page: Optional. The pagination token to continue listing instruments. This value is returned from a previous call to ListInstruments.  If this is set, then the sortBy, filter, effectiveAt, and asAt fields must not have changed. Also, if set, a start value cannot be set.
        ...
        :param str filter: Optional. Expression to filter the result set - the default filter returns only instruments in the Active state
        :param list[str] instrument_property_keys: Optional. Keys of the properties to be decorated on to the instrument
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
    ...
    def list_instruments_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(ResourceListOfInstrument, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ResourceListOfInstrument',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def update_instrument_identifier(self, identifier_type, identifier, **kwargs):  # noqa: E501
        """Update instrument identifier  # noqa: E501

        Adds, updates, or removes an identifier on an instrument  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_instrument_identifier(identifier_type, identifier, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str identifier_type: The type of identifier being supplied (required)
        :param str identifier: The instrument identifier (required)
        :param UpdateInstrumentIdentifierRequest request: The identifier to add, update, or remove
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_instrument_identifier_with_http_info(identifier_type, identifier, **kwargs)  # noqa: E501

    def update_instrument_identifier_with_http_info(self, identifier_type, identifier, **kwargs):  # noqa: E501
        """Update instrument identifier  # noqa: E501

        Adds, updates, or removes an identifier on an instrument  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_instrument_identifier_with_http_info(identifier_type, identifier, async_req=True)
        >>> result = thread.get()
    ...
    def upsert_instruments(self, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.upsert_instruments_with_http_info(**kwargs)  # noqa: E501

    def upsert_instruments_with_http_info(self, **kwargs):  # noqa: E501
        """Upsert instruments  # noqa: E501

        Attempt to master one or more instruments in LUSID's instrument master. Each instrument is keyed by some unique key. This key is unimportant, and serves only as a method to identify created instruments in the response.    The response will return both the collection of successfully created instruments, as well as those that were rejected and why their creation failed. They will be keyed against the key supplied in the  request.                It is important to always check the 'Failed' set for any unsuccessful results.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_instruments_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'requests' in local_var_params:
            body_params = local_var_params['requests']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['text/plain', 'application/json', 'text/json'])  # noqa: E501
    ...
    def upsert_instruments_properties(self, **kwargs):  # noqa: E501
        """Upsert instrument properties  # noqa: E501

        Attempt to upsert property data for one or more instruments, properties, and effective dates.    The response will include the details of any failures that occurred during data storage.                It is important to always check the 'Failed' collection for any unsuccessful results.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_instruments_properties(async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param list[UpsertInstrumentPropertyRequest] instrument_properties: The instrument property data
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.upsert_instruments_properties_with_http_info(**kwargs)  # noqa: E501

    def upsert_instruments_properties_with_http_info(self, **kwargs):  # noqa: E501
        """Upsert instrument properties  # noqa: E501

        Attempt to upsert property data for one or more instruments, properties, and effective dates.    The response will include the details of any failures that occurred during data storage.                It is important to always check the 'Failed' collection for any unsuccessful results.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_instruments_properties_with_http_info(async_req=True)
        >>> result = thread.get()
