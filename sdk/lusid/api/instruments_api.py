...
class InstrumentsApi(object):
    ...
    def get_all_possible_features(self, instrument_type, **kwargs):  # noqa: E501
    ...
    def get_all_possible_features_with_http_info(self, instrument_type, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] GetAllPossibleFeatures: Provides list of all possible features for instrument type.  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_all_possible_features" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('instrument_type' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `instrument_type` when calling `get_all_possible_features`")  # noqa: E501

        if self.api_client.client_side_validation and ('instrument_type' in local_var_params and  # noqa: E501
                                                        len(local_var_params['instrument_type']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `instrument_type` when calling `get_all_possible_features`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('instrument_type' in local_var_params and  # noqa: E501
                                                        len(local_var_params['instrument_type']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `instrument_type` when calling `get_all_possible_features`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'instrument_type' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['instrument_type']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `instrument_type` when calling `get_all_possible_features`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_existing_instrument_capabilities(self, identifier, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_existing_instrument_capabilities_with_http_info(identifier, **kwargs)  # noqa: E501

    def get_existing_instrument_capabilities_with_http_info(self, identifier, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] GetExistingInstrumentCapabilities: Retrieve capabilities of an existing instrument identified by LUID. These include instrument features, and if model is provided it also includes supported address keys and economic dependencies.  Given an lusid instrument id provides instrument capabilities, outlining features, and, given the model, the capabilities also include supported addresses as well as economic dependencies.  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_existing_instrument_capabilities" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'identifier' is set
        if self.api_client.client_side_validation and ('identifier' not in local_var_params or  # noqa: E501
                                                        local_var_params['identifier'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `identifier` when calling `get_existing_instrument_capabilities`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('identifier' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `identifier` when calling `get_existing_instrument_capabilities`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('identifier' in local_var_params and  # noqa: E501
                                                        len(local_var_params['identifier']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `identifier` when calling `get_existing_instrument_capabilities`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'identifier' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['identifier']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `identifier` when calling `get_existing_instrument_capabilities`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if self.api_client.client_side_validation and ('model' in local_var_params and  # noqa: E501
                                                        len(local_var_params['model']) > 256):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `model` when calling `get_existing_instrument_capabilities`, length must be less than or equal to `256`")  # noqa: E501
        if self.api_client.client_side_validation and ('model' in local_var_params and  # noqa: E501
                                                        len(local_var_params['model']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `model` when calling `get_existing_instrument_capabilities`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and ('instrument_scope' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `instrument_scope` when calling `get_existing_instrument_capabilities`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('instrument_scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['instrument_scope']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `instrument_scope` when calling `get_existing_instrument_capabilities`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'instrument_scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['instrument_scope']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `instrument_scope` when calling `get_existing_instrument_capabilities`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if self.api_client.client_side_validation and ('recipe_scope' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `recipe_scope` when calling `get_existing_instrument_capabilities`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('recipe_scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['recipe_scope']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_scope` when calling `get_existing_instrument_capabilities`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'recipe_scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['recipe_scope']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_scope` when calling `get_existing_instrument_capabilities`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if self.api_client.client_side_validation and ('recipe_code' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `recipe_code` when calling `get_existing_instrument_capabilities`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('recipe_code' in local_var_params and  # noqa: E501
                                                        len(local_var_params['recipe_code']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_code` when calling `get_existing_instrument_capabilities`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'recipe_code' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['recipe_code']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_code` when calling `get_existing_instrument_capabilities`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_instrument_payment_diary(self, identifier_type, identifier, recipe_scope, recipe_code, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_instrument_payment_diary_with_http_info(identifier_type, identifier, recipe_scope, recipe_code, **kwargs)  # noqa: E501

    def get_instrument_payment_diary_with_http_info(self, identifier_type, identifier, recipe_scope, recipe_code, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] GetInstrumentPaymentDiary: Get instrument payment diary  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_instrument_payment_diary" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'identifier_type' is set
        if self.api_client.client_side_validation and ('identifier_type' not in local_var_params or  # noqa: E501
                                                        local_var_params['identifier_type'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `identifier_type` when calling `get_instrument_payment_diary`")  # noqa: E501
        # verify the required parameter 'identifier' is set
        if self.api_client.client_side_validation and ('identifier' not in local_var_params or  # noqa: E501
                                                        local_var_params['identifier'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `identifier` when calling `get_instrument_payment_diary`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('recipe_scope' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `recipe_scope` when calling `get_instrument_payment_diary`")  # noqa: E501
        # verify the required parameter 'recipe_code' is set
        if self.api_client.client_side_validation and ('recipe_code' not in local_var_params or  # noqa: E501
                                                        local_var_params['recipe_code'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `recipe_code` when calling `get_instrument_payment_diary`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('identifier_type' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `identifier_type` when calling `get_instrument_payment_diary`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('identifier_type' in local_var_params and  # noqa: E501
                                                        len(local_var_params['identifier_type']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `identifier_type` when calling `get_instrument_payment_diary`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'identifier_type' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['identifier_type']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `identifier_type` when calling `get_instrument_payment_diary`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if self.api_client.client_side_validation and ('identifier' in local_var_params and  # noqa: E501
                                                        len(local_var_params['identifier']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `identifier` when calling `get_instrument_payment_diary`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('identifier' in local_var_params and  # noqa: E501
                                                        len(local_var_params['identifier']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `identifier` when calling `get_instrument_payment_diary`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'identifier' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['identifier']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `identifier` when calling `get_instrument_payment_diary`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if self.api_client.client_side_validation and ('recipe_scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['recipe_scope']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_scope` when calling `get_instrument_payment_diary`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('recipe_scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['recipe_scope']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_scope` when calling `get_instrument_payment_diary`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'recipe_scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['recipe_scope']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_scope` when calling `get_instrument_payment_diary`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if self.api_client.client_side_validation and ('recipe_code' in local_var_params and  # noqa: E501
                                                        len(local_var_params['recipe_code']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_code` when calling `get_instrument_payment_diary`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('recipe_code' in local_var_params and  # noqa: E501
                                                        len(local_var_params['recipe_code']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_code` when calling `get_instrument_payment_diary`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'recipe_code' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['recipe_code']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_code` when calling `get_instrument_payment_diary`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if self.api_client.client_side_validation and ('scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['scope']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `scope` when calling `get_instrument_payment_diary`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['scope']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `scope` when calling `get_instrument_payment_diary`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['scope']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `scope` when calling `get_instrument_payment_diary`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def query_instrument_capabilities(self, lusid_instrument, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.query_instrument_capabilities_with_http_info(lusid_instrument, **kwargs)  # noqa: E501

    def query_instrument_capabilities_with_http_info(self, lusid_instrument, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] QueryInstrumentCapabilities: Query capabilities of a particular instrument in advance of creating it. These include instrument features, and if model is provided it also includes supported address keys and economic dependencies.  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method query_instrument_capabilities" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'lusid_instrument' is set
        if self.api_client.client_side_validation and ('lusid_instrument' not in local_var_params or  # noqa: E501
                                                        local_var_params['lusid_instrument'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `lusid_instrument` when calling `query_instrument_capabilities`")  # noqa: E501

        if self.api_client.client_side_validation and ('model' in local_var_params and  # noqa: E501
                                                        len(local_var_params['model']) > 256):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `model` when calling `query_instrument_capabilities`, length must be less than or equal to `256`")  # noqa: E501
        if self.api_client.client_side_validation and ('model' in local_var_params and  # noqa: E501
                                                        len(local_var_params['model']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `model` when calling `query_instrument_capabilities`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and ('recipe_scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['recipe_scope']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_scope` when calling `query_instrument_capabilities`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('recipe_scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['recipe_scope']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_scope` when calling `query_instrument_capabilities`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'recipe_scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['recipe_scope']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_scope` when calling `query_instrument_capabilities`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if self.api_client.client_side_validation and ('recipe_code' in local_var_params and  # noqa: E501
                                                        len(local_var_params['recipe_code']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_code` when calling `query_instrument_capabilities`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('recipe_code' in local_var_params and  # noqa: E501
                                                        len(local_var_params['recipe_code']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_code` when calling `query_instrument_capabilities`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'recipe_code' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['recipe_code']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_code` when calling `query_instrument_capabilities`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        collection_formats = {}
        ...
        body_params = None
        if 'lusid_instrument' in local_var_params:
            body_params = local_var_params['lusid_instrument']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['text/plain', 'application/json', 'text/json'])  # noqa: E501
