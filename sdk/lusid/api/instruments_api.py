...
class InstrumentsApi(object):
    ...
    def delete_instrument_properties(self, identifier_type, identifier, request_body, **kwargs):  # noqa: E501
        ...
        :type identifier_type: str
        :param identifier: The identifier of the instrument to delete properties from. (required)
        :type identifier: str
        :param request_body: The property keys of the properties to be deleted from the instrument. Only properties in the  Finbourne.WebApi.Interface.Dto.PropertyDomain.Instrument domain can be supplied. (required)
        :type request_body: list[str]
        :param effective_at: The effective date to delete the properties from. Note that this is only valid to set if the properties being deleted  are defined to be Finbourne.WebApi.Interface.Dto.PropertyLifeTime.TimeVariant, otherwise this value must not be set.
