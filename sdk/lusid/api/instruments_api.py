...
class InstrumentsApi(object):
    ...
    def get_instrument(self, identifier_type, identifier, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Get instrument  # noqa: E501
        ...
        :param str effective_at: The effective datetime at which to retrieve the instrument definition.              Defaults to the current LUSID system datetime if not specified.
        ...
        :param list[str] instrument_property_keys: A list of property keys from the \"Instrument\" domain to decorate onto the instrument.              These take the format {domain}/{scope}/{code} e.g. \"Instrument/system/Name\".
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def get_instrument_identifiers(self, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Get instrument identifiers  # noqa: E501

        Get the allowable instrument identifiers and their descriptions.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_instruments(self, identifier_type, identifiers, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Get instruments  # noqa: E501
        ...
        :param str effective_at: The effective datetime at which to retrieve the instrument definitions.              Defaults to the current LUSID system datetime if not specified.
    ...
    def list_instruments(self, **kwargs):  # noqa: E501
        ...
        List all the instruments that have been mastered in the LUSID instrument master.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param str effective_at: The effective datetime at which to list the instruments.              Defaults to the current LUSID system datetime if not specified.
    ...
    def upsert_instruments(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param dict(str, InstrumentDefinition) requests: The definitions of the instruments to update or insert.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def upsert_instruments_properties(self, instrument_properties, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Upsert instruments properties  # noqa: E501
