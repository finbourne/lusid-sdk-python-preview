...
class InstrumentsApi(object):
    ...
    def delete_instrument_properties(self, identifier_type, identifier, request_body, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Delete instrument properties  # noqa: E501

        Delete a collection of properties from a particular instrument.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param str identifier_type: The unique identifier type to search, for example 'Figi'. (required)
        :param str identifier: An <i>identifierType</i> value to use to identify the instrument, for example 'BBG000BLNNV0'. (required)
        :param list[str] request_body: A list of property keys from the 'Instruments' domain whose properties to delete. (required)
        :param str effective_at: The effective date to delete time-variant properties from. Do not specify this parameter              if any of the properties to delete are perpetual.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def get_instrument_properties(self, identifier_type, identifier, **kwargs):  # noqa: E501
        ...
        :param datetime as_at: The asAt datetime at which to list the instrument's properties. Defaults to returning              the latest version of each property if not specified.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def list_instrument_properties(self, identifier_type, identifier, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Get instrument properties (with Pagination)  # noqa: E501
        ...
        :param int limit: When paginating, limit the results per page to this number.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def list_instrument_properties_with_http_info(self, identifier_type, identifier, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(ResourceListOfProperty, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        all_params = ['identifier_type', 'identifier', 'effective_at', 'as_at', 'page', 'limit']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ResourceListOfProperty',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
