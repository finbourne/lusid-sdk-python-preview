...
class InstrumentsApi(object):
    ...
    def get_instrument_property_time_series(self, identifier_type, identifier, **kwargs):  # noqa: E501
        ...
        :param str identifier_effective_at: The effective datetime of the instrument identifier. The property history of a property belonging to the associated instrument is listed. Defaults to the current LUSID system datetime if not specified.
