...
class AggregationApi(object):
    ...
    def generate_configuration_recipe_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `scope` when calling `generate_configuration_recipe`, length must be greater than or equal to `0`")  # noqa: E501
        ...
        if ('code' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `code` when calling `generate_configuration_recipe`, length must be greater than or equal to `0`")  # noqa: E501
    ...
    def get_nested_aggregation_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
                len(local_var_params['scope']) < 0):
            raise ApiValueError("Invalid value for parameter `scope` when calling `get_nested_aggregation`, length must be greater than or equal to `0`")  # noqa: E501
        if 'scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['scope']):  # noqa: E501
        ...
        if ('code' in local_var_params and
                len(local_var_params['code']) < 0):
            raise ApiValueError("Invalid value for parameter `code` when calling `get_nested_aggregation`, length must be greater than or equal to `0`")  # noqa: E501
        if 'code' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['code']):  # noqa: E501
