...
class AggregationApi(object):
    ...
    def supported_analytics_internal(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.supported_analytics_internal(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.supported_analytics_internal_with_http_info(**kwargs)  # noqa: E501

    def supported_analytics_internal_with_http_info(self, **kwargs):  # noqa: E501
        """[INTERNAL] SupportedAnalyticsInternal: Generates a matrix of analytics features supported by LUSID.  # noqa: E501
        ...
        >>> thread = api.supported_analytics_internal_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object, the HTTP status code, and the headers.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: (Aggregation, int, HTTPHeaderDict)
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method supported_analytics_internal" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        body_params = None
        if 'supported_analytics_internal_request' in local_var_params:
            body_params = local_var_params['supported_analytics_internal_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['text/plain', 'application/json', 'text/json'])  # noqa: E501
