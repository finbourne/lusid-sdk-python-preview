...
class AggregationApi(object):
    ...
    def get_aggregation_by_group(self, scope, code, **kwargs):  # noqa: E501
        """Aggregate data in a portfolio group  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_aggregation_by_group_with_http_info(scope, code, **kwargs)  # noqa: E501
            return data
    ...
    def get_aggregation_by_portfolio(self, scope, code, **kwargs):  # noqa: E501
        """Aggregate data in a portfolio  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_aggregation_by_portfolio_with_http_info(scope, code, **kwargs)  # noqa: E501
            return data
    ...
    def get_aggregation_by_result_set(self, scope, results_key, **kwargs):  # noqa: E501
        """Aggregate using result data  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_aggregation_by_result_set_with_http_info(scope, results_key, **kwargs)  # noqa: E501
            return data
    ...
    def get_nested_aggregation_by_group(self, scope, code, **kwargs):  # noqa: E501
        """Aggregate data in a portfolio group, as nested  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_nested_aggregation_by_group_with_http_info(scope, code, **kwargs)  # noqa: E501
            return data
