...
class AggregationApi(object):
    ...
    def generate_configuration_recipe_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `scope` when calling `generate_configuration_recipe`, length must be less than or equal to `100`")  # noqa: E501
        if ('scope' in local_var_params and
        ...
        if ('code' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `code` when calling `generate_configuration_recipe`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
    ...
    def get_nested_aggregation_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
                len(local_var_params['scope']) > 100):
            raise ApiValueError("Invalid value for parameter `scope` when calling `get_nested_aggregation`, length must be less than or equal to `100`")  # noqa: E501
        if ('scope' in local_var_params and
                len(local_var_params['scope']) < 1):
        ...
        if ('code' in local_var_params and
                len(local_var_params['code']) > 100):
            raise ApiValueError("Invalid value for parameter `code` when calling `get_nested_aggregation`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
                len(local_var_params['code']) < 1):
