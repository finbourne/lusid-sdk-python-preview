...
class AggregationApi(object):
    ...
    def get_aggregation(self, scope, code, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Aggregate data in a portfolio or portfolio group  Deprecated: Please use the GetValuation endpoint. It is aimed at a simpler set of requirements now deemed stable.  Aggregation will shortly be modified to include experimental features such as Simulation and XVA  # noqa: E501
    ...
    def get_nested_aggregation(self, scope, code, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Aggregate data in a portfolio or portfolio group, as nested                Deprecated: Endpoint is being retired. The nested functionality is supported on the valuation endpoint through use of an 'include subtotals' flag.  # noqa: E501
