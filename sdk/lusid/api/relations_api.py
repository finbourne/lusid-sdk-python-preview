...
class RelationsApi(object):
    ...
    def create_relation_with_http_info(self, scope, code, create_relation_request, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `scope` when calling `create_relation`, length must be less than or equal to `100`")  # noqa: E501
        if ('scope' in local_var_params and
        ...
        if ('code' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `code` when calling `create_relation`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
