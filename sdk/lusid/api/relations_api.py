...
class RelationsApi(object):
    ...
    def create_relation(self, scope, code, create_relation_request, **kwargs):  # noqa: E501
        ...
        :param str scope: Scope of the relation to create. (required)
        :param str code: Code of the relation to create. (required)
    ...
    def create_relation_with_http_info(self, scope, code, create_relation_request, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `scope` when calling `create_relation`, length must be greater than or equal to `0`")  # noqa: E501
        ...
        if ('code' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `code` when calling `create_relation`, length must be greater than or equal to `0`")  # noqa: E501
