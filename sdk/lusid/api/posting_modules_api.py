...
class PostingModulesApi(object):
    ...
    def delete_posting_module(self, scope, code, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] DeletePostingModule: Delete a PostingModule.  # noqa: E501

        Delete the given PostingModule.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def update_posting_module_details(self, scope, code, posting_module_details, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] UpdatePostingModuleDetails: Update a Posting Module details  # noqa: E501

        Update the given Posting Module details.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_posting_module_details(scope, code, posting_module_details, async_req=True)
        >>> result = thread.get()
        ...
        :type code: str
        :param posting_module_details: The details to be updated for the posting module. (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_posting_module_details_with_http_info(scope, code, posting_module_details, **kwargs)  # noqa: E501

    def update_posting_module_details_with_http_info(self, scope, code, posting_module_details, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] UpdatePostingModuleDetails: Update a Posting Module details  # noqa: E501
        ...
        >>> thread = api.update_posting_module_details_with_http_info(scope, code, posting_module_details, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_posting_module_details" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'scope' is set
        if self.api_client.client_side_validation and ('scope' not in local_var_params or  # noqa: E501
                                                        local_var_params['scope'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `scope` when calling `update_posting_module_details`")  # noqa: E501
        # verify the required parameter 'code' is set
        if self.api_client.client_side_validation and ('code' not in local_var_params or  # noqa: E501
                                                        local_var_params['code'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `code` when calling `update_posting_module_details`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('posting_module_details' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `posting_module_details` when calling `update_posting_module_details`")  # noqa: E501

        if self.api_client.client_side_validation and ('scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['scope']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `scope` when calling `update_posting_module_details`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['scope']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `scope` when calling `update_posting_module_details`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['scope']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `scope` when calling `update_posting_module_details`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if self.api_client.client_side_validation and ('code' in local_var_params and  # noqa: E501
                                                        len(local_var_params['code']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `code` when calling `update_posting_module_details`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('code' in local_var_params and  # noqa: E501
                                                        len(local_var_params['code']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `code` when calling `update_posting_module_details`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'code' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['code']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `code` when calling `update_posting_module_details`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/api/postingmodule/{scope}/{code}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_posting_module_rules(self, scope, code, posting_module_rule, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] UpdatePostingModuleRules: Update a Posting Modules rules  # noqa: E501

        Update the given Posting Modules rules, this will replace the existing set of rules for the posting module.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_posting_module_rules(scope, code, posting_module_rule, async_req=True)
        >>> result = thread.get()
        ...
        :param code: The code of the Posting Module to be updated. Together with the scope this uniquely identifies the Posting Module. (required)
        :type code: str
        :param posting_module_rule: The new rule set to be updated for the posting module. (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_posting_module_rules_with_http_info(scope, code, posting_module_rule, **kwargs)  # noqa: E501

    def update_posting_module_rules_with_http_info(self, scope, code, posting_module_rule, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] UpdatePostingModuleRules: Update a Posting Modules rules  # noqa: E501
        ...
        >>> thread = api.update_posting_module_rules_with_http_info(scope, code, posting_module_rule, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_posting_module_rules" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'scope' is set
        if self.api_client.client_side_validation and ('scope' not in local_var_params or  # noqa: E501
                                                        local_var_params['scope'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `scope` when calling `update_posting_module_rules`")  # noqa: E501
        # verify the required parameter 'code' is set
        if self.api_client.client_side_validation and ('code' not in local_var_params or  # noqa: E501
                                                        local_var_params['code'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `code` when calling `update_posting_module_rules`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('posting_module_rule' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `posting_module_rule` when calling `update_posting_module_rules`")  # noqa: E501

        if self.api_client.client_side_validation and ('scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['scope']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `scope` when calling `update_posting_module_rules`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['scope']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `scope` when calling `update_posting_module_rules`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['scope']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `scope` when calling `update_posting_module_rules`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if self.api_client.client_side_validation and ('code' in local_var_params and  # noqa: E501
                                                        len(local_var_params['code']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `code` when calling `update_posting_module_rules`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('code' in local_var_params and  # noqa: E501
                                                        len(local_var_params['code']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `code` when calling `update_posting_module_rules`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'code' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['code']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `code` when calling `update_posting_module_rules`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/api/postingmodule/{scope}/{code}/postingrules', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
