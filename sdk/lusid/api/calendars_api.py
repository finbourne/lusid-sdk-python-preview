...
class CalendarsApi(object):
    ...
    def add_date_to_calendar_with_http_info(self, scope, code, create_date_request, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `scope` when calling `add_date_to_calendar`, length must be less than or equal to `100`")  # noqa: E501
        if ('scope' in local_var_params and
        ...
        if ('code' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `code` when calling `add_date_to_calendar`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
    ...
    def delete_calendar_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
                len(local_var_params['scope']) > 100):
            raise ApiValueError("Invalid value for parameter `scope` when calling `delete_calendar`, length must be less than or equal to `100`")  # noqa: E501
        if ('scope' in local_var_params and
                len(local_var_params['scope']) < 1):
        ...
        if ('code' in local_var_params and
                len(local_var_params['code']) > 100):
            raise ApiValueError("Invalid value for parameter `code` when calling `delete_calendar`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
                len(local_var_params['code']) < 1):
    ...
    def delete_date_from_calendar_with_http_info(self, scope, code, date_id, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
                len(local_var_params['scope']) > 100):
            raise ApiValueError("Invalid value for parameter `scope` when calling `delete_date_from_calendar`, length must be less than or equal to `100`")  # noqa: E501
        if ('scope' in local_var_params and
                len(local_var_params['scope']) < 1):
        ...
        if ('code' in local_var_params and
                len(local_var_params['code']) > 100):
            raise ApiValueError("Invalid value for parameter `code` when calling `delete_date_from_calendar`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
                len(local_var_params['code']) < 1):
    ...
    def get_calendar_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
                len(local_var_params['scope']) > 100):
            raise ApiValueError("Invalid value for parameter `scope` when calling `get_calendar`, length must be less than or equal to `100`")  # noqa: E501
        if ('scope' in local_var_params and
                len(local_var_params['scope']) < 1):
        ...
        if ('code' in local_var_params and
                len(local_var_params['code']) > 100):
            raise ApiValueError("Invalid value for parameter `code` when calling `get_calendar`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
                len(local_var_params['code']) < 1):
    ...
    def get_dates_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
                len(local_var_params['scope']) > 100):
            raise ApiValueError("Invalid value for parameter `scope` when calling `get_dates`, length must be less than or equal to `100`")  # noqa: E501
        if ('scope' in local_var_params and
                len(local_var_params['scope']) < 1):
        ...
        if ('code' in local_var_params and
                len(local_var_params['code']) > 100):
            raise ApiValueError("Invalid value for parameter `code` when calling `get_dates`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
                len(local_var_params['code']) < 1):
    ...
    def is_business_date_time_with_http_info(self, date_time, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
                len(local_var_params['scope']) > 100):
            raise ApiValueError("Invalid value for parameter `scope` when calling `is_business_date_time`, length must be less than or equal to `100`")  # noqa: E501
        if ('scope' in local_var_params and
                len(local_var_params['scope']) < 1):
        ...
        if ('code' in local_var_params and
                len(local_var_params['code']) > 100):
            raise ApiValueError("Invalid value for parameter `code` when calling `is_business_date_time`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
                len(local_var_params['code']) < 1):
    ...
    def list_calendars_with_http_info(self, scope, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
                len(local_var_params['scope']) > 100):
            raise ApiValueError("Invalid value for parameter `scope` when calling `list_calendars`, length must be less than or equal to `100`")  # noqa: E501
        if ('scope' in local_var_params and
                len(local_var_params['scope']) < 1):
            raise ApiValueError("Invalid value for parameter `scope` when calling `list_calendars`, length must be greater than or equal to `1`")  # noqa: E501
        if 'scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['scope']):  # noqa: E501
    ...
    def update_calendar_with_http_info(self, scope, code, update_calendar_request, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
                len(local_var_params['scope']) > 100):
            raise ApiValueError("Invalid value for parameter `scope` when calling `update_calendar`, length must be less than or equal to `100`")  # noqa: E501
        if ('scope' in local_var_params and
                len(local_var_params['scope']) < 1):
        ...
        if ('code' in local_var_params and
                len(local_var_params['code']) > 100):
            raise ApiValueError("Invalid value for parameter `code` when calling `update_calendar`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
                len(local_var_params['code']) < 1):
