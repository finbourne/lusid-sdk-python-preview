...
class CalendarsApi(object):
    ...
    def add_date_to_calendar_with_http_info(self, scope, code, create_date_request, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/calendars/generic/{scope}/{code}/dates', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def is_business_date_time(self, date_time, scope, code, **kwargs):  # noqa: E501
        ...
        A Business DateTime is defined as a point in time that: <br />      * Does not represent a day that overlaps with the calendars WeekendMask <br />      * If the calendar is a \"Holiday Calendar\" Does not overlap with any dates in the calendar <br />      * If the calendar is a \"TradingHours Calendar\" Does overlap with a date in the calendar <br />                All dates specified must be UTC and the upper bound of a calendar is not inclusive <br />  e.g. From: 2020-12-25-00-00-00        To: 2020-12-26-00-00-00 <br />  IsBusinessDay(2020-12-26-00-00-00) == false  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def list_calendars(self, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] List all calenders  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str scope: Scope of the calendars
