...
class AllocationsApi(object):
    ...
    def get_allocation_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `scope` when calling `get_allocation`, length must be greater than or equal to `0`")  # noqa: E501
        ...
        if ('code' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `code` when calling `get_allocation`, length must be greater than or equal to `0`")  # noqa: E501
