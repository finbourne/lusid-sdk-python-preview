...
class AllocationsApi(object):
    ...
    def delete_allocations(self, resource_id, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Delete Allocations.  # noqa: E501

        Use this method to delete a collection of Allocations, each defined by ResourceId. Each delete will be attempted  independently, and the method will return lists of successful and failed attempts.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_allocations(resource_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param list[ResourceId] resource_id: The IDs of the allocations to delete. (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_allocations_with_http_info(resource_id, **kwargs)  # noqa: E501

    def delete_allocations_with_http_info(self, resource_id, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Delete Allocations.  # noqa: E501

        Use this method to delete a collection of Allocations, each defined by ResourceId. Each delete will be attempted  independently, and the method will return lists of successful and failed attempts.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_allocations_with_http_info(resource_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_allocations" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if ('resource_id' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `resource_id` when calling `delete_allocations`")  # noqa: E501
