...
class AllocationsApi(object):
    ...
    def list_allocations(self, scope, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_allocations(scope, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str scope: The scope to which the allocations belong. (required)
        :param datetime as_at: The asAt datetime at which to retrieve the allocation. Defaults to return the latest version of the allocation if not specified.
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_allocations_with_http_info(scope, **kwargs)  # noqa: E501

    def list_allocations_with_http_info(self, scope, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Fetch the last pre-AsAt date version of each allocation in scope (does not fetch the entire history).  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_allocations_with_http_info(scope, async_req=True)
        >>> result = thread.get()
        ...
        if ('scope' not in local_var_params or
                local_var_params['scope'] is None):
            raise ApiValueError("Missing the required parameter `scope` when calling `list_allocations`")  # noqa: E501
    ...
    def upsert_allocations(self, scope, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Upsert; update existing allocations with given ids, or create new allocations otherwise.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_allocations(scope, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str scope: The scope to which the allocations belong. (required)
        :param AllocationSetRequest request: The collection of allocation requests.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.upsert_allocations_with_http_info(scope, **kwargs)  # noqa: E501

    def upsert_allocations_with_http_info(self, scope, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Upsert; update existing allocations with given ids, or create new allocations otherwise.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_allocations_with_http_info(scope, async_req=True)
        >>> result = thread.get()
        ...
        if ('scope' not in local_var_params or
                local_var_params['scope'] is None):
            raise ApiValueError("Missing the required parameter `scope` when calling `upsert_allocations`")  # noqa: E501
