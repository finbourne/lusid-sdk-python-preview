...
class ConventionsApi(object):
    ...
    def delete_conventions(self, scope, code, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Delete the conventions of given scope and code, assuming that it is present.  # noqa: E501
        ...
        >>> thread = api.delete_conventions(scope, code, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str scope: The scope of the conventions to delete. (required)
        :param str code: The conventions to delete. (required)
        ...
        return self.delete_conventions_with_http_info(scope, code, **kwargs)  # noqa: E501

    def delete_conventions_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Delete the conventions of given scope and code, assuming that it is present.  # noqa: E501

        Delete the specified conventions from a single scope.  The response will return either detail of the deleted item, or an explanation (failure) as to why this did not succeed.  It is important to always check for any unsuccessful response.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_conventions_with_http_info(scope, code, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method delete_conventions" % key
                )
        ...
        if ('scope' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `scope` when calling `delete_conventions`")  # noqa: E501
        # verify the required parameter 'code' is set
        if ('code' not in local_var_params or
                local_var_params['code'] is None):
            raise ApiValueError("Missing the required parameter `code` when calling `delete_conventions`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/conventions/{scope}/{code}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_flow_conventions_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/conventions/{scope}/{code}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
