...
class ConventionsApi(object):
    ...
    def get_cds_flow_conventions_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(GetConventionsResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='GetConventionsResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def list_conventions(self, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] List the set of conventions  # noqa: E501

        List the set of conventions at the specified date/time  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_conventions(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: ResourceListOfGetConventionsResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.list_conventions_with_http_info(**kwargs)  # noqa: E501

    def list_conventions_with_http_info(self, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] List the set of conventions  # noqa: E501

        List the set of conventions at the specified date/time  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_conventions_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(ResourceListOfGetConventionsResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_conventions" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ResourceListOfGetConventionsResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def upsert_cds_flow_conventions(self, upsert_conventions_request, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_cds_flow_conventions(upsert_conventions_request, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param UpsertConventionsRequest upsert_conventions_request: The CDS Flow Conventions to update or insert (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.upsert_cds_flow_conventions_with_http_info(upsert_conventions_request, **kwargs)  # noqa: E501

    def upsert_cds_flow_conventions_with_http_info(self, upsert_conventions_request, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Upsert a set of CDS Flow Conventions. This creates or updates the data in Lusid.  # noqa: E501

        Update or insert CDS Flow Conventions in a single scope. An item will be updated if it already exists  and inserted if it does not.                The response will return the successfully updated or inserted CDS Flow Conventions or failure message if unsuccessful                It is important to always check to verify success (or failure).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_cds_flow_conventions_with_http_info(upsert_conventions_request, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['upsert_conventions_request']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            ...
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'upsert_conventions_request' is set
        if ('upsert_conventions_request' not in local_var_params or
                local_var_params['upsert_conventions_request'] is None):
            raise ApiValueError("Missing the required parameter `upsert_conventions_request` when calling `upsert_cds_flow_conventions`")  # noqa: E501
        ...
        body_params = None
        if 'upsert_conventions_request' in local_var_params:
            body_params = local_var_params['upsert_conventions_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['text/plain', 'application/json', 'text/json'])  # noqa: E501
    ...
    def upsert_flow_conventions(self, upsert_conventions_request, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Upsert a set of Flow Conventions. This creates or updates the data in Lusid.  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_flow_conventions(upsert_conventions_request, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param UpsertConventionsRequest upsert_conventions_request: The Flow Conventions to update or insert (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.upsert_flow_conventions_with_http_info(upsert_conventions_request, **kwargs)  # noqa: E501

    def upsert_flow_conventions_with_http_info(self, upsert_conventions_request, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Upsert a set of Flow Conventions. This creates or updates the data in Lusid.  # noqa: E501

        Update or insert Flow Conventions in a single scope. An item will be updated if it already exists  and inserted if it does not.                The response will return the successfully updated or inserted Flow Conventions or failure message if unsuccessful                It is important to always check to verify success (or failure).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_flow_conventions_with_http_info(upsert_conventions_request, async_req=True)
        >>> result = thread.get()
        ...
        if ('upsert_conventions_request' not in local_var_params or
                local_var_params['upsert_conventions_request'] is None):
            raise ApiValueError("Missing the required parameter `upsert_conventions_request` when calling `upsert_flow_conventions`")  # noqa: E501
    ...
    def upsert_index_convention(self, upsert_conventions_request, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_index_convention(upsert_conventions_request, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param UpsertConventionsRequest upsert_conventions_request: The Index Conventions to update or insert (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.upsert_index_convention_with_http_info(upsert_conventions_request, **kwargs)  # noqa: E501

    def upsert_index_convention_with_http_info(self, upsert_conventions_request, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Upsert a set of Index Convention. This creates or updates the data in Lusid.  # noqa: E501

        Update or insert Index Convention in a single scope. An item will be updated if it already exists  and inserted if it does not.                The response will return the successfully updated or inserted Index Convention or failure message if unsuccessful                It is important to always check to verify success (or failure).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_index_convention_with_http_info(upsert_conventions_request, async_req=True)
        >>> result = thread.get()
        ...
        if ('upsert_conventions_request' not in local_var_params or
                local_var_params['upsert_conventions_request'] is None):
            raise ApiValueError("Missing the required parameter `upsert_conventions_request` when calling `upsert_index_convention`")  # noqa: E501
