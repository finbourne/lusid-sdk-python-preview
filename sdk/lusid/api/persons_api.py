...
class PersonsApi(object):
    ...
    def set_person_identifiers(self, id_type_scope, id_type_code, code, identifiers, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Set Person Identifiers  # noqa: E501

        Set identifiers of the person  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_person_identifiers(id_type_scope, id_type_code, code, identifiers, async_req=True)
        >>> result = thread.get()
        ...
        :param str id_type_code: Code of the person identifier type. (required)
        :param str code: Code of the person under specified identifier type's scope and code. This together with stated identifier type uniquely              identifies the person. (required)
        :param SetPersonIdentifiersRequest identifiers: Request containing identifiers to set for the person. Identifiers not specified in request will not be changed. (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.set_person_identifiers_with_http_info(id_type_scope, id_type_code, code, identifiers, **kwargs)  # noqa: E501

    def set_person_identifiers_with_http_info(self, id_type_scope, id_type_code, code, identifiers, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Set Person Identifiers  # noqa: E501

        Set identifiers of the person  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_person_identifiers_with_http_info(id_type_scope, id_type_code, code, identifiers, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id_type_scope', 'id_type_code', 'code', 'identifiers']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('identifiers' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `identifiers` when calling `set_person_identifiers`")  # noqa: E501
    ...
    def set_person_properties(self, id_type_scope, id_type_code, code, properties, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Set Person Properties  # noqa: E501

        Set properties of the person  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_person_properties(id_type_scope, id_type_code, code, properties, async_req=True)
        >>> result = thread.get()
        ...
        :param str id_type_code: Code of the person identifier type. (required)
        :param str code: Code of the person under specified identifier type's scope and code. This together with stated identifier type uniquely              identifies the person. (required)
        :param SetPersonPropertiesRequest properties: Request containing properties to set for the person. Properties not specified in request will not be changed. (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.set_person_properties_with_http_info(id_type_scope, id_type_code, code, properties, **kwargs)  # noqa: E501

    def set_person_properties_with_http_info(self, id_type_scope, id_type_code, code, properties, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Set Person Properties  # noqa: E501

        Set properties of the person  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_person_properties_with_http_info(id_type_scope, id_type_code, code, properties, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id_type_scope', 'id_type_code', 'code', 'properties']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('properties' not in local_var_params or
                local_var_params['properties'] is None):
            raise ApiValueError("Missing the required parameter `properties` when calling `set_person_properties`")  # noqa: E501
        ...
        body_params = None
        if 'properties' in local_var_params:
            body_params = local_var_params['properties']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['text/plain', 'application/json', 'text/json'])  # noqa: E501
    ...
    def upsert_person(self, request, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Upsert Person  # noqa: E501

        Create or update new person under specified scope  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_person(request, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param UpsertPersonRequest request: Request to create or update a person. (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.upsert_person_with_http_info(request, **kwargs)  # noqa: E501

    def upsert_person_with_http_info(self, request, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Upsert Person  # noqa: E501

        Create or update new person under specified scope  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_person_with_http_info(request, async_req=True)
        >>> result = thread.get()
        ...
        if ('request' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `request` when calling `upsert_person`")  # noqa: E501
