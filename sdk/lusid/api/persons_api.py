...
class PersonsApi(object):
    ...
    def upsert_persons(self, success_mode, request_body, **kwargs):  # noqa: E501
    ...
    def upsert_persons_with_http_info(self, success_mode, request_body, **kwargs):  # noqa: E501
        """[EARLY ACCESS] UpsertPersons: Pluralised Upsert of Persons  # noqa: E501
        ...
        :return: Returns the result object, the HTTP status code, and the headers.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: (UpsertPersonsResponse, int, HTTPHeaderDict)
        """
        ...
        if self.api_client.client_side_validation and ('success_mode' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `success_mode` when calling `upsert_persons`")  # noqa: E501
        # verify the required parameter 'request_body' is set
        if self.api_client.client_side_validation and ('request_body' not in local_var_params or  # noqa: E501
                                                        local_var_params['request_body'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `request_body` when calling `upsert_persons`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('success_mode' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `success_mode` when calling `upsert_persons`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('success_mode' in local_var_params and  # noqa: E501
                                                        len(local_var_params['success_mode']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `success_mode` when calling `upsert_persons`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
