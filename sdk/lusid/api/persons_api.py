...
class PersonsApi(object):
    ...
    def delete_person_identifiers_with_http_info(self, id_type_scope, id_type_code, code, property_keys, **kwargs):  # noqa: E501
        ...
        if ('effective_at' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `delete_person_identifiers`, length must be less than or equal to `256`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) < 0):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `delete_person_identifiers`, length must be greater than or equal to `0`")  # noqa: E501
        if 'effective_at' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_\+:\.]+$', local_var_params['effective_at']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `delete_person_identifiers`, must conform to the pattern `/^[a-zA-Z0-9\-_\+:\.]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def delete_person_properties_with_http_info(self, id_type_scope, id_type_code, code, property_keys, **kwargs):  # noqa: E501
        ...
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) > 256):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `delete_person_properties`, length must be less than or equal to `256`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) < 0):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `delete_person_properties`, length must be greater than or equal to `0`")  # noqa: E501
        if 'effective_at' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_\+:\.]+$', local_var_params['effective_at']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `delete_person_properties`, must conform to the pattern `/^[a-zA-Z0-9\-_\+:\.]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_person_with_http_info(self, id_type_scope, id_type_code, code, **kwargs):  # noqa: E501
        ...
        if ('id_type_scope' in local_var_params and
                len(local_var_params['id_type_scope']) > 64):
            raise ApiValueError("Invalid value for parameter `id_type_scope` when calling `get_person`, length must be less than or equal to `64`")  # noqa: E501
        if ('id_type_scope' in local_var_params and
                len(local_var_params['id_type_scope']) < 1):
            raise ApiValueError("Invalid value for parameter `id_type_scope` when calling `get_person`, length must be greater than or equal to `1`")  # noqa: E501
        if 'id_type_scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['id_type_scope']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `id_type_scope` when calling `get_person`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if ('id_type_code' in local_var_params and
                len(local_var_params['id_type_code']) > 64):
            raise ApiValueError("Invalid value for parameter `id_type_code` when calling `get_person`, length must be less than or equal to `64`")  # noqa: E501
        if ('id_type_code' in local_var_params and
                len(local_var_params['id_type_code']) < 1):
            raise ApiValueError("Invalid value for parameter `id_type_code` when calling `get_person`, length must be greater than or equal to `1`")  # noqa: E501
        if 'id_type_code' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['id_type_code']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `id_type_code` when calling `get_person`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if ('code' in local_var_params and
                len(local_var_params['code']) > 64):
        ...
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) > 256):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_person`, length must be less than or equal to `256`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) < 0):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_person`, length must be greater than or equal to `0`")  # noqa: E501
        if 'effective_at' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_\+:\.]+$', local_var_params['effective_at']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_person`, must conform to the pattern `/^[a-zA-Z0-9\-_\+:\.]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_person_relations_with_http_info(self, id_type_scope, id_type_code, code, **kwargs):  # noqa: E501
        ...
        if ('id_type_scope' in local_var_params and
                len(local_var_params['id_type_scope']) > 64):
            raise ApiValueError("Invalid value for parameter `id_type_scope` when calling `get_person_relations`, length must be less than or equal to `64`")  # noqa: E501
        if ('id_type_scope' in local_var_params and
                len(local_var_params['id_type_scope']) < 1):
            raise ApiValueError("Invalid value for parameter `id_type_scope` when calling `get_person_relations`, length must be greater than or equal to `1`")  # noqa: E501
        if 'id_type_scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['id_type_scope']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `id_type_scope` when calling `get_person_relations`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if ('id_type_code' in local_var_params and
                len(local_var_params['id_type_code']) > 64):
            raise ApiValueError("Invalid value for parameter `id_type_code` when calling `get_person_relations`, length must be less than or equal to `64`")  # noqa: E501
        if ('id_type_code' in local_var_params and
                len(local_var_params['id_type_code']) < 1):
            raise ApiValueError("Invalid value for parameter `id_type_code` when calling `get_person_relations`, length must be greater than or equal to `1`")  # noqa: E501
        if 'id_type_code' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['id_type_code']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `id_type_code` when calling `get_person_relations`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if ('code' in local_var_params and
                len(local_var_params['code']) > 64):
        ...
        if ('filter' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `filter` when calling `get_person_relations`, length must be less than or equal to `2147483647`")  # noqa: E501
        if ('filter' in local_var_params and
        ...
        if 'filter' in local_var_params and not re.search(r'(?s).*', local_var_params['filter']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `filter` when calling `get_person_relations`, must conform to the pattern `/(?s).*/`")  # noqa: E501
        collection_formats = {}
    ...
    def list_persons_with_http_info(self, id_type_scope, id_type_code, **kwargs):  # noqa: E501
        ...
        if ('id_type_scope' in local_var_params and
                len(local_var_params['id_type_scope']) > 64):
            raise ApiValueError("Invalid value for parameter `id_type_scope` when calling `list_persons`, length must be less than or equal to `64`")  # noqa: E501
        if ('id_type_scope' in local_var_params and
                len(local_var_params['id_type_scope']) < 1):
            raise ApiValueError("Invalid value for parameter `id_type_scope` when calling `list_persons`, length must be greater than or equal to `1`")  # noqa: E501
        if 'id_type_scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['id_type_scope']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `id_type_scope` when calling `list_persons`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if ('id_type_code' in local_var_params and
                len(local_var_params['id_type_code']) > 64):
            raise ApiValueError("Invalid value for parameter `id_type_code` when calling `list_persons`, length must be less than or equal to `64`")  # noqa: E501
        if ('id_type_code' in local_var_params and
                len(local_var_params['id_type_code']) < 1):
            raise ApiValueError("Invalid value for parameter `id_type_code` when calling `list_persons`, length must be greater than or equal to `1`")  # noqa: E501
        if 'id_type_code' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['id_type_code']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `id_type_code` when calling `list_persons`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) > 256):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `list_persons`, length must be less than or equal to `256`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) < 0):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `list_persons`, length must be greater than or equal to `0`")  # noqa: E501
        if 'effective_at' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_\+:\.]+$', local_var_params['effective_at']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `list_persons`, must conform to the pattern `/^[a-zA-Z0-9\-_\+:\.]+$/`")  # noqa: E501
        if ('page' in local_var_params and
                len(local_var_params['page']) > 300):
            raise ApiValueError("Invalid value for parameter `page` when calling `list_persons`, length must be less than or equal to `300`")  # noqa: E501
        if ('page' in local_var_params and
        ...
        if ('filter' in local_var_params and
                len(local_var_params['filter']) > 2147483647):
            raise ApiValueError("Invalid value for parameter `filter` when calling `list_persons`, length must be less than or equal to `2147483647`")  # noqa: E501
        if ('filter' in local_var_params and
                len(local_var_params['filter']) < 0):
        ...
        if 'filter' in local_var_params and not re.search(r'(?s).*', local_var_params['filter']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `filter` when calling `list_persons`, must conform to the pattern `/(?s).*/`")  # noqa: E501
        collection_formats = {}
    ...
    def set_person_identifiers_with_http_info(self, id_type_scope, id_type_code, code, set_person_identifiers_request, **kwargs):  # noqa: E501
        ...
        if ('id_type_scope' in local_var_params and
                len(local_var_params['id_type_scope']) > 64):
            raise ApiValueError("Invalid value for parameter `id_type_scope` when calling `set_person_identifiers`, length must be less than or equal to `64`")  # noqa: E501
        if ('id_type_scope' in local_var_params and
                len(local_var_params['id_type_scope']) < 1):
            raise ApiValueError("Invalid value for parameter `id_type_scope` when calling `set_person_identifiers`, length must be greater than or equal to `1`")  # noqa: E501
        if 'id_type_scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['id_type_scope']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `id_type_scope` when calling `set_person_identifiers`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if ('id_type_code' in local_var_params and
                len(local_var_params['id_type_code']) > 64):
            raise ApiValueError("Invalid value for parameter `id_type_code` when calling `set_person_identifiers`, length must be less than or equal to `64`")  # noqa: E501
        if ('id_type_code' in local_var_params and
                len(local_var_params['id_type_code']) < 1):
            raise ApiValueError("Invalid value for parameter `id_type_code` when calling `set_person_identifiers`, length must be greater than or equal to `1`")  # noqa: E501
        if 'id_type_code' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['id_type_code']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `id_type_code` when calling `set_person_identifiers`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if ('code' in local_var_params and
                len(local_var_params['code']) > 64):
    ...
    def set_person_properties_with_http_info(self, id_type_scope, id_type_code, code, set_person_properties_request, **kwargs):  # noqa: E501
        ...
        if ('id_type_scope' in local_var_params and
                len(local_var_params['id_type_scope']) > 64):
            raise ApiValueError("Invalid value for parameter `id_type_scope` when calling `set_person_properties`, length must be less than or equal to `64`")  # noqa: E501
        if ('id_type_scope' in local_var_params and
                len(local_var_params['id_type_scope']) < 1):
            raise ApiValueError("Invalid value for parameter `id_type_scope` when calling `set_person_properties`, length must be greater than or equal to `1`")  # noqa: E501
        if 'id_type_scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['id_type_scope']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `id_type_scope` when calling `set_person_properties`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if ('id_type_code' in local_var_params and
                len(local_var_params['id_type_code']) > 64):
            raise ApiValueError("Invalid value for parameter `id_type_code` when calling `set_person_properties`, length must be less than or equal to `64`")  # noqa: E501
        if ('id_type_code' in local_var_params and
                len(local_var_params['id_type_code']) < 1):
            raise ApiValueError("Invalid value for parameter `id_type_code` when calling `set_person_properties`, length must be greater than or equal to `1`")  # noqa: E501
        if 'id_type_code' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['id_type_code']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `id_type_code` when calling `set_person_properties`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if ('code' in local_var_params and
                len(local_var_params['code']) > 64):
