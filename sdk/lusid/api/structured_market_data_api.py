...
class StructuredMarketDataApi(object):
    ...
    def delete_structured_market_data_with_http_info(self, scope, request_body, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `scope` when calling `delete_structured_market_data`, length must be greater than or equal to `0`")  # noqa: E501
    ...
    def get_structured_market_data_with_http_info(self, scope, request_body, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
                len(local_var_params['scope']) < 0):
            raise ApiValueError("Invalid value for parameter `scope` when calling `get_structured_market_data`, length must be greater than or equal to `0`")  # noqa: E501
        if 'scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['scope']):  # noqa: E501
    ...
    def upsert_structured_market_data_with_http_info(self, scope, request_body, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
                len(local_var_params['scope']) < 0):
            raise ApiValueError("Invalid value for parameter `scope` when calling `upsert_structured_market_data`, length must be greater than or equal to `0`")  # noqa: E501
        if 'scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['scope']):  # noqa: E501
