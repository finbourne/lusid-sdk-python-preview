...
class PortfolioGroupsApi(object):
    ...
    def build_transactions_for_portfolio_group_with_http_info(self, scope, code, transaction_query_parameters, **kwargs):  # noqa: E501
        ...
        if ('filter' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `filter` when calling `build_transactions_for_portfolio_group`, length must be less than or equal to `2147483647`")  # noqa: E501
        if ('filter' in local_var_params and
        ...
        if 'filter' in local_var_params and not re.search(r'(?s).*', local_var_params['filter']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `filter` when calling `build_transactions_for_portfolio_group`, must conform to the pattern `/(?s).*/`")  # noqa: E501
        collection_formats = {}
    ...
    def delete_key_from_portfolio_group_access_metadata_with_http_info(self, scope, code, metadata_key, **kwargs):  # noqa: E501
        ...
        if ('metadata_key' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `metadata_key` when calling `delete_key_from_portfolio_group_access_metadata`, length must be less than or equal to `64`")  # noqa: E501
        if ('metadata_key' in local_var_params and
        ...
        if 'metadata_key' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['metadata_key']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `metadata_key` when calling `delete_key_from_portfolio_group_access_metadata`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) > 40):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `delete_key_from_portfolio_group_access_metadata`, length must be less than or equal to `40`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) < 0):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `delete_key_from_portfolio_group_access_metadata`, length must be greater than or equal to `0`")  # noqa: E501
        if 'effective_at' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_ \+:\/\.]+$', local_var_params['effective_at']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `delete_key_from_portfolio_group_access_metadata`, must conform to the pattern `/^[a-zA-Z0-9\-_ \+:\/\.]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_holdings_for_portfolio_group_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) > 40):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_holdings_for_portfolio_group`, length must be less than or equal to `40`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) < 0):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_holdings_for_portfolio_group`, length must be greater than or equal to `0`")  # noqa: E501
        if 'effective_at' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_ \+:\/\.]+$', local_var_params['effective_at']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_holdings_for_portfolio_group`, must conform to the pattern `/^[a-zA-Z0-9\-_ \+:\/\.]+$/`")  # noqa: E501
        if ('filter' in local_var_params and
                len(local_var_params['filter']) > 2147483647):
            raise ApiValueError("Invalid value for parameter `filter` when calling `get_holdings_for_portfolio_group`, length must be less than or equal to `2147483647`")  # noqa: E501
        if ('filter' in local_var_params and
                len(local_var_params['filter']) < 0):
        ...
        if 'filter' in local_var_params and not re.search(r'(?s).*', local_var_params['filter']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `filter` when calling `get_holdings_for_portfolio_group`, must conform to the pattern `/(?s).*/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_portfolio_group_access_metadata_by_key_with_http_info(self, scope, code, metadata_key, **kwargs):  # noqa: E501
        ...
        if ('metadata_key' in local_var_params and
                len(local_var_params['metadata_key']) > 64):
            raise ApiValueError("Invalid value for parameter `metadata_key` when calling `get_portfolio_group_access_metadata_by_key`, length must be less than or equal to `64`")  # noqa: E501
        if ('metadata_key' in local_var_params and
                len(local_var_params['metadata_key']) < 1):
        ...
        if 'metadata_key' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['metadata_key']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `metadata_key` when calling `get_portfolio_group_access_metadata_by_key`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) > 40):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_portfolio_group_access_metadata_by_key`, length must be less than or equal to `40`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) < 0):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_portfolio_group_access_metadata_by_key`, length must be greater than or equal to `0`")  # noqa: E501
        if 'effective_at' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_ \+:\/\.]+$', local_var_params['effective_at']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_portfolio_group_access_metadata_by_key`, must conform to the pattern `/^[a-zA-Z0-9\-_ \+:\/\.]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_portfolio_group_metadata_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) > 40):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_portfolio_group_metadata`, length must be less than or equal to `40`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) < 0):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_portfolio_group_metadata`, length must be greater than or equal to `0`")  # noqa: E501
        if 'effective_at' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_ \+:\/\.]+$', local_var_params['effective_at']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_portfolio_group_metadata`, must conform to the pattern `/^[a-zA-Z0-9\-_ \+:\/\.]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_portfolio_group_relations_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) > 40):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_portfolio_group_relations`, length must be less than or equal to `40`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) < 0):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_portfolio_group_relations`, length must be greater than or equal to `0`")  # noqa: E501
        if 'effective_at' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_ \+:\/\.]+$', local_var_params['effective_at']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_portfolio_group_relations`, must conform to the pattern `/^[a-zA-Z0-9\-_ \+:\/\.]+$/`")  # noqa: E501
        if ('filter' in local_var_params and
                len(local_var_params['filter']) > 2147483647):
            raise ApiValueError("Invalid value for parameter `filter` when calling `get_portfolio_group_relations`, length must be less than or equal to `2147483647`")  # noqa: E501
        if ('filter' in local_var_params and
                len(local_var_params['filter']) < 0):
        ...
        if 'filter' in local_var_params and not re.search(r'(?s).*', local_var_params['filter']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `filter` when calling `get_portfolio_group_relations`, must conform to the pattern `/(?s).*/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_transactions_for_portfolio_group_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('from_transaction_date' in local_var_params and
                len(local_var_params['from_transaction_date']) > 255):
            raise ApiValueError("Invalid value for parameter `from_transaction_date` when calling `get_transactions_for_portfolio_group`, length must be less than or equal to `255`")  # noqa: E501
        if ('from_transaction_date' in local_var_params and
                len(local_var_params['from_transaction_date']) < 6):
            raise ApiValueError("Invalid value for parameter `from_transaction_date` when calling `get_transactions_for_portfolio_group`, length must be greater than or equal to `6`")  # noqa: E501
        if 'from_transaction_date' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_ \+:\/\.]+$', local_var_params['from_transaction_date']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `from_transaction_date` when calling `get_transactions_for_portfolio_group`, must conform to the pattern `/^[a-zA-Z0-9\-_ \+:\/\.]+$/`")  # noqa: E501
        if ('to_transaction_date' in local_var_params and
                len(local_var_params['to_transaction_date']) > 255):
            raise ApiValueError("Invalid value for parameter `to_transaction_date` when calling `get_transactions_for_portfolio_group`, length must be less than or equal to `255`")  # noqa: E501
        if ('to_transaction_date' in local_var_params and
                len(local_var_params['to_transaction_date']) < 6):
            raise ApiValueError("Invalid value for parameter `to_transaction_date` when calling `get_transactions_for_portfolio_group`, length must be greater than or equal to `6`")  # noqa: E501
        if 'to_transaction_date' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_ \+:\/\.]+$', local_var_params['to_transaction_date']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `to_transaction_date` when calling `get_transactions_for_portfolio_group`, must conform to the pattern `/^[a-zA-Z0-9\-_ \+:\/\.]+$/`")  # noqa: E501
        if ('filter' in local_var_params and
                len(local_var_params['filter']) > 2147483647):
            raise ApiValueError("Invalid value for parameter `filter` when calling `get_transactions_for_portfolio_group`, length must be less than or equal to `2147483647`")  # noqa: E501
        if ('filter' in local_var_params and
                len(local_var_params['filter']) < 0):
        ...
        if 'filter' in local_var_params and not re.search(r'(?s).*', local_var_params['filter']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `filter` when calling `get_transactions_for_portfolio_group`, must conform to the pattern `/(?s).*/`")  # noqa: E501
        collection_formats = {}
    ...
    def upsert_portfolio_group_access_metadata_with_http_info(self, scope, code, metadata_key, upsert_portfolio_group_access_metadata_request, **kwargs):  # noqa: E501
        ...
        if ('metadata_key' in local_var_params and
                len(local_var_params['metadata_key']) > 64):
            raise ApiValueError("Invalid value for parameter `metadata_key` when calling `upsert_portfolio_group_access_metadata`, length must be less than or equal to `64`")  # noqa: E501
        if ('metadata_key' in local_var_params and
                len(local_var_params['metadata_key']) < 1):
        ...
        if 'metadata_key' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['metadata_key']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `metadata_key` when calling `upsert_portfolio_group_access_metadata`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) > 40):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `upsert_portfolio_group_access_metadata`, length must be less than or equal to `40`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) < 0):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `upsert_portfolio_group_access_metadata`, length must be greater than or equal to `0`")  # noqa: E501
        if 'effective_at' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_ \+:\/\.]+$', local_var_params['effective_at']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `upsert_portfolio_group_access_metadata`, must conform to the pattern `/^[a-zA-Z0-9\-_ \+:\/\.]+$/`")  # noqa: E501
        collection_formats = {}
