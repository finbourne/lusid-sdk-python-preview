...
class PortfolioGroupsApi(object):
    ...
    def build_transactions_for_portfolio_group(self, scope, code, query_parameters, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.build_transactions_for_portfolio_group(scope, code, query_parameters, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.build_transactions_for_portfolio_group_with_http_info(scope, code, query_parameters, **kwargs)  # noqa: E501

    def build_transactions_for_portfolio_group_with_http_info(self, scope, code, query_parameters, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Build transactions for transaction portfolios in a portfolio group  # noqa: E501

        Build transactions for transaction portfolios in a portfolio group over a given interval of effective time.     When the specified portfolio in a portfolio group is a derived transaction portfolio, the returned set of transactions is the  union set of all transactions of the parent (and any grandparents etc.) and the specified derived transaction portfolio itself.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.build_transactions_for_portfolio_group_with_http_info(scope, code, query_parameters, async_req=True)
        >>> result = thread.get()
        ...
        if ('query_parameters' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `query_parameters` when calling `build_transactions_for_portfolio_group`")  # noqa: E501
