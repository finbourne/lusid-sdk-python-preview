...
class QuotesApi(object):
    ...
    def list_quotes(self, scope, **kwargs):  # noqa: E501
        ...
        :param str filter: Expression to filter the result set.              For example, to filter on the Provider, use \"quoteId.quoteSeriesId.provider eq 'string'\"              Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def upsert_quote_access_metadata_rule(self, scope, request, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_quote_access_metadata_rule(scope, request, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str scope: The scope to use when updating or inserting the Quote Access Metadata Rule. (required)
        :param UpsertQuoteAccessMetadataRuleRequest request: The Quote Access Metadata Rule to update or insert (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.upsert_quote_access_metadata_rule_with_http_info(scope, request, **kwargs)  # noqa: E501

    def upsert_quote_access_metadata_rule_with_http_info(self, scope, request, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Upsert a Quote Access Metadata Rule. This creates or updates the data in LUSID.  # noqa: E501

        Update or insert one Quote Access Metadata Rule in a single scope. An item will be updated if it already exists  and inserted if it does not.    The response will return the successfully updated or inserted Quote Access Metadata Rule or failure message if unsuccessful    It is important to always check to verify success (or failure).                Multiple rules for a key can exists with different effective at dates, when resources are accessed the rule that is active for the current time will be fetched  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_quote_access_metadata_rule_with_http_info(scope, request, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['scope', 'request', 'effective_at']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
