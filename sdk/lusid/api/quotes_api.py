...
class QuotesApi(object):
    ...
    def delete_quotes(self, scope, **kwargs):  # noqa: E501
        ...
        :param dict(str, QuoteId) quotes: The quotes to delete
    ...
    def get_quotes(self, scope, **kwargs):  # noqa: E501
        ...
        :param str effective_at: Optional. The date/time from which the quotes are effective
        :param datetime as_at: Optional. The 'AsAt' date/time
        :param str max_age: Optional. The quote staleness tolerance
        :param dict(str, QuoteSeriesId) quote_ids: The ids of the quotes
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def upsert_quotes(self, scope, **kwargs):  # noqa: E501
        ...
        Upsert quotes effective at the specified time. If a quote is added with the same id (and is effective at the same time) as an existing quote, then the more recently added quote will be returned when queried  The maximum number of quotes that this method can upsert per request is 2,000.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool: execute request asynchronously
        :param str scope: The scope of the quotes (required)
        :param dict(str, UpsertQuoteRequest) quotes: The quotes to upsert
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
