...
class QuotesApi(object):
    ...
    def delete_quotes(self, scope, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.delete_quotes_with_http_info(scope, **kwargs)  # noqa: E501
            return data
    ...
    def get_quotes(self, scope, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_quotes_with_http_info(scope, **kwargs)  # noqa: E501
            return data
    ...
    def upsert_quotes(self, scope, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.upsert_quotes_with_http_info(scope, **kwargs)  # noqa: E501
            return data
