...
class QuotesApi(object):
    ...
    def get_quotes(self, scope, **kwargs):  # noqa: E501
        ...
        :param str effective_at: The effective datetime at which to retrieve the quotes. Defaults to the current LUSID system datetime if not specified.
        ...
        :param str max_age: The duration of the look back window in an ISO8601 time interval format e.g. P1Y2M3DT4H30M (1 year, 2 months, 3 days, 4 hours and 30 minutes).               This is subtracted from the provided effectiveAt datetime to generate a effective datetime window inside which a quote must exist to be retrieved.
