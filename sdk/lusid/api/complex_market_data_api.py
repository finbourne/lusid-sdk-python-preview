...
class ComplexMarketDataApi(object):
    ...
    def delete_complex_market_data(self, scope, request_body, **kwargs):  # noqa: E501
        ...
        :param str scope: The scope of the complex market data to delete. (required)
        :param dict(str, ComplexMarketDataId) request_body: The complex market data Ids to delete, each keyed by a unique correlation id. (required)
    ...
    def get_complex_market_data(self, scope, request_body, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str scope: The scope of the complex market data to retrieve. (required)
        :param dict(str, ComplexMarketDataId) request_body: The time invariant set of complex data identifiers to retrieve the data for. These need to be               keyed by a unique correlation id allowing the retrieved item to be identified in the response. (required)
        :param str effective_at: The effective datetime at which to retrieve the complex market data. Defaults to the current LUSID system datetime if not specified.
        :param datetime as_at: The asAt datetime at which to retrieve the complex market data. Defaults to return the latest version if not specified.
    ...
    def get_complex_market_data_with_http_info(self, scope, request_body, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(GetComplexMarketDataResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='GetComplexMarketDataResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def upsert_complex_market_data(self, scope, request_body, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str scope: The scope to use when updating or inserting the complex market data. (required)
        :param dict(str, UpsertComplexMarketDataRequest) request_body: The set of complex market data items to update or insert keyed by a unique correlation id. (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
