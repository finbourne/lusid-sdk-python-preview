...
class StructuredResultDataApi(object):
    ...
    def get_structured_result_data_with_http_info(self, scope, request_body, **kwargs):  # noqa: E501
        ...
        if ('effective_at' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_structured_result_data`, length must be less than or equal to `256`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) < 0):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_structured_result_data`, length must be greater than or equal to `0`")  # noqa: E501
        if 'effective_at' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_\+:\.]+$', local_var_params['effective_at']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_structured_result_data`, must conform to the pattern `/^[a-zA-Z0-9\-_\+:\.]+$/`")  # noqa: E501
        collection_formats = {}
