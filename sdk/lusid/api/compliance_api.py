...
class ComplianceApi(object):
    ...
    def get_breached_orders_info(self, run_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_breached_orders_info(run_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_breached_orders_info_with_http_info(run_id, **kwargs)  # noqa: E501

    def get_breached_orders_info_with_http_info(self, run_id, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] GetBreachedOrdersInfo: Get the Ids of Breached orders in a given compliance run and the corresponding list of rules that could have caused it.  # noqa: E501
        ...
        >>> thread = api.get_breached_orders_info_with_http_info(run_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_breached_orders_info" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('run_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `run_id` when calling `get_breached_orders_info`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('run_id' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `run_id` when calling `get_breached_orders_info`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('run_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['run_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `run_id` when calling `get_breached_orders_info`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'run_id' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['run_id']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `run_id` when calling `get_breached_orders_info`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if self.api_client.client_side_validation and ('order_scope' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `order_scope` when calling `get_breached_orders_info`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('order_scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['order_scope']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `order_scope` when calling `get_breached_orders_info`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'order_scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['order_scope']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `order_scope` when calling `get_breached_orders_info`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if self.api_client.client_side_validation and ('order_code' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `order_code` when calling `get_breached_orders_info`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('order_code' in local_var_params and  # noqa: E501
                                                        len(local_var_params['order_code']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `order_code` when calling `get_breached_orders_info`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'order_code' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['order_code']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `order_code` when calling `get_breached_orders_info`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] > 5000:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_breached_orders_info`, must be a value less than or equal to `5000`")  # noqa: E501
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_breached_orders_info`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def get_compliance_run_results_with_http_info(self, run_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('filter' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `filter` when calling `get_compliance_run_results`, length must be less than or equal to `16384`")  # noqa: E501
        if self.api_client.client_side_validation and ('filter' in local_var_params and  # noqa: E501
                                                        len(local_var_params['filter']) < 0):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `filter` when calling `get_compliance_run_results`, length must be greater than or equal to `0`")  # noqa: E501
        if self.api_client.client_side_validation and 'filter' in local_var_params and not re.search(r'^[\s\S]*$', local_var_params['filter']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `filter` when calling `get_compliance_run_results`, must conform to the pattern `/^[\s\S]*$/`")  # noqa: E501
        collection_formats = {}
