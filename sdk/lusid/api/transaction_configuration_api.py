...
class TransactionConfigurationApi(object):
    ...
    def get_transaction_type_with_http_info(self, source, type, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('type' in local_var_params and  # noqa: E501
                                                        len(local_var_params['type']) > 256):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `type` when calling `get_transaction_type`, length must be less than or equal to `256`")  # noqa: E501
        if self.api_client.client_side_validation and ('type' in local_var_params and  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'type' in local_var_params and not re.search(r'^[^\\<>&"]+$', local_var_params['type']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `type` when calling `get_transaction_type`, must conform to the pattern `/^[^\\<>&"]+$/`")  # noqa: E501
        collection_formats = {}
