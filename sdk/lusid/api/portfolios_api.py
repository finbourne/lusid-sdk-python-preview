...
class PortfoliosApi(object):
    ...
    def get_portfolio_property_time_series(self, scope, code, **kwargs):  # noqa: E501
        ...
        :param str effective_at: The effective datetime at which to list the property history. Defaults to the current LUSID system datetime if not specified.
    ...
    def get_portfolio_property_time_series_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        all_params = ['scope', 'code', 'property_key', 'effective_at', 'as_at', 'filter', 'page', 'limit']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
