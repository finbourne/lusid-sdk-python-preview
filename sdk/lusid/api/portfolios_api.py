...
class PortfoliosApi(object):
    ...
    def update_portfolio_with_http_info(self, scope, code, portfolio_definition, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('portfolio_definition' not in local_var_params or  # noqa: E501
                                                        local_var_params['portfolio_definition'] is None):  # noqa: E501
    ...
    def upsert_portfolio_access_metadata(self, scope, code, metadata_key, request, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_portfolio_access_metadata(scope, code, metadata_key, request, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.upsert_portfolio_access_metadata_with_http_info(scope, code, metadata_key, request, **kwargs)  # noqa: E501

    def upsert_portfolio_access_metadata_with_http_info(self, scope, code, metadata_key, request, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Upsert a Portfolio Access Metadata Rule associated with specific metadataKey. This creates or updates the data in LUSID.  # noqa: E501

        Update or insert one Portfolio Access Metadata Rule in a single scope. An item will be updated if it already exists  and inserted if it does not.    The response will return the successfully updated or inserted Portfolio Access Metadata Rule or failure message if unsuccessful    It is important to always check to verify success (or failure).                Multiple rules for a metadataKey can exists with different effective at dates, when resources are accessed the rule that is active for the current time will be fetched  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_portfolio_access_metadata_with_http_info(scope, code, metadata_key, request, async_req=True)
        >>> result = thread.get()
    ...
    def upsert_portfolio_properties_with_http_info(self, scope, code, portfolio_properties, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('portfolio_properties' not in local_var_params or  # noqa: E501
                                                        local_var_params['portfolio_properties'] is None):  # noqa: E501
