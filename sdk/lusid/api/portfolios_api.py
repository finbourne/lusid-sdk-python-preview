...
class PortfoliosApi(object):
    ...
    def delete_portfolio_returns(self, scope, code, return_scope, return_code, from_effective_at, to_effective_at, **kwargs):  # noqa: E501
        ...
        :param str from_effective_at: The start date from which to delete the Returns. (required)
        :param str to_effective_at: The end date from which to delete the Returns. (required)
        :param str period: The Period (Daily or Monthly) of the Returns to be deleted.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def delete_portfolio_returns_with_http_info(self, scope, code, return_scope, return_code, from_effective_at, to_effective_at, **kwargs):  # noqa: E501
        ...
        all_params = ['scope', 'code', 'return_scope', 'return_code', 'from_effective_at', 'to_effective_at', 'period']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_portfolio_aggregate_returns(self, scope, code, return_scope, return_code, **kwargs):  # noqa: E501
        ...
        :param str from_effective_at: The start date from which to calculate the Returns.
        :param str to_effective_at: The end date for which to calculate the Returns.
        ...
        :param str output_frequency: The type of calculated output: Daily/Weekly/Monthly/Quarterly/Half-Yearly/Yearly.
        :param list[str] metrics: Determines what type of returns should be calculated, see https://support.lusid.com/knowledgebase/article/KA-01675/en-us for a list of available metrics.
        :param datetime as_at: The asAt datetime at which to retrieve the Returns. Defaults to the latest.
        :param str alternative_inc_date: The date from which to consider the Returns on the Portfolio, if this is different from the date when Returns begin.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def get_portfolio_aggregate_returns_with_http_info(self, scope, code, return_scope, return_code, **kwargs):  # noqa: E501
        ...
        all_params = ['scope', 'code', 'return_scope', 'return_code', 'recipe_id_scope', 'recipe_id_code', 'from_effective_at', 'to_effective_at', 'composite_method', 'period', 'output_frequency', 'metrics', 'as_at', 'alternative_inc_date']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'as_at' in local_var_params:
            query_params.append(('asAt', local_var_params['as_at']))  # noqa: E501
        if 'alternative_inc_date' in local_var_params:
    ...
    def list_portfolio_properties_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        all_params = ['scope', 'code', 'effective_at', 'as_at', 'page', 'limit']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
