...
class PortfoliosApi(object):
    ...
    def get_portfolio_aggregate_returns(self, scope, code, return_scope, return_code, **kwargs):  # noqa: E501
        ...
        :param str period: the type of the returns used to calculate the aggregation result.
        :param str output_frequency: The type of calculated output.
    ...
    def get_portfolio_property_time_series(self, scope, code, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Get the time series of a portfolio property  # noqa: E501
        ...
        :param str property_key: The property key of the property that will have its history shown. These must be in the format {domain}/{scope}/{code} e.g. \"Portfolio/Manager/Id\".              Each property must be from the \"Portfolio\" domain.
        ...
        :param datetime as_at: The asAt datetime at which to list the portfolio's property history. Defaults to return the current datetime if not supplied.
    ...
    def get_portfolio_relationships(self, scope, code, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Get Relationships for Portfolio  # noqa: E501

        Get relationships for the specified Portfolio  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
