...
class PortfoliosApi(object):
    ...
    def delete_key_from_portfolio_access_metadata_with_http_info(self, scope, code, metadata_key, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `scope` when calling `delete_key_from_portfolio_access_metadata`, length must be less than or equal to `100`")  # noqa: E501
        if ('scope' in local_var_params and
        ...
        if ('code' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `code` when calling `delete_key_from_portfolio_access_metadata`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
    ...
    def delete_portfolio_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
                len(local_var_params['scope']) > 100):
            raise ApiValueError("Invalid value for parameter `scope` when calling `delete_portfolio`, length must be less than or equal to `100`")  # noqa: E501
        if ('scope' in local_var_params and
                len(local_var_params['scope']) < 1):
        ...
        if ('code' in local_var_params and
                len(local_var_params['code']) > 100):
            raise ApiValueError("Invalid value for parameter `code` when calling `delete_portfolio`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
                len(local_var_params['code']) < 1):
    ...
    def delete_portfolio_properties_with_http_info(self, scope, code, property_keys, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
                len(local_var_params['scope']) > 100):
            raise ApiValueError("Invalid value for parameter `scope` when calling `delete_portfolio_properties`, length must be less than or equal to `100`")  # noqa: E501
        if ('scope' in local_var_params and
                len(local_var_params['scope']) < 1):
        ...
        if ('code' in local_var_params and
                len(local_var_params['code']) > 100):
            raise ApiValueError("Invalid value for parameter `code` when calling `delete_portfolio_properties`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
                len(local_var_params['code']) < 1):
    ...
    def get_portfolio_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
                len(local_var_params['scope']) > 100):
            raise ApiValueError("Invalid value for parameter `scope` when calling `get_portfolio`, length must be less than or equal to `100`")  # noqa: E501
        if ('scope' in local_var_params and
                len(local_var_params['scope']) < 1):
        ...
        if ('code' in local_var_params and
                len(local_var_params['code']) > 100):
            raise ApiValueError("Invalid value for parameter `code` when calling `get_portfolio`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
                len(local_var_params['code']) < 1):
    ...
    def get_portfolio_commands_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
                len(local_var_params['scope']) > 100):
            raise ApiValueError("Invalid value for parameter `scope` when calling `get_portfolio_commands`, length must be less than or equal to `100`")  # noqa: E501
        if ('scope' in local_var_params and
                len(local_var_params['scope']) < 1):
        ...
        if ('code' in local_var_params and
                len(local_var_params['code']) > 100):
            raise ApiValueError("Invalid value for parameter `code` when calling `get_portfolio_commands`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
                len(local_var_params['code']) < 1):
    ...
    def get_portfolio_metadata_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
                len(local_var_params['scope']) > 100):
            raise ApiValueError("Invalid value for parameter `scope` when calling `get_portfolio_metadata`, length must be less than or equal to `100`")  # noqa: E501
        if ('scope' in local_var_params and
                len(local_var_params['scope']) < 1):
        ...
        if ('code' in local_var_params and
                len(local_var_params['code']) > 100):
            raise ApiValueError("Invalid value for parameter `code` when calling `get_portfolio_metadata`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
                len(local_var_params['code']) < 1):
    ...
    def get_portfolio_properties_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
                len(local_var_params['scope']) > 100):
            raise ApiValueError("Invalid value for parameter `scope` when calling `get_portfolio_properties`, length must be less than or equal to `100`")  # noqa: E501
        if ('scope' in local_var_params and
                len(local_var_params['scope']) < 1):
        ...
        if ('code' in local_var_params and
                len(local_var_params['code']) > 100):
            raise ApiValueError("Invalid value for parameter `code` when calling `get_portfolio_properties`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
                len(local_var_params['code']) < 1):
    ...
    def get_portfolio_relations_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
                len(local_var_params['scope']) > 100):
            raise ApiValueError("Invalid value for parameter `scope` when calling `get_portfolio_relations`, length must be less than or equal to `100`")  # noqa: E501
        if ('scope' in local_var_params and
                len(local_var_params['scope']) < 1):
        ...
        if ('code' in local_var_params and
                len(local_var_params['code']) > 100):
            raise ApiValueError("Invalid value for parameter `code` when calling `get_portfolio_relations`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
                len(local_var_params['code']) < 1):
    ...
    def get_portfolios_access_metadata_by_key_with_http_info(self, scope, code, metadata_key, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
                len(local_var_params['scope']) > 100):
            raise ApiValueError("Invalid value for parameter `scope` when calling `get_portfolios_access_metadata_by_key`, length must be less than or equal to `100`")  # noqa: E501
        if ('scope' in local_var_params and
                len(local_var_params['scope']) < 1):
        ...
        if ('code' in local_var_params and
                len(local_var_params['code']) > 100):
            raise ApiValueError("Invalid value for parameter `code` when calling `get_portfolios_access_metadata_by_key`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
                len(local_var_params['code']) < 1):
    ...
    def list_portfolios_for_scope_with_http_info(self, scope, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
                len(local_var_params['scope']) > 100):
            raise ApiValueError("Invalid value for parameter `scope` when calling `list_portfolios_for_scope`, length must be less than or equal to `100`")  # noqa: E501
        if ('scope' in local_var_params and
                len(local_var_params['scope']) < 1):
    ...
    def update_portfolio_with_http_info(self, scope, code, update_portfolio_request, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
                len(local_var_params['scope']) > 100):
            raise ApiValueError("Invalid value for parameter `scope` when calling `update_portfolio`, length must be less than or equal to `100`")  # noqa: E501
        if ('scope' in local_var_params and
                len(local_var_params['scope']) < 1):
        ...
        if ('code' in local_var_params and
                len(local_var_params['code']) > 100):
            raise ApiValueError("Invalid value for parameter `code` when calling `update_portfolio`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
                len(local_var_params['code']) < 1):
    ...
    def upsert_portfolio_access_metadata_with_http_info(self, scope, code, metadata_key, upsert_portfolio_access_metadata_request, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
                len(local_var_params['scope']) > 100):
            raise ApiValueError("Invalid value for parameter `scope` when calling `upsert_portfolio_access_metadata`, length must be less than or equal to `100`")  # noqa: E501
        if ('scope' in local_var_params and
                len(local_var_params['scope']) < 1):
        ...
        if ('code' in local_var_params and
                len(local_var_params['code']) > 100):
            raise ApiValueError("Invalid value for parameter `code` when calling `upsert_portfolio_access_metadata`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
                len(local_var_params['code']) < 1):
    ...
    def upsert_portfolio_properties_with_http_info(self, scope, code, request_body, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
                len(local_var_params['scope']) > 100):
            raise ApiValueError("Invalid value for parameter `scope` when calling `upsert_portfolio_properties`, length must be less than or equal to `100`")  # noqa: E501
        if ('scope' in local_var_params and
                len(local_var_params['scope']) < 1):
        ...
        if ('code' in local_var_params and
                len(local_var_params['code']) > 100):
            raise ApiValueError("Invalid value for parameter `code` when calling `upsert_portfolio_properties`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
                len(local_var_params['code']) < 1):
