...
class PortfoliosApi(object):
    ...
    def delete_portfolio(self, scope, code, **kwargs):  # noqa: E501
        ...
        The deletion of the portfolio will be valid from portfolio's creation time. This implies the portfolio would no longer exist from the AsAt time of deletion.  # noqa: E501
    ...
    def delete_portfolio_properties(self, scope, code, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Delete portfolio properties  # noqa: E501

        Delete one, many or all property values from a portfolio for the specified effectiveAt                Specifying no effectiveAt will delete all properties  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_portfolio_properties(scope, code, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str scope: The scope of the portfolio (required)
        :param str code: Code for the portfolio (required)
        :param str effective_at: Optional. The effective date of the deletion
        :param list[str] portfolio_property_keys: Optional. The keys of the properties to be deleted. None specified indicates the intention to delete all properties from the portfolio
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_portfolio_properties_with_http_info(scope, code, **kwargs)  # noqa: E501

    def delete_portfolio_properties_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Delete portfolio properties  # noqa: E501

        Delete one, many or all property values from a portfolio for the specified effectiveAt                Specifying no effectiveAt will delete all properties  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_portfolio_properties_with_http_info(scope, code, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['scope', 'code', 'effective_at', 'portfolio_property_keys']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_portfolio(self, scope, code, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Get portfolio definition  # noqa: E501

        Retrieves the basic set of information about a portfolio using the specified scope and code.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_portfolio_commands(self, scope, code, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Get commands  # noqa: E501

        Gets all commands that modified a specific portfolio, including any input transactions.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_portfolio_properties(self, scope, code, **kwargs):  # noqa: E501
        ...
        Get the properties of a portfolio  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_portfolio_properties_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        all_params = ['scope', 'code', 'effective_at', 'as_at', 'sort_by', 'start', 'limit']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def list_portfolios(self, **kwargs):  # noqa: E501
        ...
        :param str effective_at: Optional. The effective date of the data
        :param datetime as_at: Optional. The AsAt date of the data
        :param str page: Optional. The pagination token to continue listing portfolios. This value is returned from a previous call to ListPortfolios.  If this is set, then the sortBy, filter, query, effectiveAt, and asAt fields must not have changed. Also, if set, a start  value cannot be set.
        :param list[str] sort_by: Optional. Order the results by these fields. Use use the '-' sign to denote descending order e.g. -MyFieldName
        :param int start: Optional. When paginating, skip this number of results
        :param int limit: Optional. When paginating, limit the number of returned results to this many.
        :param str filter: Optional. Expression to filter the result set
        :param str query: Optional. Expression specifying the criteria that the returned portfolios must meet
        :param list[str] portfolio_property_keys: Optional. Keys of the properties to be decorated on to the portfolio
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def list_portfolios_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['effective_at', 'as_at', 'page', 'sort_by', 'start', 'limit', 'filter', 'query', 'portfolio_property_keys']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def list_portfolios_for_scope(self, scope, **kwargs):  # noqa: E501
        ...
        List all the portfolios in the specified scope  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def list_portfolios_for_scope_with_http_info(self, scope, **kwargs):  # noqa: E501
        ...
        all_params = ['scope', 'effective_at', 'as_at', 'sort_by', 'start', 'limit', 'filter', 'portfolio_property_keys']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def update_portfolio(self, scope, code, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Update portfolio definition  # noqa: E501

        Update the definition of a specific portfolio. Note, some parts of a portfolio definition are not available for modification after the initial creation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param str scope: The scope of the portfolio (required)
        :param str code: The code of the portfolio (required)
        :param str effective_at: Optional. The effective date for the change
    ...
    def upsert_portfolio_properties(self, scope, code, **kwargs):  # noqa: E501
        ...
        Upsert one or more property values to a portfolio. All properties must be of the domain Portfolio.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param str scope: The scope of the portfolio (required)
        :param str code: The code of the portfolio (required)
        :param dict(str, ModelProperty) portfolio_properties: The property values to be upserted to the portfolio. Time variant properties must have an EffectiveFrom date.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
