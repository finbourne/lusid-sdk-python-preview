...
class PortfoliosApi(object):
    ...
    def delete_key_from_portfolio_access_metadata_with_http_info(self, scope, code, metadata_key, **kwargs):  # noqa: E501
        ...
        if ('metadata_key' in local_var_params and
                len(local_var_params['metadata_key']) > 64):
            raise ApiValueError("Invalid value for parameter `metadata_key` when calling `delete_key_from_portfolio_access_metadata`, length must be less than or equal to `64`")  # noqa: E501
        if ('metadata_key' in local_var_params and
        ...
        if 'metadata_key' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['metadata_key']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `metadata_key` when calling `delete_key_from_portfolio_access_metadata`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) > 40):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `delete_key_from_portfolio_access_metadata`, length must be less than or equal to `40`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) < 0):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `delete_key_from_portfolio_access_metadata`, length must be greater than or equal to `0`")  # noqa: E501
        if 'effective_at' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_ \+:\/\.]+$', local_var_params['effective_at']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `delete_key_from_portfolio_access_metadata`, must conform to the pattern `/^[a-zA-Z0-9\-_ \+:\/\.]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def delete_portfolio_properties_with_http_info(self, scope, code, property_keys, **kwargs):  # noqa: E501
        ...
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) > 40):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `delete_portfolio_properties`, length must be less than or equal to `40`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) < 0):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `delete_portfolio_properties`, length must be greater than or equal to `0`")  # noqa: E501
        if 'effective_at' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_ \+:\/\.]+$', local_var_params['effective_at']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `delete_portfolio_properties`, must conform to the pattern `/^[a-zA-Z0-9\-_ \+:\/\.]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_portfolio_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) > 40):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_portfolio`, length must be less than or equal to `40`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) < 0):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_portfolio`, length must be greater than or equal to `0`")  # noqa: E501
        if 'effective_at' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_ \+:\/\.]+$', local_var_params['effective_at']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_portfolio`, must conform to the pattern `/^[a-zA-Z0-9\-_ \+:\/\.]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_portfolio_commands_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('filter' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `filter` when calling `get_portfolio_commands`, length must be less than or equal to `2147483647`")  # noqa: E501
        if ('filter' in local_var_params and
        ...
        if 'filter' in local_var_params and not re.search(r'(?s).*', local_var_params['filter']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `filter` when calling `get_portfolio_commands`, must conform to the pattern `/(?s).*/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_portfolio_metadata_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) > 40):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_portfolio_metadata`, length must be less than or equal to `40`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) < 0):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_portfolio_metadata`, length must be greater than or equal to `0`")  # noqa: E501
        if 'effective_at' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_ \+:\/\.]+$', local_var_params['effective_at']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_portfolio_metadata`, must conform to the pattern `/^[a-zA-Z0-9\-_ \+:\/\.]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_portfolio_properties_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) > 40):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_portfolio_properties`, length must be less than or equal to `40`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) < 0):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_portfolio_properties`, length must be greater than or equal to `0`")  # noqa: E501
        if 'effective_at' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_ \+:\/\.]+$', local_var_params['effective_at']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_portfolio_properties`, must conform to the pattern `/^[a-zA-Z0-9\-_ \+:\/\.]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_portfolio_relations_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) > 40):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_portfolio_relations`, length must be less than or equal to `40`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) < 0):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_portfolio_relations`, length must be greater than or equal to `0`")  # noqa: E501
        if 'effective_at' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_ \+:\/\.]+$', local_var_params['effective_at']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_portfolio_relations`, must conform to the pattern `/^[a-zA-Z0-9\-_ \+:\/\.]+$/`")  # noqa: E501
        if ('filter' in local_var_params and
                len(local_var_params['filter']) > 2147483647):
            raise ApiValueError("Invalid value for parameter `filter` when calling `get_portfolio_relations`, length must be less than or equal to `2147483647`")  # noqa: E501
        if ('filter' in local_var_params and
                len(local_var_params['filter']) < 0):
        ...
        if 'filter' in local_var_params and not re.search(r'(?s).*', local_var_params['filter']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `filter` when calling `get_portfolio_relations`, must conform to the pattern `/(?s).*/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_portfolio_returns_with_http_info(self, scope, code, return_scope, return_code, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(ResourceListOfReturn, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ResourceListOfReturn',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def get_portfolios_access_metadata_by_key_with_http_info(self, scope, code, metadata_key, **kwargs):  # noqa: E501
        ...
        if ('metadata_key' in local_var_params and
                len(local_var_params['metadata_key']) > 64):
            raise ApiValueError("Invalid value for parameter `metadata_key` when calling `get_portfolios_access_metadata_by_key`, length must be less than or equal to `64`")  # noqa: E501
        if ('metadata_key' in local_var_params and
                len(local_var_params['metadata_key']) < 1):
        ...
        if 'metadata_key' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['metadata_key']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `metadata_key` when calling `get_portfolios_access_metadata_by_key`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) > 40):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_portfolios_access_metadata_by_key`, length must be less than or equal to `40`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) < 0):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_portfolios_access_metadata_by_key`, length must be greater than or equal to `0`")  # noqa: E501
        if 'effective_at' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_ \+:\/\.]+$', local_var_params['effective_at']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `get_portfolios_access_metadata_by_key`, must conform to the pattern `/^[a-zA-Z0-9\-_ \+:\/\.]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def list_portfolios_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) > 40):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `list_portfolios`, length must be less than or equal to `40`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) < 0):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `list_portfolios`, length must be greater than or equal to `0`")  # noqa: E501
        if 'effective_at' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_ \+:\/\.]+$', local_var_params['effective_at']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `list_portfolios`, must conform to the pattern `/^[a-zA-Z0-9\-_ \+:\/\.]+$/`")  # noqa: E501
        if ('page' in local_var_params and
                len(local_var_params['page']) > 200):
            raise ApiValueError("Invalid value for parameter `page` when calling `list_portfolios`, length must be less than or equal to `200`")  # noqa: E501
        if ('page' in local_var_params and
        ...
        if ('filter' in local_var_params and
                len(local_var_params['filter']) > 2147483647):
            raise ApiValueError("Invalid value for parameter `filter` when calling `list_portfolios`, length must be less than or equal to `2147483647`")  # noqa: E501
        if ('filter' in local_var_params and
                len(local_var_params['filter']) < 0):
        ...
        if 'filter' in local_var_params and not re.search(r'(?s).*', local_var_params['filter']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `filter` when calling `list_portfolios`, must conform to the pattern `/(?s).*/`")  # noqa: E501
        if ('query' in local_var_params and
                len(local_var_params['query']) > 6000):
            raise ApiValueError("Invalid value for parameter `query` when calling `list_portfolios`, length must be less than or equal to `6000`")  # noqa: E501
        if ('query' in local_var_params and
                len(local_var_params['query']) < 0):
        ...
        if 'query' in local_var_params and not re.search(r'(?s).*', local_var_params['query']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `query` when calling `list_portfolios`, must conform to the pattern `/(?s).*/`")  # noqa: E501
        collection_formats = {}
    ...
    def list_portfolios_for_scope_with_http_info(self, scope, **kwargs):  # noqa: E501
        ...
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) > 40):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `list_portfolios_for_scope`, length must be less than or equal to `40`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) < 0):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `list_portfolios_for_scope`, length must be greater than or equal to `0`")  # noqa: E501
        if 'effective_at' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_ \+:\/\.]+$', local_var_params['effective_at']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `list_portfolios_for_scope`, must conform to the pattern `/^[a-zA-Z0-9\-_ \+:\/\.]+$/`")  # noqa: E501
        if ('page' in local_var_params and
                len(local_var_params['page']) > 200):
            raise ApiValueError("Invalid value for parameter `page` when calling `list_portfolios_for_scope`, length must be less than or equal to `200`")  # noqa: E501
        if ('page' in local_var_params and
                len(local_var_params['page']) < 1):
        ...
        if ('filter' in local_var_params and
                len(local_var_params['filter']) > 2147483647):
            raise ApiValueError("Invalid value for parameter `filter` when calling `list_portfolios_for_scope`, length must be less than or equal to `2147483647`")  # noqa: E501
        if ('filter' in local_var_params and
                len(local_var_params['filter']) < 0):
        ...
        if 'filter' in local_var_params and not re.search(r'(?s).*', local_var_params['filter']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `filter` when calling `list_portfolios_for_scope`, must conform to the pattern `/(?s).*/`")  # noqa: E501
        collection_formats = {}
    ...
    def update_portfolio_with_http_info(self, scope, code, update_portfolio_request, **kwargs):  # noqa: E501
        ...
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) > 40):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `update_portfolio`, length must be less than or equal to `40`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) < 0):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `update_portfolio`, length must be greater than or equal to `0`")  # noqa: E501
        if 'effective_at' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_ \+:\/\.]+$', local_var_params['effective_at']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `update_portfolio`, must conform to the pattern `/^[a-zA-Z0-9\-_ \+:\/\.]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def upsert_portfolio_access_metadata_with_http_info(self, scope, code, metadata_key, upsert_portfolio_access_metadata_request, **kwargs):  # noqa: E501
        ...
        if ('metadata_key' in local_var_params and
                len(local_var_params['metadata_key']) > 64):
            raise ApiValueError("Invalid value for parameter `metadata_key` when calling `upsert_portfolio_access_metadata`, length must be less than or equal to `64`")  # noqa: E501
        if ('metadata_key' in local_var_params and
                len(local_var_params['metadata_key']) < 1):
        ...
        if 'metadata_key' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['metadata_key']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `metadata_key` when calling `upsert_portfolio_access_metadata`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) > 40):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `upsert_portfolio_access_metadata`, length must be less than or equal to `40`")  # noqa: E501
        if ('effective_at' in local_var_params and
                len(local_var_params['effective_at']) < 0):
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `upsert_portfolio_access_metadata`, length must be greater than or equal to `0`")  # noqa: E501
        if 'effective_at' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_ \+:\/\.]+$', local_var_params['effective_at']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `effective_at` when calling `upsert_portfolio_access_metadata`, must conform to the pattern `/^[a-zA-Z0-9\-_ \+:\/\.]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def upsert_portfolio_returns(self, scope, code, return_scope, return_code, model_return, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Upsert Returns  # noqa: E501

        Update or insert returns into the specified portfolio.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_portfolio_returns(scope, code, return_scope, return_code, model_return, async_req=True)
        >>> result = thread.get()
        ...
        :param str return_scope: The scope of the Returns. (required)
        :param str return_code: The code of the Returns. (required)
        :param list[ModelReturn] model_return: This contains the Returns which need to be upsert. (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.upsert_portfolio_returns_with_http_info(scope, code, return_scope, return_code, model_return, **kwargs)  # noqa: E501

    def upsert_portfolio_returns_with_http_info(self, scope, code, return_scope, return_code, model_return, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Upsert Returns  # noqa: E501

        Update or insert returns into the specified portfolio.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_portfolio_returns_with_http_info(scope, code, return_scope, return_code, model_return, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['scope', 'code', 'return_scope', 'return_code', 'model_return']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('model_return' not in local_var_params or
                local_var_params['model_return'] is None):
            raise ApiValueError("Missing the required parameter `model_return` when calling `upsert_portfolio_returns`")  # noqa: E501
        ...
        body_params = None
        if 'model_return' in local_var_params:
            body_params = local_var_params['model_return']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['text/plain', 'application/json', 'text/json'])  # noqa: E501
