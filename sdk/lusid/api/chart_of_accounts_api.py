...
class ChartOfAccountsApi(object):
    ...
    def upsert_accounts_properties_with_http_info(self, scope, code, account_code, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('scope' not in local_var_params or  # noqa: E501
                                                        local_var_params['scope'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `scope` when calling `upsert_accounts_properties`")  # noqa: E501
        # verify the required parameter 'code' is set
        if self.api_client.client_side_validation and ('code' not in local_var_params or  # noqa: E501
                                                        local_var_params['code'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `code` when calling `upsert_accounts_properties`")  # noqa: E501
        # verify the required parameter 'account_code' is set
        if self.api_client.client_side_validation and ('account_code' not in local_var_params or  # noqa: E501
                                                        local_var_params['account_code'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `account_code` when calling `upsert_accounts_properties`")  # noqa: E501
