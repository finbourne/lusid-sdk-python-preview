...
class TransactionPortfoliosApi(object):
    ...
    def adjust_holdings_with_http_info(self, scope, code, effective_at, adjust_holding_request, **kwargs):  # noqa: E501
        ...
        header_params['X-LUSID-SDK-Version'] = '0.11.3107-mark'
    ...
    def cancel_executions(self, scope, code, execution_ids, **kwargs):  # noqa: E501
        ...
        :param code: The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio. (required)
        :type code: str
        :param execution_ids: The ids of the executions to cancel. (required)
    ...
    def get_a2_b_data(self, scope, code, from_effective_at, to_effective_at, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Get an A2B report for the given portfolio.  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ResourceListOfA2BDataRecord
        """
        kwargs['_return_http_data_only'] = True
    ...
    def get_a2_b_data_with_http_info(self, scope, code, from_effective_at, to_effective_at, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ResourceListOfA2BDataRecord, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        response_types_map = {
            200: "ResourceListOfA2BDataRecord",
            400: "LusidValidationProblemDetails",
        }
    ...
    def get_a2_b_movements(self, scope, code, from_effective_at, to_effective_at, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ResourceListOfA2BMovementRecord
        """
        kwargs['_return_http_data_only'] = True
    ...
    def get_a2_b_movements_with_http_info(self, scope, code, from_effective_at, to_effective_at, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ResourceListOfA2BMovementRecord, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        response_types_map = {
            200: "ResourceListOfA2BMovementRecord",
            400: "LusidValidationProblemDetails",
        }
    ...
    def get_holdings(self, scope, code, **kwargs):  # noqa: E501
        ...
        :type effective_at: str
        :param as_at: The as-at datetime at which to retrieve the holdings of the transaction portfolio. Defaults              to return the latest version if not specified.
        :type as_at: datetime
    ...
    def get_portfolio_cash_flows(self, scope, code, effective_at, window_start, window_end, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Get portfolio cash flows  # noqa: E501
        ...
        >>> thread = api.get_portfolio_cash_flows(scope, code, effective_at, window_start, window_end, async_req=True)
        >>> result = thread.get()
        ...
        :type window_end: str
        :param as_at: The as-at datetime at which to retrieve the data. Defaults to returning the latest version               of each transaction if not specified.
        :type as_at: datetime
        :param filter: Expression to filter the result set.                For example, to return only transactions with a transaction type of 'Buy', specify \"type eq 'Buy'\".               For more information about filtering LUSID results, see https://support.lusid.com/knowledgebase/article/KA-01914.
        :type filter: str
        :param recipe_id_scope: The scope of the given recipeId
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_portfolio_cash_flows_with_http_info(scope, code, effective_at, window_start, window_end, **kwargs)  # noqa: E501

    def get_portfolio_cash_flows_with_http_info(self, scope, code, effective_at, window_start, window_end, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Get portfolio cash flows  # noqa: E501
        ...
        >>> thread = api.get_portfolio_cash_flows_with_http_info(scope, code, effective_at, window_start, window_end, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('effective_at' not in local_var_params or  # noqa: E501
                                                        local_var_params['effective_at'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `effective_at` when calling `get_portfolio_cash_flows`")  # noqa: E501
        # verify the required parameter 'window_start' is set
        if self.api_client.client_side_validation and ('window_start' not in local_var_params or  # noqa: E501
                                                        local_var_params['window_start'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `window_start` when calling `get_portfolio_cash_flows`")  # noqa: E501
        # verify the required parameter 'window_end' is set
        if self.api_client.client_side_validation and ('window_end' not in local_var_params or  # noqa: E501
                                                        local_var_params['window_end'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `window_end` when calling `get_portfolio_cash_flows`")  # noqa: E501
    ...
    def get_portfolio_cash_ladder(self, scope, code, from_effective_at, to_effective_at, **kwargs):  # noqa: E501
        ...
        :param to_effective_at: The upper bound effective datetime or cut label (inclusive) from which to retrieve the data.              There is no upper bound if this is not specified. (required)
        :type to_effective_at: str
        :param as_at: The as-at datetime at which to retrieve the portfolio. Defaults to returning the latest version              of each transaction if not specified.
        :type as_at: datetime
        :param filter: Expression to filter the result set.               For example, to return only transactions with a transaction type of 'Buy', specify \"type eq 'Buy'\".              For more information about filtering LUSID results, see https://support.lusid.com/knowledgebase/article/KA-01914.
        :type filter: str
        :param recipe_id_scope: The scope of the given recipeId
    ...
    def get_transactions(self, scope, code, **kwargs):  # noqa: E501
        ...
        :param as_at: The as-at datetime at which to retrieve transactions. Defaults to returning the latest version              of each transaction if not specified.
        :type as_at: datetime
    ...
    def get_upsertable_portfolio_cash_flows(self, scope, code, effective_at, window_start, window_end, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Get upsertable portfolio cash flows.  # noqa: E501
        ...
        >>> thread = api.get_upsertable_portfolio_cash_flows(scope, code, effective_at, window_start, window_end, async_req=True)
        >>> result = thread.get()
        ...
        :param window_end: The upper bound effective datetime or cut label (inclusive) from which to retrieve the cashflows.               The upper bound defaults to 'today' if it is not specified (required)
        :type window_end: str
        :param as_at: The as-at datetime at which to retrieve the portfolio. Defaults to return the latest version               of each transaction if not specified.
        :type as_at: datetime
        :param filter: Expression to filter the result set.                For example, to return only transactions with a transaction type of 'Buy', specify \"type eq 'Buy'\".               For more information about filtering LUSID results, see https://support.lusid.com/knowledgebase/article/KA-01914.
        :type filter: str
        :param recipe_id_scope: The scope of the given recipeId
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_upsertable_portfolio_cash_flows_with_http_info(scope, code, effective_at, window_start, window_end, **kwargs)  # noqa: E501

    def get_upsertable_portfolio_cash_flows_with_http_info(self, scope, code, effective_at, window_start, window_end, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Get upsertable portfolio cash flows.  # noqa: E501
        ...
        >>> thread = api.get_upsertable_portfolio_cash_flows_with_http_info(scope, code, effective_at, window_start, window_end, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('effective_at' not in local_var_params or  # noqa: E501
                                                        local_var_params['effective_at'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `effective_at` when calling `get_upsertable_portfolio_cash_flows`")  # noqa: E501
        # verify the required parameter 'window_start' is set
        if self.api_client.client_side_validation and ('window_start' not in local_var_params or  # noqa: E501
                                                        local_var_params['window_start'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `window_start` when calling `get_upsertable_portfolio_cash_flows`")  # noqa: E501
        # verify the required parameter 'window_end' is set
        if self.api_client.client_side_validation and ('window_end' not in local_var_params or  # noqa: E501
                                                        local_var_params['window_end'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `window_end` when calling `get_upsertable_portfolio_cash_flows`")  # noqa: E501
    ...
    def upsert_executions(self, scope, code, **kwargs):  # noqa: E501
        ...
        :param code: The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio. (required)
        :type code: str
        :param execution_request: The executions to update or insert.
        :type execution_request: list[ExecutionRequest]
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: UpsertPortfolioExecutionsResponse
        """
        kwargs['_return_http_data_only'] = True
    ...
    def upsert_executions_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(UpsertPortfolioExecutionsResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        response_types_map = {
            200: "UpsertPortfolioExecutionsResponse",
            400: "LusidValidationProblemDetails",
        }
    ...
    def upsert_portfolio_details(self, scope, code, create_portfolio_details, **kwargs):  # noqa: E501
        ...
        Update or insert details that can be changed for a transaction portfolio once it has been created. The details will be updated  if they already exist and inserted if they do not.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param code: The code of the transaction portfolio. Together with the              scope this uniquely identifies the transaction portfolio. (required)
        :type code: str
        :param create_portfolio_details: The details to update or insert for the specified transaction portfolio. (required)
    ...
    def upsert_transaction_properties(self, scope, code, transaction_id, request_body, **kwargs):  # noqa: E501
        ...
        :param code: The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio. (required)
        :type code: str
        :param transaction_id: The unique ID of the transaction to update or insert properties for. (required)
        :type transaction_id: str
        :param request_body: The properties and their associated values to update or insert. (required)
    ...
    def upsert_transactions(self, scope, code, transaction_request, **kwargs):  # noqa: E501
        ...
        Update or insert transactions into the transaction portfolio. A transaction will be updated  if it already exists and inserted if it does not.  The maximum number of transactions that this method can upsert per request is 10,000.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param code: The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio. (required)
        :type code: str
        :param transaction_request: A list of transactions to be updated or inserted. (required)
