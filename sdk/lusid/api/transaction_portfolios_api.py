...
class TransactionPortfoliosApi(object):
    ...
    def adjust_holdings_with_http_info(self, scope, code, effective_at, adjust_holding_request, **kwargs):  # noqa: E501
        ...
        header_params['X-LUSID-SDK-Version'] = '0.11.3056'
    ...
    def get_holdings(self, scope, code, **kwargs):  # noqa: E501
        ...
        :param datetime as_at: The as-at datetime at which to retrieve the holdings of the transaction portfolio. Defaults              to return the latest version if not specified.
    ...
    def get_portfolio_cash_flows(self, scope, code, effective_at, window_start, window_end, **kwargs):  # noqa: E501
        ...
        :param str window_start: The lower bound effective datetime or cut label (inclusive) from which to retrieve the cashflows.               There is no lower bound if this is not specified. (required)
        :param str window_end: The upper bound effective datetime or cut label (inclusive) from which to retrieve the cashflows.               The upper bound defaults to 'today' if it is not specified (required)
        :param datetime as_at: The as-at datetime at which to retrieve the data. Defaults to returning the latest version               of each transaction if not specified.
        :param str filter: Expression to filter the result set.                For example, to return only transactions with a transaction type of 'Buy', specify \"type eq 'Buy'\".               For more information about filtering LUSID results, see https://support.lusid.com/knowledgebase/article/KA-01914.
        :param str recipe_id_scope: The scope of the given recipeId
        :param str recipe_id_code: The code of the given recipeID
        :param _preload_content: if False, the urllib3.HTTPResponse object will
    ...
    def get_portfolio_cash_flows_with_http_info(self, scope, code, effective_at, window_start, window_end, **kwargs):  # noqa: E501
        ...
        if ('window_start' not in local_var_params or
                local_var_params['window_start'] is None):
        ...
        if ('window_end' not in local_var_params or
                local_var_params['window_end'] is None):
    ...
    def get_portfolio_cash_statement(self, scope, code, from_effective_at, to_effective_at, **kwargs):  # noqa: E501
        ...
        :param str from_effective_at: The lower bound effective datetime or cut label (inclusive) from which to retrieve the data.              There is no lower bound if this is not specified. (required)
        :param str to_effective_at: The upper bound effective datetime or cut label (inclusive) from which to retrieve the data.              There is no upper bound if this is not specified. (required)
        :param datetime as_at: The as-at datetime at which to retrieve the portfolio. Defaults to returning the latest version              of each transaction if not specified.
        :param str filter: Expression to filter the result set.               For example, to return only transactions with a transaction type of 'Buy', specify \"type eq 'Buy'\".              For more information about filtering LUSID results, see https://support.lusid.com/knowledgebase/article/KA-01914.
        :param str recipe_id_scope: The scope of the given recipeId
        :param str recipe_id_code: The code of the given recipeID
        :param _preload_content: if False, the urllib3.HTTPResponse object will
    ...
    def get_transactions(self, scope, code, **kwargs):  # noqa: E501
        ...
        :param datetime as_at: The as-at datetime at which to retrieve transactions. Defaults to returning the latest version              of each transaction if not specified.
    ...
    def get_upsertable_portfolio_cash_flows(self, scope, code, effective_at, window_start, window_end, **kwargs):  # noqa: E501
        ...
        :param str window_start: The lower bound effective datetime or cut label (inclusive) from which to retrieve the cashflows.               There is no lower bound if this is not specified. (required)
        :param str window_end: The upper bound effective datetime or cut label (inclusive) from which to retrieve the cashflows.               The upper bound defaults to 'today' if it is not specified (required)
        :param datetime as_at: The as-at datetime at which to retrieve the portfolio. Defaults to return the latest version               of each transaction if not specified.
        :param str filter: Expression to filter the result set.                For example, to return only transactions with a transaction type of 'Buy', specify \"type eq 'Buy'\".               For more information about filtering LUSID results, see https://support.lusid.com/knowledgebase/article/KA-01914.
        :param str recipe_id_scope: The scope of the given recipeId
        :param str recipe_id_code: The code of the given recipeID
        :param _preload_content: if False, the urllib3.HTTPResponse object will
    ...
    def upsert_transaction_properties(self, scope, code, transaction_id, request_body, **kwargs):  # noqa: E501
        ...
        :param str scope: The scope of the transaction portfolio. (required)
        :param str code: The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio. (required)
        :param str transaction_id: The unique ID of the transaction to update or insert properties for. (required)
        :param dict(str, PerpetualProperty) request_body: The properties and their associated values to update or insert. (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def upsert_transactions(self, scope, code, transaction_request, **kwargs):  # noqa: E501
        ...
        :param str scope: The scope of the transaction portfolio. (required)
        :param str code: The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio. (required)
        :param list[TransactionRequest] transaction_request: A list of transactions to be updated or inserted. (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
