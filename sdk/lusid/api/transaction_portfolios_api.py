...
"""
    ...
    The version of the OpenAPI document: 0.10.467
...
class TransactionPortfoliosApi(object):
    ...
    def add_transaction_property(self, scope, code, transaction_id, transaction_properties, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Add transaction property  # noqa: E501

        Update or insert one or more transaction properties to a single transaction in a transaction portfolio.  Each property will be updated if it already exists and inserted if it does not.  # noqa: E501
        ...
        :param dict(str, PerpetualPropertyValue) transaction_properties: The properties with their associated values to update or insert onto the              transaction. (required)
    ...
    def add_transaction_property_with_http_info(self, scope, code, transaction_id, transaction_properties, **kwargs):  # noqa: E501
        ...
        header_params['X-LUSID-SDK-Version'] = '0.10.467'
    ...
    def adjust_holdings(self, scope, code, effective_at, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Adjust holdings  # noqa: E501
        ...
        :param str scope: The scope of the transaction portfolio. (required)
        :param str code: The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio. (required)
        :param str effective_at: The effective datetime at which the holdings should be set to the provided targets. (required)
    ...
    def build_transactions(self, scope, code, parameters, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Build transactions  # noqa: E501
    ...
    def cancel_adjust_holdings(self, scope, code, effective_at, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Cancel adjust holdings  # noqa: E501
        ...
        :param str scope: The scope of the transaction portfolio. (required)
        :param str code: The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio. (required)
        :param str effective_at: The effective datetime at which the holding adjustments should be undone. (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def cancel_transactions(self, scope, code, transaction_ids, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Cancel transactions  # noqa: E501
    ...
    def create_portfolio(self, scope, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Create portfolio  # noqa: E501
    ...
    def delete_property_from_transaction(self, scope, code, transaction_id, transaction_property_key, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Delete property from transaction  # noqa: E501
        ...
        :param str transaction_property_key: The property key of the property value to delete from the transaction.              This must be from the \"Transaction\" domain and will have the format {domain}/{scope}/{code} e.g.              \"Transaction/strategy/quantsignal\". (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def get_details(self, scope, code, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Get details  # noqa: E501
        ...
        :param str effective_at: The effective datetime at which to retrieve the details of the transaction              portfolio. Defaults to the current LUSID system datetime if not specified.
    ...
    def get_holdings(self, scope, code, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Get holdings  # noqa: E501
        ...
        :param str effective_at: The effective datetime at which to retrieve the holdings of the transaction              portfolio. Defaults to the current LUSID system datetime if not specified.
    ...
    def get_holdings_adjustment(self, scope, code, effective_at, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Get holdings adjustment  # noqa: E501
        ...
        :param str scope: The scope of the transaction portfolio. (required)
        :param str code: The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio. (required)
        :param str effective_at: The effective datetime of the holdings adjustment. (required)
    ...
    def get_transactions(self, scope, code, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Get transactions  # noqa: E501
        ...
        :param str scope: The scope of the transaction portfolio. (required)
        :param str code: The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio. (required)
        :param str from_transaction_date: The lower bound effective datetime (inclusive) from which to retrieve the transactions.              There is no lower bound if this is not specified.
        :param str to_transaction_date: The upper bound effective datetime (inclusive) from which to retrieve transactions.              There is no upper bound if this is not specified.
    ...
    def list_holdings_adjustments(self, scope, code, **kwargs):  # noqa: E501
        """[EARLY ACCESS] List holdings adjustments  # noqa: E501
        ...
        :param str scope: The scope of the transaction portfolio. (required)
        :param str code: The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio. (required)
        :param str from_effective_at: The lower bound effective datetime (inclusive) from which to retrieve the holdings              adjustments. There is no lower bound if this is not specified.
        :param str to_effective_at: The upper bound effective datetime (inclusive) from which to retrieve the holdings              adjustments. There is no upper bound if this is not specified.
    ...
    def set_holdings(self, scope, code, effective_at, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Set holdings  # noqa: E501
    ...
    def upsert_portfolio_details(self, scope, code, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Upsert portfolio details  # noqa: E501
        ...
        :param str effective_at: The effective datetime at which the updated or inserted details should become valid.              Defaults to the current LUSID system datetime if not specified.
        :param CreatePortfolioDetails details: The details to update or insert for the specified transaction portfolio.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def upsert_transactions(self, scope, code, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Upsert transactions  # noqa: E501

        Update or insert transactions into the specified transaction portfolio. A transaction will be updated  if it already exists and inserted if it does not.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param str scope: The scope of the transaction portfolio. (required)
        :param str code: The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio. (required)
        :param list[TransactionRequest] transactions: The transactions to be updated or inserted.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
