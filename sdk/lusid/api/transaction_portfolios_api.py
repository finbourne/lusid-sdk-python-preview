...
class TransactionPortfoliosApi(object):
    ...
    def adjust_holdings_with_http_info(self, scope, code, effective_at, adjust_holding_request, **kwargs):  # noqa: E501
        ...
        header_params['X-LUSID-SDK-Version'] = '0.11.4787'
    ...
    def create_trade_ticket(self, scope, code, **kwargs):  # noqa: E501
        ...
        :param code: The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio. (required)
        :type code: str
        :param trade_ticket: the trade ticket to upsert
        :type trade_ticket: TradeTicket
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def create_trade_ticket_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object, the HTTP status code, and the headers.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: (TradeTicket, int, HTTPHeaderDict)
        """
        ...
        body_params = None
        if 'trade_ticket' in local_var_params:
            body_params = local_var_params['trade_ticket']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['text/plain', 'application/json', 'text/json'])  # noqa: E501
