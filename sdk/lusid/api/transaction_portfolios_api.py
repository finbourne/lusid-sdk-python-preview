...
class TransactionPortfoliosApi(object):
    ...
    def add_transaction_property(self, scope, code, transaction_id, **kwargs):  # noqa: E501
        ...
        :param dict(str, PerpetualPropertyValue) transaction_properties: Transaction properties values
    ...
    def add_transaction_property_with_http_info(self, scope, code, transaction_id, **kwargs):  # noqa: E501
        ...
        header_params['X-LUSID-SDK-Version'] = '0.10.312'
    ...
    def adjust_holdings(self, scope, code, effective_at, **kwargs):  # noqa: E501
        ...
        :param str scope: The scope of the portfolio (required)
        :param str code: The code of the portfolio (required)
        :param str effective_at: The effective date of the change (required)
        :param list[AdjustHoldingRequest] holding_adjustments: The selected set of holdings adjustments
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def build_transactions(self, scope, code, **kwargs):  # noqa: E501
        ...
        :param list[str] property_keys: Optional. Keys for the transaction or instrument property values that will be decorated onto the transactions. No properties will be decorated if none are specified.
        :param str filter: Optional. Expression to filter the result set
        :param TransactionQueryParameters parameters: Optional. Transaction query parameters
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def build_transactions_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        all_params = ['scope', 'code', 'as_at', 'sort_by', 'start', 'limit', 'property_keys', 'filter', 'parameters']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def create_portfolio(self, scope, **kwargs):  # noqa: E501
        ...
        :param CreateTransactionPortfolioRequest create_request: The transaction portfolio definition
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def get_details(self, scope, code, **kwargs):  # noqa: E501
        ...
        :param str scope: The scope of the portfolio (required)
        :param str code: The code of the portfolio (required)
        :param str effective_at: Optional. The effective date of the data
        :param datetime as_at: Optional. The AsAt date of the data
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
    ...
    def get_holdings(self, scope, code, **kwargs):  # noqa: E501
        ...
        :param str effective_at: Optional. The effective date of the portfolio
        :param datetime as_at: Optional. The AsAt date of the data
        :param list[str] sort_by: Optional. Order the results by these fields. Use use the '-' sign to denote descending order e.g. -MyFieldName
        :param int start: Optional. When paginating, skip this number of results
        :param int limit: Optional. When paginating, limit the number of returned results to this many.
        :param str filter: Optional. Expression to filter the result set
        :param list[str] property_keys: Optional. Keys for the Holding or instrument property values that will be decorated onto the transactions. No properties will be decorated if none are specified.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def get_holdings_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        all_params = ['scope', 'code', 'by_taxlots', 'effective_at', 'as_at', 'sort_by', 'start', 'limit', 'filter', 'property_keys']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_holdings_adjustment(self, scope, code, effective_at, **kwargs):  # noqa: E501
        ...
        :param str scope: The scope of the portfolio (required)
        :param str code: The code of the portfolio (required)
        :param str effective_at: The effective time of the holdings adjustment (required)
        :param datetime as_at: Optional. The AsAt date of the data
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
    ...
    def get_transactions(self, scope, code, **kwargs):  # noqa: E501
        ...
        :param str scope: The scope of the portfolio (required)
        :param str code: The code of the portfolio (required)
        :param str from_transaction_date: Optional. Limit the returned transactions to those with a transaction date equal or later than this date
        :param str to_transaction_date: Optional. Limit the returned transactions to those with a transaction date equal or before this date
        :param datetime as_at: Optional. The AsAt date of the data
        :param list[str] sort_by: Optional. Order the results by these fields. Use use the '-' sign to denote descending order e.g. -MyFieldName
        :param int start: Optional. When paginating, skip this number of results
        :param int limit: Optional. When paginating, limit the number of returned results to this many.
    ...
    def get_transactions_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        all_params = ['scope', 'code', 'from_transaction_date', 'to_transaction_date', 'as_at', 'sort_by', 'start', 'limit', 'property_keys', 'filter']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def list_holdings_adjustments(self, scope, code, **kwargs):  # noqa: E501
        ...
        :param str scope: The scope of the portfolio (required)
        :param str code: Code for the portfolio (required)
        :param str from_effective_at: Holdings adjustments between this time (inclusive) and the toEffectiveAt are returned.
        :param str to_effective_at: Holdings adjustments between this time (inclusive) and the fromEffectiveAt are returned.
        :param datetime as_at: Optional. The AsAt date of the data
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
    ...
    def set_holdings(self, scope, code, effective_at, **kwargs):  # noqa: E501
        ...
        :param str effective_at: The effective date of the change (required)
        :param list[AdjustHoldingRequest] holding_adjustments: The complete set of holdings adjustments for the portfolio
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def upsert_executions(self, scope, code, **kwargs):  # noqa: E501
        ...
        :param str scope: The scope of the portfolio (required)
        :param str code: The code of the portfolio (required)
        :param list[ExecutionRequest] executions: The executions to be updated
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def upsert_portfolio_details(self, scope, code, **kwargs):  # noqa: E501
        ...
        :param str scope: The scope of the portfolio (required)
        :param str code: The code of the portfolio (required)
        :param str effective_at: Optional. The effective date of the change
        :param CreatePortfolioDetails details: The set of details for the portfolio
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
