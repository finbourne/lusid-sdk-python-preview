...
class CounterpartyApi(object):
    ...
    def get_counterparty(self, scope, code, **kwargs):  # noqa: E501
        ...
        :type code: str
        :param as_at: The asAt datetime at which to retrieve the counterparty. Defaults to return the latest version if not specified.
        :type as_at: datetime
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
    ...
    def get_counterparty_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetCounterpartyResponse, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def get_credit_support_annex(self, scope, code, **kwargs):  # noqa: E501
        ...
        :type code: str
        :param as_at: The asAt datetime at which to retrieve the CSA. Defaults to return the latest version if not specified.
        :type as_at: datetime
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
    ...
    def list_counterparties(self, **kwargs):  # noqa: E501
        ...
        :param as_at: The asAt datetime at which to list the counterparty. Defaults to latest if not specified.
        :type as_at: datetime
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ResourceListOfGetCounterpartyResponse
        """
        kwargs['_return_http_data_only'] = True
    ...
    def list_counterparties_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ResourceListOfGetCounterpartyResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        response_types_map = {
            200: "ResourceListOfGetCounterpartyResponse",
            400: "LusidValidationProblemDetails",
        }
    ...
    def list_credit_support_annexes(self, **kwargs):  # noqa: E501
        ...
        :param as_at: The asAt datetime at which to list the CSAs. Defaults to latest if not specified.
        :type as_at: datetime
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
    ...
    def upsert_counterparty(self, upsert_counterparty_request, **kwargs):  # noqa: E501
        ...
        :param upsert_counterparty_request: The Counterparty to update or insert (required)
        :type upsert_counterparty_request: UpsertCounterpartyRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def upsert_counterparty_with_http_info(self, upsert_counterparty_request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('upsert_counterparty_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['upsert_counterparty_request'] is None):  # noqa: E501
    ...
    def upsert_credit_support_annex(self, upsert_credit_support_annex_request, **kwargs):  # noqa: E501
        ...
        :param upsert_credit_support_annex_request: The CSA to update or insert (required)
