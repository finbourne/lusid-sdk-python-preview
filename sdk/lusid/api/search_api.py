...
"""
    ...
    The version of the OpenAPI document: 0.10.441
...
class SearchApi(object):
    ...
    def instruments_search(self, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Search instruments  # noqa: E501
        ...
        :param str mastered_effective_at: Optional. The effective date for searching mastered instruments. If this is not set, then the current date is taken.  This parameter has no effect on instruments that have not been mastered within LUSID.
    ...
    def instruments_search_with_http_info(self, **kwargs):  # noqa: E501
        ...
        header_params['X-LUSID-SDK-Version'] = '0.10.441'
