...
class SearchApi(object):
    ...
    def instruments_search(self, **kwargs):  # noqa: E501
        """Search instruments  # noqa: E501

        Search through instruments that have been mastered in LUSID, and optionally augment results with instruments from a symbology service  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.instruments_search(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param datetime mastered_effective_at: Optional. The effective date for searching mastered instruments. If this is not set, then the current date is taken.  This parameter has no effect on instruments that have not been mastered within LUSID.
        :param bool mastered_only: Optional. If set to true, only search over instruments that have been mastered within LUSID. Default to false
        :param list[InstrumentSearchProperty] symbols: A collection of instrument symbols to search for
        ...
        if kwargs.get('async_req'):
            return self.instruments_search_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.instruments_search_with_http_info(**kwargs)  # noqa: E501
            return data

    def instruments_search_with_http_info(self, **kwargs):  # noqa: E501
        """Search instruments  # noqa: E501

        Search through instruments that have been mastered in LUSID, and optionally augment results with instruments from a symbology service  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.instruments_search_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['mastered_effective_at', 'mastered_only', 'symbols']  # noqa: E501
    ...
    def portfolio_groups_search(self, **kwargs):  # noqa: E501
        """Search portfolio groups  # noqa: E501

        Search through all portfolio groups  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.portfolio_groups_search(async_req=True)
        >>> result = thread.get()
        ...
        :param object request: A valid Elasticsearch 5.x request
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.portfolio_groups_search_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.portfolio_groups_search_with_http_info(**kwargs)  # noqa: E501
            return data

    def portfolio_groups_search_with_http_info(self, **kwargs):  # noqa: E501
        """Search portfolio groups  # noqa: E501

        Search through all portfolio groups  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.portfolio_groups_search_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def portfolios_search(self, **kwargs):  # noqa: E501
        """Search portfolios  # noqa: E501

        Search through all portfolios  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.portfolios_search(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.portfolios_search_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.portfolios_search_with_http_info(**kwargs)  # noqa: E501
            return data

    def portfolios_search_with_http_info(self, **kwargs):  # noqa: E501
        """Search portfolios  # noqa: E501

        Search through all portfolios  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.portfolios_search_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def properties_search(self, **kwargs):  # noqa: E501
        """Search property definitions  # noqa: E501

        Search through all property definitions  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.properties_search(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.properties_search_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.properties_search_with_http_info(**kwargs)  # noqa: E501
            return data

    def properties_search_with_http_info(self, **kwargs):  # noqa: E501
        """Search property definitions  # noqa: E501

        Search through all property definitions  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.properties_search_with_http_info(async_req=True)
        >>> result = thread.get()
