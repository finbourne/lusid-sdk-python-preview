...
class RelationDefinitionsApi(object):
    ...
    def get_relation_definition_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `scope` when calling `get_relation_definition`, length must be less than or equal to `100`")  # noqa: E501
        if ('scope' in local_var_params and
        ...
        if ('code' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `code` when calling `get_relation_definition`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
