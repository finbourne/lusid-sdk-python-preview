...
class CustomEntityDefinitionsApi(object):
    ...
    def update_custom_entity_definition(self, entity_type, update_custom_entity_definition_request, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] UpdateCustomEntityDefinition: Modify an existing Custom Entity type.  # noqa: E501
    ...
    def update_custom_entity_definition_with_http_info(self, entity_type, update_custom_entity_definition_request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('entity_type' in local_var_params and  # noqa: E501
                                                        len(local_var_params['entity_type']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `entity_type` when calling `update_custom_entity_definition`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('entity_type' in local_var_params and  # noqa: E501
                                                        len(local_var_params['entity_type']) < 1):  # noqa: E501
