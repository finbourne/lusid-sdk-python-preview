...
class SystemConfigurationApi(object):
    ...
    def create_side_definition(self, **kwargs):  # noqa: E501
        ...
        :param side_configuration_data_request: The definition of the side to be created.
    ...
    def list_configuration_transaction_types(self, **kwargs):  # noqa: E501
        ...
        :param as_at: The asAt datetime at which to retrieve the Transaction configuration types. Defaults              to return the latest version of the holdings if not specified.
        :type as_at: datetime
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
