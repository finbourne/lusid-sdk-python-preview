...
class InstrumentEventsApi(object):
    ...
    def query_applicable_instrument_events(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.query_applicable_instrument_events(async_req=True)
        >>> result = thread.get()
        ...
        return self.query_applicable_instrument_events_with_http_info(**kwargs)  # noqa: E501

    def query_applicable_instrument_events_with_http_info(self, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] QueryApplicableInstrumentEvents: Returns a list of applicable instrument events based on the holdings of the portfolios and date range specified in the query.  # noqa: E501
        ...
        >>> thread = api.query_applicable_instrument_events_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object, the HTTP status code, and the headers.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: (ResourceListOfApplicableInstrumentEvent, int, HTTPHeaderDict)
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method query_applicable_instrument_events" % key
                )
        ...
        if self.api_client.client_side_validation and ('page' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `page` when calling `query_applicable_instrument_events`, length must be less than or equal to `500`")  # noqa: E501
        if self.api_client.client_side_validation and ('page' in local_var_params and  # noqa: E501
                                                        len(local_var_params['page']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page` when calling `query_applicable_instrument_events`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'page' in local_var_params and not re.search(r'^[a-zA-Z0-9\+\/]*={0,3}$', local_var_params['page']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page` when calling `query_applicable_instrument_events`, must conform to the pattern `/^[a-zA-Z0-9\+\/]*={0,3}$/`")  # noqa: E501
        collection_formats = {}
        ...
        body_params = None
        if 'query_applicable_instrument_events_request' in local_var_params:
            body_params = local_var_params['query_applicable_instrument_events_request']
        # HTTP header `Accept`
