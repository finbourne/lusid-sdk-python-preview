...
class ReferencePortfolioApi(object):
    ...
    def create_reference_portfolio(self, scope, reference_portfolio, **kwargs):  # noqa: E501
        """Create reference portfolio  # noqa: E501

        Create a new reference portfolio.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_reference_portfolio(scope, reference_portfolio, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str scope: The intended scope of the portfolio (required)
        :param CreateReferencePortfolioRequest reference_portfolio: The portfolio creation request object (required)
        ...
        return self.create_reference_portfolio_with_http_info(scope, reference_portfolio, **kwargs)  # noqa: E501

    def create_reference_portfolio_with_http_info(self, scope, reference_portfolio, **kwargs):  # noqa: E501
        """Create reference portfolio  # noqa: E501

        Create a new reference portfolio.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_reference_portfolio_with_http_info(scope, reference_portfolio, async_req=True)
        >>> result = thread.get()
    ...
    def upsert_reference_portfolio_constituents(self, scope, code, constituents, **kwargs):  # noqa: E501
        """Add constituents  # noqa: E501

        Add constituents to the specified reference portfolio.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_reference_portfolio_constituents(scope, code, constituents, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str scope: The scope of the portfolio (required)
        :param str code: The code of the portfolio (required)
        :param UpsertReferencePortfolioConstituentsRequest constituents: The constituents to upload to the portfolio (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.upsert_reference_portfolio_constituents_with_http_info(scope, code, constituents, **kwargs)  # noqa: E501

    def upsert_reference_portfolio_constituents_with_http_info(self, scope, code, constituents, **kwargs):  # noqa: E501
        """Add constituents  # noqa: E501

        Add constituents to the specified reference portfolio.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_reference_portfolio_constituents_with_http_info(scope, code, constituents, async_req=True)
        >>> result = thread.get()
