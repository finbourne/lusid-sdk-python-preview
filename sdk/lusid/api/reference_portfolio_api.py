...
class ReferencePortfolioApi(object):
    ...
    def create_reference_portfolio(self, scope, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Create reference portfolio  # noqa: E501

        Create a new reference portfolio.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_reference_portfolio(scope, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str scope: The intended scope of the portfolio (required)
        :param CreateReferencePortfolioRequest reference_portfolio: The portfolio creation request object
        ...
        return self.create_reference_portfolio_with_http_info(scope, **kwargs)  # noqa: E501

    def create_reference_portfolio_with_http_info(self, scope, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Create reference portfolio  # noqa: E501

        Create a new reference portfolio.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_reference_portfolio_with_http_info(scope, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['scope', 'reference_portfolio']  # noqa: E501
        ...
        body_params = None
        if 'reference_portfolio' in local_var_params:
            body_params = local_var_params['reference_portfolio']
        # HTTP header `Accept`
    ...
    def get_reference_portfolio_constituents(self, scope, code, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Get constituents  # noqa: E501

        Get all the constituents in the specified reference portfolio  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param str effective_at: Optional. The effective date of the constituents to retrieve
        :param datetime as_at: Optional. The AsAt date of the data
        :param list[str] sort_by: Optional. Order the results by these fields. Use the '-' sign to denote descending order e.g. -MyFieldName
        ...
        :param list[str] instrument_property_keys: Optional. The Properties of the constituents
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def get_reference_portfolio_constituents_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        all_params = ['scope', 'code', 'effective_at', 'as_at', 'sort_by', 'start', 'limit', 'instrument_property_keys']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def list_constituents_adjustments(self, scope, code, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Gets constituents adjustments in an interval of effective time.  # noqa: E501

        Specify a time period in which you'd like to see the list of times that adjustments where made to this portfolio  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_constituents_adjustments(scope, code, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str scope: The scope of the portfolio (required)
        :param str code: Code for the portfolio (required)
        :param str from_effective_at: Events between this time (inclusive) and the toEffectiveAt are returned.
        :param str to_effective_at: Events between this time (inclusive) and the fromEffectiveAt are returned.
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_constituents_adjustments_with_http_info(scope, code, **kwargs)  # noqa: E501

    def list_constituents_adjustments_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Gets constituents adjustments in an interval of effective time.  # noqa: E501

        Specify a time period in which you'd like to see the list of times that adjustments where made to this portfolio  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_constituents_adjustments_with_http_info(scope, code, async_req=True)
        >>> result = thread.get()
    ...
    def upsert_reference_portfolio_constituents(self, scope, code, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Add constituents  # noqa: E501

        Add constituents to the specified reference portfolio.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_reference_portfolio_constituents(scope, code, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str scope: The scope of the portfolio (required)
        :param str code: The code of the portfolio (required)
        :param UpsertReferencePortfolioConstituentsRequest constituents: The constituents to upload to the portfolio
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.upsert_reference_portfolio_constituents_with_http_info(scope, code, **kwargs)  # noqa: E501

    def upsert_reference_portfolio_constituents_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Add constituents  # noqa: E501

        Add constituents to the specified reference portfolio.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_reference_portfolio_constituents_with_http_info(scope, code, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['scope', 'code', 'constituents']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        body_params = None
        if 'constituents' in local_var_params:
            body_params = local_var_params['constituents']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['text/plain', 'application/json', 'text/json'])  # noqa: E501
