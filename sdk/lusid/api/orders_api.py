...
class OrdersApi(object):
    ...
    def get_order(self, scope, id, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Fetch a given order.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_order(scope, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str scope: The scope to which the order belongs. (required)
        :param str id: The order's unique identifier. (required)
        :param datetime as_at: The asat datetime at which to retrieve the order. Defaults to              return the latest version of each order if not specified.
        ...
        return self.get_order_with_http_info(scope, id, **kwargs)  # noqa: E501

    def get_order_with_http_info(self, scope, id, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Fetch a given order.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_order_with_http_info(scope, id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['scope', 'id', 'as_at', 'property_keys']  # noqa: E501
        ...
        if ('id' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `get_order`")  # noqa: E501
    ...
    def list_orders(self, scope, **kwargs):  # noqa: E501
        ...
        :param datetime as_at: The asat datetime at which to retrieve the orders. Defaults to              return the latest version of each order if not specified.
    ...
    def list_orders_with_http_info(self, scope, **kwargs):  # noqa: E501
        ...
        all_params = ['scope', 'as_at', 'property_keys']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def upsert_orders_with_http_info(self, scope, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(OrderSet, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='OrderSet',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
