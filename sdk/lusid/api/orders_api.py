...
class OrdersApi(object):
    ...
    def delete_orders(self, resource_id, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Delete Orders.  # noqa: E501

        Use this method to delete a collection of Orders, each defined by ResourceId. Each delete will be attempted  independently, and the method will return lists of successful and failed attempts.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_orders(resource_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param list[ResourceId] resource_id: The IDs of the orders to delete. (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_orders_with_http_info(resource_id, **kwargs)  # noqa: E501

    def delete_orders_with_http_info(self, resource_id, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Delete Orders.  # noqa: E501

        Use this method to delete a collection of Orders, each defined by ResourceId. Each delete will be attempted  independently, and the method will return lists of successful and failed attempts.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_orders_with_http_info(resource_id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(DeletedOrdersEntitiesResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if ('resource_id' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `resource_id` when calling `delete_orders`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='DeletedOrdersEntitiesResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
