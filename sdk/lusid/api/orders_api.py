...
class OrdersApi(object):
    ...
    def get_order_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `scope` when calling `get_order`, length must be less than or equal to `100`")  # noqa: E501
        if ('scope' in local_var_params and
        ...
        if ('code' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `code` when calling `get_order`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
    ...
    def upsert_order_properties_with_http_info(self, scope, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
                len(local_var_params['scope']) > 100):
            raise ApiValueError("Invalid value for parameter `scope` when calling `upsert_order_properties`, length must be less than or equal to `100`")  # noqa: E501
        if ('scope' in local_var_params and
                len(local_var_params['scope']) < 1):
