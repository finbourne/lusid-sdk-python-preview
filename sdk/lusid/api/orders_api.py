...
class OrdersApi(object):
    ...
    def delete_order_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
                len(local_var_params['scope']) > 256):
            raise ApiValueError("Invalid value for parameter `scope` when calling `delete_order`, length must be less than or equal to `256`")  # noqa: E501
        if ('scope' in local_var_params and
        ...
        if ('code' in local_var_params and
                len(local_var_params['code']) > 256):
            raise ApiValueError("Invalid value for parameter `code` when calling `delete_order`, length must be less than or equal to `256`")  # noqa: E501
        if ('code' in local_var_params and
    ...
    def get_order_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
                len(local_var_params['scope']) > 256):
            raise ApiValueError("Invalid value for parameter `scope` when calling `get_order`, length must be less than or equal to `256`")  # noqa: E501
        if ('scope' in local_var_params and
                len(local_var_params['scope']) < 1):
        ...
        if ('code' in local_var_params and
                len(local_var_params['code']) > 256):
            raise ApiValueError("Invalid value for parameter `code` when calling `get_order`, length must be less than or equal to `256`")  # noqa: E501
        if ('code' in local_var_params and
                len(local_var_params['code']) < 1):
    ...
    def list_orders_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if ('page' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `page` when calling `list_orders`, length must be less than or equal to `300`")  # noqa: E501
        if ('page' in local_var_params and
        ...
        if ('filter' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `filter` when calling `list_orders`, length must be less than or equal to `2147483647`")  # noqa: E501
        if ('filter' in local_var_params and
        ...
        if 'filter' in local_var_params and not re.search(r'(?s).*', local_var_params['filter']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `filter` when calling `list_orders`, must conform to the pattern `/(?s).*/`")  # noqa: E501
        collection_formats = {}
    ...
    def upsert_order_properties_with_http_info(self, scope, **kwargs):  # noqa: E501
        ...
        if ('scope' in local_var_params and
                len(local_var_params['scope']) > 256):
            raise ApiValueError("Invalid value for parameter `scope` when calling `upsert_order_properties`, length must be less than or equal to `256`")  # noqa: E501
        if ('scope' in local_var_params and
                len(local_var_params['scope']) < 1):
            raise ApiValueError("Invalid value for parameter `scope` when calling `upsert_order_properties`, length must be greater than or equal to `1`")  # noqa: E501
        if 'scope' in local_var_params and not re.search(r'^[a-zA-Z0-9@\/+-_*#;,^&.?€£$¥ ]+$', local_var_params['scope']):  # noqa: E501
