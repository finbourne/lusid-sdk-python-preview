...
class OrdersApi(object):
    ...
    def list_orders(self, scope, **kwargs):  # noqa: E501
        ...
        :param str filter: Expression to filter the result set.  Currently Orders can be filtered by Id (e.g.              \"Id eq 'ORD001'), Quantity (e.g. \"Quantity lt 100\"), Portfolio (e.g. \"Portfolio eq 'TestScope/UKEquities'\"),              LUSID Instrument Id (e.g. \"InstrumentUid eq 'LUID_12345678'\") or by Property (Read more about filtering results from LUSID here:              https://support.lusid.com/filtering-results-from-lusid.).
