...
class PropertyDefinitionsApi(object):
    ...
    def create_property_definition(self, definition, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Create property definition  # noqa: E501
    ...
    def delete_property_definition(self, domain, scope, code, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Delete property definition  # noqa: E501
    ...
    def get_multiple_property_definitions(self, property_keys, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Get multiple property definitions  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param list[str] property_keys: One or more property keys which identify each property that a definition should              be retrieved for. The format for each property key is {domain}/{scope}/{code}, e.g. \"Instrument/system/Name\". (required)
        :param datetime as_at: The asAt datetime at which to retrieve the property definition/s.
    ...
    def get_property_definition(self, domain, scope, code, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Get property definition  # noqa: E501

        Retrieve the definition of the specified property.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param datetime as_at: The asAt datetime at which to retrieve the property definition.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def update_property_definition(self, domain, scope, code, **kwargs):  # noqa: E501
        """[EARLY ACCESS] Update property definition  # noqa: E501

        Update display name of specified existing property.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
