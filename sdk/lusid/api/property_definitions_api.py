...
class PropertyDefinitionsApi(object):
    ...
    def update_property_definition(self, domain, scope, code, **kwargs):  # noqa: E501
        ...
        Update the definition of the specified existing property. Not all elements within a property definition  are modifiable due to the potential implications for data already stored against the property.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
