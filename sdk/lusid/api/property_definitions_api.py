...
class PropertyDefinitionsApi(object):
    ...
    def create_property_definition(self, **kwargs):  # noqa: E501
        """Define a new property  # noqa: E501

        Create a new property definition  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_property_definition(async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param CreatePropertyDefinitionRequest definition: The definition of the new property
        ...
        return self.create_property_definition_with_http_info(**kwargs)  # noqa: E501

    def create_property_definition_with_http_info(self, **kwargs):  # noqa: E501
        """Define a new property  # noqa: E501

        Create a new property definition  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_property_definition_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def delete_property_definition(self, domain, scope, code, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str domain: The Property Domain of the property to be deleted (required)
        :param str scope: The scope of the property to be deleted (required)
        :param str code: The code of the property to be deleted (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def get_multiple_property_definitions(self, **kwargs):  # noqa: E501
        """Get multiple property definitions  # noqa: E501

        Get one or more property definitions  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_multiple_property_definitions(async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param list[str] property_keys: One or more keys for properties for which the schema should be returned
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_multiple_property_definitions_with_http_info(**kwargs)  # noqa: E501

    def get_multiple_property_definitions_with_http_info(self, **kwargs):  # noqa: E501
        """Get multiple property definitions  # noqa: E501

        Get one or more property definitions  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_multiple_property_definitions_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['property_keys', 'as_at', 'sort_by', 'start', 'limit', 'filter']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_property_definition(self, domain, scope, code, **kwargs):  # noqa: E501
        ...
        Retrieve the definition for the identified property  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool: execute request asynchronously
        :param str domain: The Property Domain of the requested property (required)
        :param str scope: The scope of the requested property (required)
        :param str code: The code of the requested property (required)
        :param datetime as_at: Optional. The AsAt date of the data
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
    ...
    def update_property_definition(self, domain, scope, code, **kwargs):  # noqa: E501
        """Update the definition of the specified existing property  # noqa: E501

        Not all elements within a property definition are modifiable due to the potential implications for data  already stored against these properties  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_property_definition(domain, scope, code, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str domain: The Property Domain of the property being updated (required)
        :param str scope: The scope of the property to be updated (required)
        :param str code: The code of the property to be updated (required)
        :param UpdatePropertyDefinitionRequest definition: The updated definition of the property
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_property_definition_with_http_info(domain, scope, code, **kwargs)  # noqa: E501

    def update_property_definition_with_http_info(self, domain, scope, code, **kwargs):  # noqa: E501
        """Update the definition of the specified existing property  # noqa: E501

        Not all elements within a property definition are modifiable due to the potential implications for data  already stored against these properties  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_property_definition_with_http_info(domain, scope, code, async_req=True)
        >>> result = thread.get()
