...
class FeesAndCommissionsApi(object):
    ...
    def get_applicable_fees_with_http_info(self, **kwargs):  # noqa: E501
        ...
        header_params['X-LUSID-SDK-Version'] = '0.11.4060'
    ...
    def get_applicable_fees_new(self, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] GetApplicableFeesNew: Get the Fees and Commissions that may be applicable to a transaction.  # noqa: E501

        Additionally, matching can be based on the instrument's properties, its portfolio properties, and any additional property keys present in the data file.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_applicable_fees_new(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_applicable_fees_new_with_http_info(**kwargs)  # noqa: E501

    def get_applicable_fees_new_with_http_info(self, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] GetApplicableFeesNew: Get the Fees and Commissions that may be applicable to a transaction.  # noqa: E501
        ...
        >>> thread = api.get_applicable_fees_new_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_applicable_fees_new" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('instrument_identifier_type' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `instrument_identifier_type` when calling `get_applicable_fees_new`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('instrument_identifier_type' in local_var_params and  # noqa: E501
                                                        len(local_var_params['instrument_identifier_type']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `instrument_identifier_type` when calling `get_applicable_fees_new`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and ('instrument_identifier' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `instrument_identifier` when calling `get_applicable_fees_new`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('instrument_identifier' in local_var_params and  # noqa: E501
                                                        len(local_var_params['instrument_identifier']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `instrument_identifier` when calling `get_applicable_fees_new`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and ('portfolio_scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['portfolio_scope']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `portfolio_scope` when calling `get_applicable_fees_new`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('portfolio_scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['portfolio_scope']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `portfolio_scope` when calling `get_applicable_fees_new`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'portfolio_scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['portfolio_scope']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `portfolio_scope` when calling `get_applicable_fees_new`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if self.api_client.client_side_validation and ('portfolio_code' in local_var_params and  # noqa: E501
                                                        len(local_var_params['portfolio_code']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `portfolio_code` when calling `get_applicable_fees_new`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('portfolio_code' in local_var_params and  # noqa: E501
                                                        len(local_var_params['portfolio_code']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `portfolio_code` when calling `get_applicable_fees_new`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'portfolio_code' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['portfolio_code']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `portfolio_code` when calling `get_applicable_fees_new`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/api/feesandcommissions/$GetApplicableFees', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
