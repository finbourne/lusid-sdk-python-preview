...
class ResultsApi(object):
    ...
    def get_results(self, entity_scope, entity_code, calculation_scope, calculation_code, effective_at, **kwargs):  # noqa: E501
        """Retrieve a page of results all keyed by the provided parameters. The result store is not bi-temporal; a single date  addressed the market effectiveAt.  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_results_with_http_info(entity_scope, entity_code, calculation_scope, calculation_code, effective_at, **kwargs)  # noqa: E501
            return data
    ...
    def upsert_results(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.upsert_results_with_http_info(**kwargs)  # noqa: E501
            return data
