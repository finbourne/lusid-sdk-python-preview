...
class ScopesApi(object):
    ...
    def list_scopes(self, **kwargs):  # noqa: E501
        ...
        :param str query: Optional. Expression specifying the criteria that the returned portfolios must meet
    ...
    def list_scopes_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['sort_by', 'start', 'limit', 'filter', 'query']  # noqa: E501
