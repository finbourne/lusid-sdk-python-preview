...
class SchemasApi(object):
    ...
    def get_entity_schema(self, entity, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_entity_schema_with_http_info(entity, **kwargs)  # noqa: E501
            return data
    ...
    def get_property_schema(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_property_schema_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def get_value_types(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_value_types_with_http_info(**kwargs)  # noqa: E501
            return data
