...
class CorporateActionSourcesApi(object):
    ...
    def delete_corporate_actions(self, scope, code, corporate_action_ids, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Delete one or more corporate actions  # noqa: E501

        Deletes one or more corporate actions from the specified corporate action source  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_corporate_actions_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if 'filter' in local_var_params and not re.search(r'(?s).*', local_var_params['filter']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `filter` when calling `get_corporate_actions`, must conform to the pattern `/(?s).*/`")  # noqa: E501
        collection_formats = {}
    ...
    def list_corporate_action_sources_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if 'filter' in local_var_params and not re.search(r'(?s).*', local_var_params['filter']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `filter` when calling `list_corporate_action_sources`, must conform to the pattern `/(?s).*/`")  # noqa: E501
        if ('page' in local_var_params and
                len(local_var_params['page']) > 300):
            raise ApiValueError("Invalid value for parameter `page` when calling `list_corporate_action_sources`, length must be less than or equal to `300`")  # noqa: E501
        if ('page' in local_var_params and
