...
class CorporateActionSourcesApi(object):
    ...
    def batch_upsert_corporate_actions(self, scope, code, **kwargs):  # noqa: E501
        """Upsert corporate actions  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.batch_upsert_corporate_actions_with_http_info(scope, code, **kwargs)  # noqa: E501
            return data
    ...
    def create_corporate_action_source(self, request, **kwargs):  # noqa: E501
        """Create Corporate Action Source  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.create_corporate_action_source_with_http_info(request, **kwargs)  # noqa: E501
            return data
    ...
    def delete_corporate_action_source(self, scope, code, **kwargs):  # noqa: E501
        """Delete a corporate action source  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.delete_corporate_action_source_with_http_info(scope, code, **kwargs)  # noqa: E501
            return data
    ...
    def get_corporate_actions(self, scope, code, **kwargs):  # noqa: E501
        ...
        :param str code: The code of the corporate action source (required)
        :param datetime from_effective_at: Optional. The start effective date of the data range
        :param datetime to_effective_at: Optional. The end effective date of the data range
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_corporate_actions_with_http_info(scope, code, **kwargs)  # noqa: E501
            return data
    ...
    def list_corporate_action_sources(self, **kwargs):  # noqa: E501
        """Get corporate action sources  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.list_corporate_action_sources_with_http_info(**kwargs)  # noqa: E501
            return data
