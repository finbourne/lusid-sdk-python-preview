...
class LegalEntitiesApi(object):
    ...
    def delete_legal_entity_with_http_info(self, id_type_scope, id_type_code, code, **kwargs):  # noqa: E501
        ...
        if ('code' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `code` when calling `delete_legal_entity`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
    ...
    def get_legal_entity_with_http_info(self, id_type_scope, id_type_code, code, **kwargs):  # noqa: E501
        ...
        if ('code' in local_var_params and
                len(local_var_params['code']) > 100):
            raise ApiValueError("Invalid value for parameter `code` when calling `get_legal_entity`, length must be less than or equal to `100`")  # noqa: E501
        if ('code' in local_var_params and
                len(local_var_params['code']) < 1):
