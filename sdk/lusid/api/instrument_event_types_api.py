...
class InstrumentEventTypesApi(object):
    ...
    def get_transaction_template(self, instrument_event_type, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_transaction_template(instrument_event_type, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_transaction_template_with_http_info(instrument_event_type, **kwargs)  # noqa: E501

    def get_transaction_template_with_http_info(self, instrument_event_type, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] GetTransactionTemplate: Get Transaction Template  # noqa: E501
        ...
        >>> thread = api.get_transaction_template_with_http_info(instrument_event_type, async_req=True)
        >>> result = thread.get()
