...
class CutLabelDefinitionsApi(object):
    ...
    def delete_cut_label_definition_with_http_info(self, code, **kwargs):  # noqa: E501
        ...
        if ('code' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `code` when calling `delete_cut_label_definition`, length must be greater than or equal to `0`")  # noqa: E501
    ...
    def get_cut_label_definition_with_http_info(self, code, **kwargs):  # noqa: E501
        ...
        if ('code' in local_var_params and
                len(local_var_params['code']) < 0):
            raise ApiValueError("Invalid value for parameter `code` when calling `get_cut_label_definition`, length must be greater than or equal to `0`")  # noqa: E501
        if 'code' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['code']):  # noqa: E501
    ...
    def update_cut_label_definition_with_http_info(self, code, **kwargs):  # noqa: E501
        ...
        if ('code' in local_var_params and
                len(local_var_params['code']) < 0):
            raise ApiValueError("Invalid value for parameter `code` when calling `update_cut_label_definition`, length must be greater than or equal to `0`")  # noqa: E501
        if 'code' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['code']):  # noqa: E501
