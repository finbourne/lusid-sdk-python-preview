...
class EntitiesApi(object):
    ...
    def get_portfolio_changes(self, scope, effective_at, **kwargs):  # noqa: E501
        """Get the next change to each portfolio in a scope.  # noqa: E501
        ...
        :param datetime effective_at: The effective date of the origin. (required)
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_portfolio_changes_with_http_info(scope, effective_at, **kwargs)  # noqa: E501
            return data
