...
class TransactionTaxRulesApi(object):
    ...
    def create_tax_rule_set_with_http_info(self, create_tax_rule_set_request, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/transactions/taxrules', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_tax_rule_set(self, scope, code, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] DeleteTaxRuleSet: Deletes a tax rule.  # noqa: E501

        <br>              Deletes the rule for all effective time.                <br>              The rule will remain viewable at previous as at times, but it will no longer be considered applicable.                <br>              This cannot be undone.                # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def delete_tax_rule_set_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/transactions/taxrules/{scope}/{code}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_tax_rule_set_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/transactions/taxrules/{scope}/{code}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_tax_rule_sets(self, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] ListTaxRuleSets: List tax rules.  # noqa: E501
    ...
    def update_tax_rule_set(self, scope, code, update_tax_rule_set_request, **kwargs):  # noqa: E501
        ...
        Updates the tax rule set definition at the given effective time.  The user must be entitled to read any properties specified in each rule.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def update_tax_rule_set_with_http_info(self, scope, code, update_tax_rule_set_request, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/transactions/taxrules/{scope}/{code}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
