...
class BranchStep(object):
    ...
    def __init__(self, label=None, grouped_parameters=None, compliance_step_type=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type label: str
        :param grouped_parameters:  Parameters required for the step. Some step types group parameters to differentiate between, for example, hard limit and warning threshold parameters (required)
    ...
    def grouped_parameters(self):
        """Gets the grouped_parameters of this BranchStep.  # noqa: E501

        Parameters required for the step. Some step types group parameters to differentiate between, for example, hard limit and warning threshold parameters  # noqa: E501

        :return: The grouped_parameters of this BranchStep.  # noqa: E501
    ...
    def grouped_parameters(self, grouped_parameters):
        """Sets the grouped_parameters of this BranchStep.

        Parameters required for the step. Some step types group parameters to differentiate between, for example, hard limit and warning threshold parameters  # noqa: E501

        :param grouped_parameters: The grouped_parameters of this BranchStep.  # noqa: E501
        :type grouped_parameters: dict(str, list[ComplianceTemplateParameter])
        """
