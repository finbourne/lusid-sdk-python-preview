...
class CreateRelationDefinitionRequest(object):
    ...
    def source_entity_domain(self, source_entity_domain):
        ...
        if source_entity_domain is not None and len(source_entity_domain) > 64:
            raise ValueError("Invalid value for `source_entity_domain`, length must be less than or equal to `64`")  # noqa: E501
        if source_entity_domain is not None and len(source_entity_domain) < 1:
            raise ValueError("Invalid value for `source_entity_domain`, length must be greater than or equal to `1`")  # noqa: E501
        if (source_entity_domain is not None and not re.search(r'^[a-zA-Z0-9\-_]+$', source_entity_domain)):  # noqa: E501
            raise ValueError(r"Invalid value for `source_entity_domain`, must be a follow pattern or equal to `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
    ...
    def target_entity_domain(self, target_entity_domain):
        ...
        if target_entity_domain is not None and len(target_entity_domain) > 64:
            raise ValueError("Invalid value for `target_entity_domain`, length must be less than or equal to `64`")  # noqa: E501
        if target_entity_domain is not None and len(target_entity_domain) < 1:
            raise ValueError("Invalid value for `target_entity_domain`, length must be greater than or equal to `1`")  # noqa: E501
        if (target_entity_domain is not None and not re.search(r'^[a-zA-Z0-9\-_]+$', target_entity_domain)):  # noqa: E501
            raise ValueError(r"Invalid value for `target_entity_domain`, must be a follow pattern or equal to `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
    ...
    def outward_description(self, outward_description):
        ...
        if outward_description is not None and len(outward_description) > 1024:
            raise ValueError("Invalid value for `outward_description`, length must be less than or equal to `1024`")  # noqa: E501
        if outward_description is not None and len(outward_description) < 0:
            raise ValueError("Invalid value for `outward_description`, length must be greater than or equal to `0`")  # noqa: E501
    ...
    def inward_description(self, inward_description):
        ...
        if inward_description is not None and len(inward_description) > 1024:
            raise ValueError("Invalid value for `inward_description`, length must be less than or equal to `1024`")  # noqa: E501
        if inward_description is not None and len(inward_description) < 0:
            raise ValueError("Invalid value for `inward_description`, length must be greater than or equal to `0`")  # noqa: E501
    ...
    def life_time(self, life_time):
        ...
        :type: str
        """
        if life_time is not None and len(life_time) > 512:
            raise ValueError("Invalid value for `life_time`, length must be less than or equal to `512`")  # noqa: E501
        if life_time is not None and len(life_time) < 1:
            raise ValueError("Invalid value for `life_time`, length must be greater than or equal to `1`")  # noqa: E501
        if (life_time is not None and not re.search(r'(?s).*', life_time)):  # noqa: E501
            raise ValueError(r"Invalid value for `life_time`, must be a follow pattern or equal to `/(?s).*/`")  # noqa: E501
    ...
    def constraint_style(self, constraint_style):
        ...
        :type: str
        """
        if constraint_style is not None and len(constraint_style) > 512:
            raise ValueError("Invalid value for `constraint_style`, length must be less than or equal to `512`")  # noqa: E501
        if constraint_style is not None and len(constraint_style) < 1:
            raise ValueError("Invalid value for `constraint_style`, length must be greater than or equal to `1`")  # noqa: E501
        if (constraint_style is not None and not re.search(r'(?s).*', constraint_style)):  # noqa: E501
            raise ValueError(r"Invalid value for `constraint_style`, must be a follow pattern or equal to `/(?s).*/`")  # noqa: E501
