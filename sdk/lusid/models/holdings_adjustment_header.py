...
class HoldingsAdjustmentHeader(object):
    ...
    def __init__(self, effective_at=None, version=None, unmatched_holding_method=None, links=None):  # noqa: E501
        ...
        :param unmatched_holding_method:  Describes how the holdings were adjusted. If 'PositionToZero' the entire transaction portfolio's holdings were set via a call to 'Set holdings'. If 'KeepTheSame' only the specified holdings were adjusted via a call to 'Adjust holdings'. (required)
    ...
    def unmatched_holding_method(self):
        ...
        Describes how the holdings were adjusted. If 'PositionToZero' the entire transaction portfolio's holdings were set via a call to 'Set holdings'. If 'KeepTheSame' only the specified holdings were adjusted via a call to 'Adjust holdings'.  # noqa: E501
