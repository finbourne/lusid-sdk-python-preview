...
class DependencySourceFilter(object):
    ...
    attribute_map = {
        ...
        'dom_ccy': 'domCcy',
        'long_or_short_indicator': 'longOrShortIndicator'
    }
    ...
    required_map = {
        ...
        'dom_ccy': 'optional',
        'long_or_short_indicator': 'optional'
    }

    def __init__(self, instrument_type=None, asset_class=None, dom_ccy=None, long_or_short_indicator=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type dom_ccy: str
        :param long_or_short_indicator:  Specify that a rule should apply if the market data is requested by a model with a given long or short indicator.  If none, then no filtering on LongOrShortIndicator is applied.
        :type long_or_short_indicator: str
        ...
        self._dom_ccy = None
        self._long_or_short_indicator = None
        self.discriminator = None

        self.instrument_type = instrument_type
        self.asset_class = asset_class
        self.dom_ccy = dom_ccy
        self.long_or_short_indicator = long_or_short_indicator
    ...
    @property
    def long_or_short_indicator(self):
        """Gets the long_or_short_indicator of this DependencySourceFilter.  # noqa: E501

        Specify that a rule should apply if the market data is requested by a model with a given long or short indicator.  If none, then no filtering on LongOrShortIndicator is applied.  # noqa: E501

        :return: The long_or_short_indicator of this DependencySourceFilter.  # noqa: E501
        :rtype: str
        """
        return self._long_or_short_indicator

    @long_or_short_indicator.setter
    def long_or_short_indicator(self, long_or_short_indicator):
        """Sets the long_or_short_indicator of this DependencySourceFilter.

        Specify that a rule should apply if the market data is requested by a model with a given long or short indicator.  If none, then no filtering on LongOrShortIndicator is applied.  # noqa: E501

        :param long_or_short_indicator: The long_or_short_indicator of this DependencySourceFilter.  # noqa: E501
        :type long_or_short_indicator: str
        """

        self._long_or_short_indicator = long_or_short_indicator
