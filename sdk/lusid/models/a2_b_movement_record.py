...
class A2BMovementRecord(object):
    ...
    def __init__(self, holding_type=None, instrument_uid=None, sub_holding_keys=None, currency=None, transaction_id=None, movement_name=None, effective_date=None, units=None, start=None, flows=None, gains=None, carry=None, end=None, properties=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type units: float
        :param start: 
        :type start: A2BCategory
        :param flows: 
        :type flows: A2BCategory
        :param gains: 
        :type gains: A2BCategory
        :param carry: 
        :type carry: A2BCategory
        :param end: 
        :type end: A2BCategory
