...
class OpaqueMarketDataAllOf(object):
    ...
    def document(self, document):
        ...
        if (self.local_vars_configuration.client_side_validation and
                document is not None and len(document) < 1):
            raise ValueError("Invalid value for `document`, length must be greater than or equal to `1`")  # noqa: E501
    ...
    @property
    def lineage(self):
        """Gets the lineage of this OpaqueMarketDataAllOf.  # noqa: E501

        Description of the complex market data's lineage e.g. 'FundAccountant_GreenQuality'.  # noqa: E501

        :return: The lineage of this OpaqueMarketDataAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def lineage(self, lineage):
        """Sets the lineage of this OpaqueMarketDataAllOf.

        Description of the complex market data's lineage e.g. 'FundAccountant_GreenQuality'.  # noqa: E501

        :param lineage: The lineage of this OpaqueMarketDataAllOf.  # noqa: E501
        :type lineage: str
        """
        if (self.local_vars_configuration.client_side_validation and
