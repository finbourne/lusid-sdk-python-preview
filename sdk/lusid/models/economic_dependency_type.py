...
class EconomicDependencyType(object):
    ...
    allowable_values = [OPAQUEDEPENDENCY, CASHDEPENDENCY, DISCOUNTINGDEPENDENCY, EQUITYCURVEDEPENDENCY, EQUITYVOLDEPENDENCY, FXDEPENDENCY, FXFORWARDSDEPENDENCY, FXVOLDEPENDENCY, INDEXPROJECTIONDEPENDENCY, IRVOLDEPENDENCY, QUOTEDEPENDENCY, VENDOR, CALENDARDEPENDENCY, INFLATIONFIXINGDEPENDENCY]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """EconomicDependencyType - a model defined in OpenAPI"
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EconomicDependencyType):
            return False
