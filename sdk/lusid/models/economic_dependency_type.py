...
class EconomicDependencyType(object):
    ...
    allowable_values = [OPAQUEDEPENDENCY, CASHDEPENDENCY, DISCOUNTINGDEPENDENCY, EQUITYCURVEDEPENDENCY, EQUITYVOLDEPENDENCY, FXDEPENDENCY, FXFORWARDSDEPENDENCY, FXVOLDEPENDENCY, INDEXPROJECTIONDEPENDENCY, IRVOLDEPENDENCY, QUOTEDEPENDENCY, VENDORDEPENDENCY]  # noqa: E501
