...
class CdsFlowConventions(object):
    ...
    def __init__(self, roll_frequency=None, scope=None, code=None, currency=None, payment_frequency=None, day_count_convention=None, roll_convention=None, holiday_calendars=None):  # noqa: E501
        """
