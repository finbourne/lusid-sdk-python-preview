...
class CustomEntityId(object):
    ...
    def identifier_value(self, identifier_value):
        ...
        if (self.local_vars_configuration.client_side_validation and
                identifier_value is not None and len(identifier_value) > 64):
            raise ValueError("Invalid value for `identifier_value`, length must be less than or equal to `64`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
