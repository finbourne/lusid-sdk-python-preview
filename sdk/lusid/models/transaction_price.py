...
class TransactionPrice(object):
    ...
    def __init__(self, price=None, type=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param price: 
        :type price: float
        :param type:  The available values are: Price, Yield, Spread, CashFlowPerUnit
        :type type: str
    ...
    def type(self):
        ...
        The available values are: Price, Yield, Spread, CashFlowPerUnit  # noqa: E501
    ...
    def type(self, type):
        ...
        :type type: str
        """
        allowed_values = ["Price", "Yield", "Spread", "CashFlowPerUnit"]  # noqa: E501
