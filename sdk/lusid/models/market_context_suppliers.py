...
class MarketContextSuppliers(object):
    ...
    def commodity(self, commodity):
        ...
        if self.local_vars_configuration.client_side_validation and commodity not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def credit(self, credit):
        ...
        """
        allowed_values = ["DataScope", "Lusid", "Isda", "Client", "Edi", "TraderMade", "FactSet"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and credit not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def equity(self, equity):
        ...
        """
        allowed_values = ["DataScope", "Lusid", "Isda", "Client", "Edi", "TraderMade", "FactSet"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and equity not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def fx(self, fx):
        ...
        """
        allowed_values = ["DataScope", "Lusid", "Isda", "Client", "Edi", "TraderMade", "FactSet"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and fx not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def rates(self, rates):
        ...
        """
        allowed_values = ["DataScope", "Lusid", "Isda", "Client", "Edi", "TraderMade", "FactSet"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and rates not in allowed_values:  # noqa: E501
            raise ValueError(
