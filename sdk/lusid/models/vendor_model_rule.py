...
class VendorModelRule(object):
    ...
    openapi_types = {
        ...
        'instrument_id': 'str',
        'address_key_filters': 'list[AddressKeyFilter]'
    }
    ...
    attribute_map = {
        ...
        'address_key_filters': 'addressKeyFilters'
    }
    ...
    required_map = {
        ...
        'address_key_filters': 'optional'
    }

    def __init__(self, supplier=None, model_name=None, instrument_type=None, parameters=None, model_options=None, instrument_id=None, address_key_filters=None, local_vars_configuration=None):  # noqa: E501
        """VendorModelRule - a model defined in OpenAPI"
        
        :param supplier:  The available values are: Lusid, RefinitivQps, RefinitivTracsWeb, VolMaster, IsdaCds, YieldBook, LusidCalc (required)
        :type supplier: str
        ...
        :param address_key_filters:  Condition for model selection. If a condition is satisfied the default model for valuation is overridden (for that instrument).
        :type address_key_filters: list[lusid.AddressKeyFilter]
        ...
        self._address_key_filters = None
        ...
        self.address_key_filters = address_key_filters
    ...
    @property
    def address_key_filters(self):
        """Gets the address_key_filters of this VendorModelRule.  # noqa: E501

        Condition for model selection. If a condition is satisfied the default model for valuation is overridden (for that instrument).  # noqa: E501

        :return: The address_key_filters of this VendorModelRule.  # noqa: E501
        :rtype: list[lusid.AddressKeyFilter]
        """
        return self._address_key_filters

    @address_key_filters.setter
    def address_key_filters(self, address_key_filters):
        """Sets the address_key_filters of this VendorModelRule.

        Condition for model selection. If a condition is satisfied the default model for valuation is overridden (for that instrument).  # noqa: E501

        :param address_key_filters: The address_key_filters of this VendorModelRule.  # noqa: E501
        :type address_key_filters: list[lusid.AddressKeyFilter]
        """

        self._address_key_filters = address_key_filters
