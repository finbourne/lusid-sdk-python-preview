...
class AborConfigurationRequest(object):
    ...
    def __init__(self, code=None, description=None, name=None, recipe_id=None, chart_of_accounts_id=None, posting_module_ids=None, properties=None, local_vars_configuration=None):  # noqa: E501
