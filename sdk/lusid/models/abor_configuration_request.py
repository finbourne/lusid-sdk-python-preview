...
class AborConfigurationRequest(object):
    ...
    def __init__(self, code=None, display_name=None, description=None, recipe_id=None, chart_of_accounts_id=None, posting_module_codes=None, properties=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param posting_module_codes:  The Posting Modules Codes from where the rules to be applied are retrieved.
    ...
    def posting_module_codes(self):
        ...
        The Posting Modules Codes from where the rules to be applied are retrieved.  # noqa: E501
