...
class OrderFlowConfiguration(object):
    ...
    def __init__(self, include_entity_types=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param include_entity_types:  Controls whether Orders and Allocations orders are included in the Portfolio valuation.  Valid values are  None (to account for Transactions only), Allocations (to include Allocations and Transactions) and  OrdersAndAllocations (to include Orders, Allocations and Transactions). (required)
    ...
    def include_entity_types(self):
        ...
        Controls whether Orders and Allocations orders are included in the Portfolio valuation.  Valid values are  None (to account for Transactions only), Allocations (to include Allocations and Transactions) and  OrdersAndAllocations (to include Orders, Allocations and Transactions).  # noqa: E501
