...
class CdsInstrument(object):
    ...
    openapi_types = {
        'ticker': 'str',
        'conventions': 'list[FlowConventions]',
        'coupon_rate': 'float',
        'detail_specifications': 'CdsDetailSpecifications',
        'start_date': 'datetime',
    ...
    required_map = {
        ...
        'detail_specifications': 'required',
        'start_date': 'required',
    ...
    def __init__(self, ticker=None, conventions=None, coupon_rate=None, detail_specifications=None, start_date=None, maturity_date=None, dom_ccy=None, instrument_type=None):  # noqa: E501
        """
        CdsInstrument - a model defined in OpenAPI

        :param ticker:  A ticker to uniquely specify the entity against which the cds is written (required)
        :type ticker: str
        :param conventions:  Flow Convention details for the legs of the CDS (in practice the conventions for the protection leg are limited/based on premium leg) (required)
        :type conventions: list[lusid.FlowConventions]
        ...
        :param detail_specifications:  (required)
        :type detail_specifications: lusid.CdsDetailSpecifications
        ...
        self._detail_specifications = None
        ...
        self.detail_specifications = detail_specifications
    ...
    def ticker(self):
        ...
        A ticker to uniquely specify the entity against which the cds is written  # noqa: E501
    ...
    def conventions(self):
        """Gets the conventions of this CdsInstrument.  # noqa: E501
        ...
        :return: The conventions of this CdsInstrument.  # noqa: E501
    ...
    def conventions(self, conventions):
        """Sets the conventions of this CdsInstrument.

        Flow Convention details for the legs of the CDS (in practice the conventions for the protection leg are limited/based on premium leg)  # noqa: E501

        :param conventions: The conventions of this CdsInstrument.  # noqa: E501
    ...
    @property
    def detail_specifications(self):
        """Gets the detail_specifications of this CdsInstrument.  # noqa: E501


        :return: The detail_specifications of this CdsInstrument.  # noqa: E501
        :rtype: CdsDetailSpecifications
        """
        return self._detail_specifications

    @detail_specifications.setter
    def detail_specifications(self, detail_specifications):
        """Sets the detail_specifications of this CdsInstrument.


        :param detail_specifications: The detail_specifications of this CdsInstrument.  # noqa: E501
        :type: CdsDetailSpecifications
        """
        if detail_specifications is None:
            raise ValueError("Invalid value for `detail_specifications`, must not be `None`")  # noqa: E501

        self._detail_specifications = detail_specifications
    ...
    def instrument_type(self, instrument_type):
        ...
        allowed_values = ["QuotedSecurity", "InterestRateSwap", "FxForward", "Exotic", "FxOption", "CreditDefaultSwap", "Unknown"]  # noqa: E501
