...
class FuturesContractDetails(object):
    ...
    def __init__(self, dom_ccy=None, fgn_ccy=None, asset_class=None, contract_code=None, contract_month=None, contract_size=None, convention=None, country=None, description=None, exchange_code=None, exchange_name=None, ticker_step=None, unit_value=None, calendars=None, delivery_type=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param contract_month:  Which month does the contract trade for.    Supported string (enumeration) values are: [F, G, H, J, K, M, N, Q, U, V, X, Z].
        ...
        :param delivery_type:  Delivery type to be used on settling the contract.  Optional: Defaults to DeliveryType.Physical if not provided.    Supported string (enumeration) values are: [Cash, Physical].
    ...
    def delivery_type(self):
        """Gets the delivery_type of this FuturesContractDetails.  # noqa: E501

        Delivery type to be used on settling the contract.  Optional: Defaults to DeliveryType.Physical if not provided.    Supported string (enumeration) values are: [Cash, Physical].  # noqa: E501

        :return: The delivery_type of this FuturesContractDetails.  # noqa: E501
        :rtype: str
        """
    ...
    def delivery_type(self, delivery_type):
        """Sets the delivery_type of this FuturesContractDetails.

        Delivery type to be used on settling the contract.  Optional: Defaults to DeliveryType.Physical if not provided.    Supported string (enumeration) values are: [Cash, Physical].  # noqa: E501

        :param delivery_type: The delivery_type of this FuturesContractDetails.  # noqa: E501
        :type delivery_type: str
        """
