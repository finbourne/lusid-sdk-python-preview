...
class FuturesContractDetails(object):
    ...
    def __init__(self, dom_ccy=None, contract_code=None, contract_month=None, contract_size=None, convention=None, country=None, description=None, exchange_code=None, exchange_name=None, ticker_step=None, unit_value=None):  # noqa: E501
        """
        ...
        :param contract_month:  which month does the contract trade for. (required)
        ...
        :param convention:  The available values are: Actual360, Act360, MoneyMarket, Actual365, Act365, Thirty360, ThirtyU360, Bond, ThirtyE360, EuroBond, ActAct, ActualActual, ActActIsda, ActActIsma, ActActIcma, Invalid (required)
        :type convention: str
        :param country:  Country (code) for the exchange. (required)
        :type country: str
        :param description:  Description of contract (required)
        :type description: str
        :param exchange_code:  Exchange code for contract (required)
    ...
    def contract_month(self):
        ...
        which month does the contract trade for.  # noqa: E501
    ...
    def convention(self):
        ...
        The available values are: Actual360, Act360, MoneyMarket, Actual365, Act365, Thirty360, ThirtyU360, Bond, ThirtyE360, EuroBond, ActAct, ActualActual, ActActIsda, ActActIsma, ActActIcma, Invalid  # noqa: E501
    ...
    def convention(self, convention):
        ...
        allowed_values = ["Actual360", "Act360", "MoneyMarket", "Actual365", "Act365", "Thirty360", "ThirtyU360", "Bond", "ThirtyE360", "EuroBond", "ActAct", "ActualActual", "ActActIsda", "ActActIsma", "ActActIcma", "Invalid"]  # noqa: E501
        if convention not in allowed_values:
            raise ValueError(
                "Invalid value for `convention` ({0}), must be one of {1}"  # noqa: E501
                .format(convention, allowed_values)
            )
    ...
    def exchange_code(self):
        ...
        Exchange code for contract  # noqa: E501
