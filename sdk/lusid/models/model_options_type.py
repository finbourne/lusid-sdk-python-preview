...
class ModelOptionsType(object):
    ...
    allowable_values = [INVALID, OPAQUEMODELOPTIONS, EMPTYMODELOPTIONS, INDEXMODELOPTIONS, FXFORWARDMODELOPTIONS, FUNDINGLEGMODELOPTIONS, EQUITYMODELOPTIONS]  # noqa: E501
