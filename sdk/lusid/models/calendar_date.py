...
class CalendarDate(object):
    ...
    def __init__(self, href=None, date_identifier=None, from_utc=None, to_utc=None, local_date=None, timezone=None, description=None, type=None, attributes=None, source_data=None):  # noqa: E501
        """
