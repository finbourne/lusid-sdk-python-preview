...
class CalendarDate(object):
    ...
    def __init__(self, href=None, date_identifier=None, from_utc=None, to_utc=None, local_start_date=None, timezone=None, description=None, type=None, attributes=None, source_data=None):  # noqa: E501
        """
        ...
        :param local_start_date:  (required)
        :type local_start_date: str
        ...
        self.to_utc = to_utc
        self.local_start_date = local_start_date
    ...
    def local_start_date(self):
        """Gets the local_start_date of this CalendarDate.  # noqa: E501


        :return: The local_start_date of this CalendarDate.  # noqa: E501
        :rtype: str
        """
        return self._local_start_date

    @local_start_date.setter
    def local_start_date(self, local_start_date):
        """Sets the local_start_date of this CalendarDate.


        :param local_start_date: The local_start_date of this CalendarDate.  # noqa: E501
        :type: str
        """
        if local_start_date is None:
            raise ValueError("Invalid value for `local_start_date`, must not be `None`")  # noqa: E501

        self._local_start_date = local_start_date
