...
class MarketDataSpecificRule(object):
    ...
    def __init__(self, key=None, supplier=None, data_scope=None, quote_type=None, field=None, quote_interval=None, as_at=None, price_source=None, mask=None, dependency_source_filter=None, source_system=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type data_scope: str
        :param quote_type:  The available values are: Price, Spread, Rate, LogNormalVol, NormalVol, ParSpread, IsdaSpread, Upfront, Index, Ratio, Delta, PoolFactor, InflationAssumption, DirtyPrice (required)
        :type quote_type: str
    ...
    def quote_type(self):
        ...
        The available values are: Price, Spread, Rate, LogNormalVol, NormalVol, ParSpread, IsdaSpread, Upfront, Index, Ratio, Delta, PoolFactor, InflationAssumption, DirtyPrice  # noqa: E501
    ...
    def quote_type(self, quote_type):
        ...
        allowed_values = ["Price", "Spread", "Rate", "LogNormalVol", "NormalVol", "ParSpread", "IsdaSpread", "Upfront", "Index", "Ratio", "Delta", "PoolFactor", "InflationAssumption", "DirtyPrice"]  # noqa: E501
