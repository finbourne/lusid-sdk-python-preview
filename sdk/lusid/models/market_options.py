...
class MarketOptions(object):
    ...
    def __init__(self, default_supplier=None, default_instrument_code_type=None, default_scope=None, attempt_to_infer_missing_fx=None, manifest_level_of_detail=None, local_vars_configuration=None):  # noqa: E501
        """
        ...
        :param manifest_level_of_detail: 
    ...
    def manifest_level_of_detail(self, manifest_level_of_detail):
        ...
        if self.local_vars_configuration.client_side_validation and manifest_level_of_detail not in allowed_values:  # noqa: E501
            raise ValueError(
