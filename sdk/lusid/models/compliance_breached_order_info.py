...
class ComplianceBreachedOrderInfo(object):
    ...
    def __init__(self, order_id=None, list_rule_result=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param list_rule_result:  The related list of rule results that may be applicable to this order (applied to portfolio that the order belongs to) (required)
    ...
    def list_rule_result(self):
        ...
        The related list of rule results that may be applicable to this order (applied to portfolio that the order belongs to)  # noqa: E501
