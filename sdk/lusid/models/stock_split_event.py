...
class StockSplitEvent(object):
    ...
    def __init__(self, payment_date=None, ex_date=None, units_ratio=None, record_date=None, announcement_date=None, fractional_units_cash_price=None, fractional_units_cash_currency=None, instrument_event_type=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param fractional_units_cash_price:  The cash price per unit paid in lieu when fractional units can not be distributed.
        :type fractional_units_cash_price: float
        :param fractional_units_cash_currency:  The currency of the cash paid in lieu of fractional units.
    ...
    def fractional_units_cash_price(self):
        """Gets the fractional_units_cash_price of this StockSplitEvent.  # noqa: E501

        The cash price per unit paid in lieu when fractional units can not be distributed.  # noqa: E501

        :return: The fractional_units_cash_price of this StockSplitEvent.  # noqa: E501
        :rtype: float
        """
    ...
    def fractional_units_cash_price(self, fractional_units_cash_price):
        """Sets the fractional_units_cash_price of this StockSplitEvent.

        The cash price per unit paid in lieu when fractional units can not be distributed.  # noqa: E501

        :param fractional_units_cash_price: The fractional_units_cash_price of this StockSplitEvent.  # noqa: E501
        :type fractional_units_cash_price: float
        """
    ...
    def fractional_units_cash_currency(self):
        """Gets the fractional_units_cash_currency of this StockSplitEvent.  # noqa: E501

        The currency of the cash paid in lieu of fractional units.  # noqa: E501

        :return: The fractional_units_cash_currency of this StockSplitEvent.  # noqa: E501
        :rtype: str
        """
    ...
    def fractional_units_cash_currency(self, fractional_units_cash_currency):
        """Sets the fractional_units_cash_currency of this StockSplitEvent.

        The currency of the cash paid in lieu of fractional units.  # noqa: E501

        :param fractional_units_cash_currency: The fractional_units_cash_currency of this StockSplitEvent.  # noqa: E501
        :type fractional_units_cash_currency: str
        """
