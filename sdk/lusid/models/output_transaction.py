...
class OutputTransaction(object):
    ...
    def instrument_identifiers(self):
        ...
        The set of instrument identifiers that can be used to resolve the transaction to a unique instrument.  # noqa: E501
    ...
    def properties(self):
        ...
        Set of unique transaction properties and associated values to stored with the transaction. Each property will be from the 'Trade' domain.  # noqa: E501
