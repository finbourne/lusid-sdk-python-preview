...
class OutputTransaction(object):
    ...
    openapi_types = {
        ...
        'source_type': 'str',
        'source_instrument_event_id': 'str',
    ...
    attribute_map = {
        ...
        'source_instrument_event_id': 'sourceInstrumentEventId',
    ...
    required_map = {
        ...
        'holding_ids': 'optional',
        'source_type': 'optional',
        'source_instrument_event_id': 'optional',
        'transaction_group_id': 'optional'
    }

    def __init__(self, transaction_id=None, type=None, description=None, instrument_identifiers=None, instrument_scope=None, instrument_uid=None, transaction_date=None, settlement_date=None, units=None, transaction_amount=None, transaction_price=None, total_consideration=None, exchange_rate=None, transaction_to_portfolio_rate=None, transaction_currency=None, properties=None, counterparty_id=None, source=None, transaction_status=None, entry_date_time=None, cancel_date_time=None, realised_gain_loss=None, holding_ids=None, source_type=None, source_instrument_event_id=None, transaction_group_id=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param instrument_uid:  The unique Lusid Instrument Id (LUID) of the instrument that the transaction is in. (required)
        ...
        :param holding_ids:  The collection of single identifiers for the holding within the portfolio. The holdingId is constructed from the LusidInstrumentId, sub-holding keys and currrency and is unique within the portfolio.
        :type holding_ids: list[int]
        :param source_type:  The type of source that the transaction originated from, eg: InputTransaction, InstrumentEvent, HoldingAdjustment
        :type source_type: str
        :param source_instrument_event_id:  The unique ID of the instrument event that the transaction is related to.
        :type source_instrument_event_id: str
        :param transaction_group_id:  The identifier for grouping economic events across multiple transactions
        ...
        self._holding_ids = None
        self._source_type = None
        self._source_instrument_event_id = None
        ...
        self.source_instrument_event_id = source_instrument_event_id
    ...
    def instrument_uid(self):
        ...
        The unique Lusid Instrument Id (LUID) of the instrument that the transaction is in.  # noqa: E501
    ...
    def holding_ids(self):
        """Gets the holding_ids of this OutputTransaction.  # noqa: E501

        The collection of single identifiers for the holding within the portfolio. The holdingId is constructed from the LusidInstrumentId, sub-holding keys and currrency and is unique within the portfolio.  # noqa: E501

        :return: The holding_ids of this OutputTransaction.  # noqa: E501
        :rtype: list[int]
        """
        return self._holding_ids

    @holding_ids.setter
    def holding_ids(self, holding_ids):
        """Sets the holding_ids of this OutputTransaction.

        The collection of single identifiers for the holding within the portfolio. The holdingId is constructed from the LusidInstrumentId, sub-holding keys and currrency and is unique within the portfolio.  # noqa: E501

        :param holding_ids: The holding_ids of this OutputTransaction.  # noqa: E501
        :type holding_ids: list[int]
        """

        self._holding_ids = holding_ids

    @property
    def source_type(self):
        """Gets the source_type of this OutputTransaction.  # noqa: E501

        The type of source that the transaction originated from, eg: InputTransaction, InstrumentEvent, HoldingAdjustment  # noqa: E501

        :return: The source_type of this OutputTransaction.  # noqa: E501
        :rtype: str
        """
    ...
    def source_type(self, source_type):
        """Sets the source_type of this OutputTransaction.

        The type of source that the transaction originated from, eg: InputTransaction, InstrumentEvent, HoldingAdjustment  # noqa: E501

        :param source_type: The source_type of this OutputTransaction.  # noqa: E501
        :type source_type: str
        """
    ...
    @property
    def source_instrument_event_id(self):
        """Gets the source_instrument_event_id of this OutputTransaction.  # noqa: E501

        The unique ID of the instrument event that the transaction is related to.  # noqa: E501

        :return: The source_instrument_event_id of this OutputTransaction.  # noqa: E501
        :rtype: str
        """
        return self._source_instrument_event_id

    @source_instrument_event_id.setter
    def source_instrument_event_id(self, source_instrument_event_id):
        """Sets the source_instrument_event_id of this OutputTransaction.

        The unique ID of the instrument event that the transaction is related to.  # noqa: E501

        :param source_instrument_event_id: The source_instrument_event_id of this OutputTransaction.  # noqa: E501
        :type source_instrument_event_id: str
        """

        self._source_instrument_event_id = source_instrument_event_id

    @property
    def transaction_group_id(self):
        """Gets the transaction_group_id of this OutputTransaction.  # noqa: E501

        The identifier for grouping economic events across multiple transactions  # noqa: E501

        :return: The transaction_group_id of this OutputTransaction.  # noqa: E501
        :rtype: str
        """
    ...
    def transaction_group_id(self, transaction_group_id):
        """Sets the transaction_group_id of this OutputTransaction.

        The identifier for grouping economic events across multiple transactions  # noqa: E501

        :param transaction_group_id: The transaction_group_id of this OutputTransaction.  # noqa: E501
        :type transaction_group_id: str
        """
