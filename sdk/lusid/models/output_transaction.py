...
class OutputTransaction(object):
    ...
    def __init__(self, transaction_id=None, type=None, description=None, instrument_identifiers=None, instrument_uid=None, transaction_date=None, settlement_date=None, units=None, transaction_amount=None, transaction_price=None, total_consideration=None, exchange_rate=None, transaction_to_portfolio_rate=None, transaction_currency=None, properties=None, counterparty_id=None, source=None, transaction_status=None, entry_date_time=None, cancel_date_time=None, realised_gain_loss=None):  # noqa: E501
        ...
        :param instrument_identifiers:  The set of instrument identifiers that can be used to resolve the transaction to a unique instrument.
        ...
        :type source: str
        :param transaction_status:  The status of the transaction.
