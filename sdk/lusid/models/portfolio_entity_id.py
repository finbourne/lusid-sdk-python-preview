...
class PortfolioEntityId(object):
    ...
    def __init__(self, scope=None, code=None, portfolio_entity_type=None):  # noqa: E501
        ...
        :type code: str
        :param portfolio_entity_type:  String identifier for portfolio e.g. \"SinglePortfolio\" and \"GroupPortfolio\". If not specified will assume it is a single portfolio.
    ...
    def portfolio_entity_type(self):
        ...
        String identifier for portfolio e.g. \"SinglePortfolio\" and \"GroupPortfolio\". If not specified will assume it is a single portfolio.  # noqa: E501
