...
class DiaryEntryRequest(object):
    ...
    def __init__(self, name=None, status=None, effective_at=None, query_as_at=None, properties=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type name: str
        :param status:  The status of the diary entry. Defaults to 'Undefined' and the allowed options are: 'Undefined' and 'Estimate'.
        :type status: str
    ...
    def status(self):
        ...
        The status of the diary entry. Defaults to 'Undefined' and the allowed options are: 'Undefined' and 'Estimate'.  # noqa: E501
