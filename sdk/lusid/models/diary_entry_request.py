...
class DiaryEntryRequest(object):
    ...
    def __init__(self, diary_entry_code=None, name=None, status=None, effective_at=None, query_as_at=None, properties=None, local_vars_configuration=None):  # noqa: E501
        """DiaryEntryRequest - a model defined in OpenAPI"
        
        :param diary_entry_code:  The code of the diary entry. (required)
        :type diary_entry_code: str
        :param name:  The name of the diary entry.
        :type name: str
        :param status:  The status of a Diary Entry of Type 'Other'. Defaults to 'Undefined' and supports 'Undefined', 'Estimate', 'Candidate', and 'Final'.
        :type status: str
    ...
    def diary_entry_code(self):
        """Gets the diary_entry_code of this DiaryEntryRequest.  # noqa: E501

        The code of the diary entry.  # noqa: E501

        :return: The diary_entry_code of this DiaryEntryRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def diary_entry_code(self, diary_entry_code):
        """Sets the diary_entry_code of this DiaryEntryRequest.

        The code of the diary entry.  # noqa: E501

        :param diary_entry_code: The diary_entry_code of this DiaryEntryRequest.  # noqa: E501
        :type diary_entry_code: str
        """
    ...
    def status(self):
        ...
        The status of a Diary Entry of Type 'Other'. Defaults to 'Undefined' and supports 'Undefined', 'Estimate', 'Candidate', and 'Final'.  # noqa: E501
