...
class ContractForDifference(object):
    ...
    def __init__(self, start_date=None, maturity_date=None, code=None, contract_size=None, pay_ccy=None, reference_rate=None, type=None, underlying_ccy=None, underlying_identifier=None, lot_size=None, instrument_type=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param lot_size:  CFD LotSize, the minimum number of shares that can be bought or sold at once.  Optional, if set must be non-negative, if not set defaults to 1.
        :type lot_size: int
    ...
    @property
    def lot_size(self):
        """Gets the lot_size of this ContractForDifference.  # noqa: E501

        CFD LotSize, the minimum number of shares that can be bought or sold at once.  Optional, if set must be non-negative, if not set defaults to 1.  # noqa: E501

        :return: The lot_size of this ContractForDifference.  # noqa: E501
        :rtype: int
        """
    ...
    def lot_size(self, lot_size):
        """Sets the lot_size of this ContractForDifference.

        CFD LotSize, the minimum number of shares that can be bought or sold at once.  Optional, if set must be non-negative, if not set defaults to 1.  # noqa: E501

        :param lot_size: The lot_size of this ContractForDifference.  # noqa: E501
        :type lot_size: int
        """
