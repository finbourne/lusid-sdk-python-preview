...
class FxRateScheduleAllOf(object):
    ...
    def fixing_lag(self, fixing_lag):
        """Sets the fixing_lag of this FxRateScheduleAllOf.

        If rate is not known upfront then will need a fixing rate. Can be fixed x number of days before payment date.  # noqa: E501

        :param fixing_lag: The fixing_lag of this FxRateScheduleAllOf.  # noqa: E501
        :type fixing_lag: int
        """
