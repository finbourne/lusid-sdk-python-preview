...
class OrderGraphBlockOrderDetail(object):
    ...
    def __init__(self, id=None, compliance_state=None, approval_state=None, portfolio_id=None, portfolio_name=None, order_approval_task_id=None, order_approval_task_definition_id=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param compliance_state:  The compliance state of this order. Possible values are 'Pending', 'Failed', 'Manually approved', 'Passed' and 'Warning'. (required)
    ...
    def compliance_state(self):
        ...
        The compliance state of this order. Possible values are 'Pending', 'Failed', 'Manually approved', 'Passed' and 'Warning'.  # noqa: E501
