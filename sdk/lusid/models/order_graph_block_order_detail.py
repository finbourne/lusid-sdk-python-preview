...
class OrderGraphBlockOrderDetail(object):
    ...
    def __init__(self, id=None, compliance_state=None, approval_state=None, portfolio_id=None, portfolio_name=None, order_approval_task_id=None, local_vars_configuration=None):  # noqa: E501
