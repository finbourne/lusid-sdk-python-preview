...
class Order(object):
    ...
    def __init__(self, properties=None, version=None, instrument_identifiers=None, quantity=None, side=None, order_book_id=None, portfolio_id=None, id=None, lusid_instrument_id=None, links=None, local_vars_configuration=None):  # noqa: E501
