...
class InternalEvent(object):
    ...
    def __init__(self, event_type=None, event_category=None, event_source=None, anchor_date=None, event_window_end=None, instrument_event_type=None, local_vars_configuration=None):  # noqa: E501
        """InternalEvent - a model defined in OpenAPI"
    ...
    @property
    def event_type(self):
        """Gets the event_type of this InternalEvent.  # noqa: E501

        What category of event does this represent; instrument opening, closing, transition or other.  # noqa: E501

        :return: The event_type of this InternalEvent.  # noqa: E501
        :rtype: str
        """
    ...
    def event_type(self, event_type):
        """Sets the event_type of this InternalEvent.

        What category of event does this represent; instrument opening, closing, transition or other.  # noqa: E501

        :param event_type: The event_type of this InternalEvent.  # noqa: E501
        :type event_type: str
        """
    ...
    def event_category(self):
        """Gets the event_category of this InternalEvent.  # noqa: E501

        What category of event does this represent; instrument opening, closing, transition or other.  # noqa: E501

        :return: The event_category of this InternalEvent.  # noqa: E501
        :rtype: str
        """
    ...
    def event_category(self, event_category):
        """Sets the event_category of this InternalEvent.

        What category of event does this represent; instrument opening, closing, transition or other.  # noqa: E501

        :param event_category: The event_category of this InternalEvent.  # noqa: E501
        :type event_category: str
        """
    ...
    def event_source(self):
        """Gets the event_source of this InternalEvent.  # noqa: E501

        What is the event source, what causes it to happen.  # noqa: E501

        :return: The event_source of this InternalEvent.  # noqa: E501
        :rtype: str
        """
    ...
    def event_source(self, event_source):
        """Sets the event_source of this InternalEvent.

        What is the event source, what causes it to happen.  # noqa: E501

        :param event_source: The event_source of this InternalEvent.  # noqa: E501
        :type event_source: str
        """
    ...
    def anchor_date(self):
        """Gets the anchor_date of this InternalEvent.  # noqa: E501
        ...
        :return: The anchor_date of this InternalEvent.  # noqa: E501
        :rtype: datetime
        """
    ...
    def anchor_date(self, anchor_date):
        """Sets the anchor_date of this InternalEvent.

        In the case of a point event, the single date on which the event occurs. In the case of an event which is  spread over a window, e.g. a barrier or American option, the start of that window.  # noqa: E501

        :param anchor_date: The anchor_date of this InternalEvent.  # noqa: E501
        :type anchor_date: datetime
        """
    ...
    def event_window_end(self):
        """Gets the event_window_end of this InternalEvent.  # noqa: E501
        ...
        :return: The event_window_end of this InternalEvent.  # noqa: E501
        :rtype: datetime
        """
    ...
    def event_window_end(self, event_window_end):
        """Sets the event_window_end of this InternalEvent.

        In the case of a point event this is identical to the anchor date. In the case of an event that is spread over a window,  this is the end of that window.  # noqa: E501

        :param event_window_end: The event_window_end of this InternalEvent.  # noqa: E501
        :type event_window_end: datetime
        """
    ...
    def instrument_event_type(self):
        """Gets the instrument_event_type of this InternalEvent.  # noqa: E501
        ...
        :return: The instrument_event_type of this InternalEvent.  # noqa: E501
        :rtype: str
        """
    ...
    def instrument_event_type(self, instrument_event_type):
        """Sets the instrument_event_type of this InternalEvent.

        The Type of Event. The available values are: TransitionEvent, InternalEvent, CouponEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent  # noqa: E501

        :param instrument_event_type: The instrument_event_type of this InternalEvent.  # noqa: E501
        :type instrument_event_type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InternalEvent):
            return False
