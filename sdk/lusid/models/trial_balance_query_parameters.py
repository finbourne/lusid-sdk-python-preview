...
class TrialBalanceQueryParameters(object):
    ...
    def __init__(self, start=None, end=None, date_mode=None, general_ledger_profile_code=None, property_keys=None, exclude_cleardown_module=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param date_mode:  The mode of calculation of the trial balance. The available values are: ActivityDate, AccountingDate.
        :type date_mode: str
    ...
    def date_mode(self):
        ...
        The mode of calculation of the trial balance. The available values are: ActivityDate, AccountingDate.  # noqa: E501
