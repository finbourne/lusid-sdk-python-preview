...
class CapitalDistributionEventAllOf(object):
    ...
    def __init__(self, announcement_date=None, cash_elections=None, ex_date=None, payment_date=None, record_date=None, instrument_event_type=None, local_vars_configuration=None):  # noqa: E501
        """CapitalDistributionEventAllOf - a model defined in OpenAPI"
    ...
    def announcement_date(self):
        """Gets the announcement_date of this CapitalDistributionEventAllOf.  # noqa: E501

        Date on which the dividend was announced / declared.  # noqa: E501

        :return: The announcement_date of this CapitalDistributionEventAllOf.  # noqa: E501
        :rtype: datetime
        """
    ...
    def announcement_date(self, announcement_date):
        """Sets the announcement_date of this CapitalDistributionEventAllOf.

        Date on which the dividend was announced / declared.  # noqa: E501

        :param announcement_date: The announcement_date of this CapitalDistributionEventAllOf.  # noqa: E501
        :type announcement_date: datetime
        """
    ...
    def cash_elections(self):
        """Gets the cash_elections of this CapitalDistributionEventAllOf.  # noqa: E501

        Possible elections for this event, each keyed with a unique identifier.  # noqa: E501

        :return: The cash_elections of this CapitalDistributionEventAllOf.  # noqa: E501
    ...
    def cash_elections(self, cash_elections):
        """Sets the cash_elections of this CapitalDistributionEventAllOf.

        Possible elections for this event, each keyed with a unique identifier.  # noqa: E501

        :param cash_elections: The cash_elections of this CapitalDistributionEventAllOf.  # noqa: E501
        :type cash_elections: list[lusid.CashElection]
        """
    ...
    @property
    def ex_date(self):
        """Gets the ex_date of this CapitalDistributionEventAllOf.  # noqa: E501

        The first business day on which the dividend is not owed to the buying party.  # noqa: E501

        :return: The ex_date of this CapitalDistributionEventAllOf.  # noqa: E501
        :rtype: datetime
        """
    ...
    def ex_date(self, ex_date):
        """Sets the ex_date of this CapitalDistributionEventAllOf.

        The first business day on which the dividend is not owed to the buying party.  # noqa: E501

        :param ex_date: The ex_date of this CapitalDistributionEventAllOf.  # noqa: E501
        :type ex_date: datetime
        """
    ...
    def payment_date(self):
        """Gets the payment_date of this CapitalDistributionEventAllOf.  # noqa: E501

        The date the company begins distributing the dividend.  # noqa: E501

        :return: The payment_date of this CapitalDistributionEventAllOf.  # noqa: E501
        :rtype: datetime
        """
    ...
    def payment_date(self, payment_date):
        """Sets the payment_date of this CapitalDistributionEventAllOf.

        The date the company begins distributing the dividend.  # noqa: E501

        :param payment_date: The payment_date of this CapitalDistributionEventAllOf.  # noqa: E501
        :type payment_date: datetime
        """
    ...
    def record_date(self):
        """Gets the record_date of this CapitalDistributionEventAllOf.  # noqa: E501

        Date you have to be the holder of record in order to participate in the tender.  # noqa: E501

        :return: The record_date of this CapitalDistributionEventAllOf.  # noqa: E501
        :rtype: datetime
        """
    ...
    def record_date(self, record_date):
        """Sets the record_date of this CapitalDistributionEventAllOf.

        Date you have to be the holder of record in order to participate in the tender.  # noqa: E501

        :param record_date: The record_date of this CapitalDistributionEventAllOf.  # noqa: E501
        :type record_date: datetime
        """
    ...
    def instrument_event_type(self):
        """Gets the instrument_event_type of this CapitalDistributionEventAllOf.  # noqa: E501
        ...
        :return: The instrument_event_type of this CapitalDistributionEventAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def instrument_event_type(self, instrument_event_type):
        """Sets the instrument_event_type of this CapitalDistributionEventAllOf.

        The Type of Event. The available values are: TransitionEvent, InformationalEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent, AmortisationEvent, CashFlowEvent, ExerciseEvent, ResetEvent, TriggerEvent, RawVendorEvent, InformationalErrorEvent, BondCouponEvent, DividendReinvestmentEvent, AccumulationEvent, BondPrincipalEvent, DividendOptionEvent, MaturityEvent, FxForwardSettlementEvent, ExpiryEvent, ScripDividendEvent, StockDividendEvent, ReverseStockSplitEvent, CapitalDistributionEvent, SpinOffEvent, MergerEvent, FutureExpiryEvent  # noqa: E501

        :param instrument_event_type: The instrument_event_type of this CapitalDistributionEventAllOf.  # noqa: E501
        :type instrument_event_type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CapitalDistributionEventAllOf):
            return False
