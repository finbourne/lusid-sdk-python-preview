...
class Stream(object):
    ...
    def __init__(self, can_read=None, can_write=None, can_seek=None, can_timeout=None, length=None, position=None, read_timeout=None, write_timeout=None, local_vars_configuration=None):  # noqa: E501
