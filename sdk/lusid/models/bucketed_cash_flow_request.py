...
class BucketedCashFlowRequest(object):
    ...
    openapi_types = {
        ...
        'cash_flow_type': 'str',
        'bucketing_schedule': 'BucketingSchedule',
        'filter': 'str'
    }
    ...
    required_map = {
        ...
        'bucketing_schedule': 'optional',
        'filter': 'optional'
    }

    def __init__(self, rounding_method=None, bucketing_dates=None, bucket_tenors=None, effective_at=None, window_start=None, window_end=None, recipe_id=None, report_currency=None, group_by=None, addresses=None, equip_with_subtotals=None, as_at=None, exclude_unsettled_trades=None, cash_flow_type=None, bucketing_schedule=None, filter=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param report_currency:  Three letter ISO currency string indicating what currency to report in for ReportCurrency denominated queries.
        ...
        :param bucketing_schedule: 
        :type bucketing_schedule: lusid.BucketingSchedule
        :param filter: 
        :type filter: str
        ...
        if bucketing_schedule is not None:
            self.bucketing_schedule = bucketing_schedule
        self.filter = filter
    ...
    def cash_flow_type(self):
        """Gets the cash_flow_type of this BucketedCashFlowRequest.  # noqa: E501
        ...
        :return: The cash_flow_type of this BucketedCashFlowRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def cash_flow_type(self, cash_flow_type):
        """Sets the cash_flow_type of this BucketedCashFlowRequest.

        Indicate the requested cash flow representation InstrumentCashFlows or PortfolioCashFlows (GetCashLadder uses this)  Options: [InstrumentCashFlow, PortfolioCashFlow]  # noqa: E501

        :param cash_flow_type: The cash_flow_type of this BucketedCashFlowRequest.  # noqa: E501
        :type cash_flow_type: str
        """
    ...
    @property
    def bucketing_schedule(self):
        """Gets the bucketing_schedule of this BucketedCashFlowRequest.  # noqa: E501


        :return: The bucketing_schedule of this BucketedCashFlowRequest.  # noqa: E501
        :rtype: lusid.BucketingSchedule
        """
        return self._bucketing_schedule

    @bucketing_schedule.setter
    def bucketing_schedule(self, bucketing_schedule):
        """Sets the bucketing_schedule of this BucketedCashFlowRequest.


        :param bucketing_schedule: The bucketing_schedule of this BucketedCashFlowRequest.  # noqa: E501
        :type bucketing_schedule: lusid.BucketingSchedule
        """

        self._bucketing_schedule = bucketing_schedule

    @property
    def filter(self):
        """Gets the filter of this BucketedCashFlowRequest.  # noqa: E501


        :return: The filter of this BucketedCashFlowRequest.  # noqa: E501
        :rtype: str
        """
        return self._filter
    ...
    def filter(self, filter):
        """Sets the filter of this BucketedCashFlowRequest.


        :param filter: The filter of this BucketedCashFlowRequest.  # noqa: E501
        :type filter: str
        """
        if (self.local_vars_configuration.client_side_validation and
