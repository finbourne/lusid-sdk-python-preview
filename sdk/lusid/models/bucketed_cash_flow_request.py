...
class BucketedCashFlowRequest(object):
    ...
    def __init__(self, rounding_method=None, bucketing_dates=None, bucket_tenors=None, effective_at=None, window_start=None, window_end=None, recipe_id=None, report_currency=None, group_by=None, addresses=None, equip_with_subtotals=None, as_at=None, local_vars_configuration=None):  # noqa: E501
