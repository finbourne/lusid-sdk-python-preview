...
class UpsertRecipeRequest(object):
    ...
    required_map = {
        'code': 'required',
        'configuration_recipe': 'required',
        'configuration_recipe_snippet': 'required'
    }
    ...
    def __init__(self, code=None, configuration_recipe=None, configuration_recipe_snippet=None):  # noqa: E501
        ...
        :type code: str
        :param configuration_recipe:  (required)
        :type configuration_recipe: lusid.ConfigurationRecipe
        :param configuration_recipe_snippet:  (required)
    ...
    def configuration_recipe(self, configuration_recipe):
        ...
        """
        if configuration_recipe is None:
    ...
    def configuration_recipe_snippet(self, configuration_recipe_snippet):
        ...
        """
        if configuration_recipe_snippet is None:
