...
class AggregatedReturn(object):
    ...
    def __init__(self, effective_at=None, opening_market_value=None, closing_market_value=None, metrics_value=None, frequency=None, local_vars_configuration=None):  # noqa: E501
