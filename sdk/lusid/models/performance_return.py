...
class PerformanceReturn(object):
    ...
    def __init__(self, effective_at=None, ro_r=None, opening_market_value=None, period=None):  # noqa: E501
        """
        PerformanceReturn - a model defined in OpenAPI

        :param effective_at:  The effectiveAt for the return. (required)
        :type effective_at: datetime
        :param ro_r:  The return number. (required)
        :type ro_r: float
    ...
    @property
    def ro_r(self):
        """Gets the ro_r of this PerformanceReturn.  # noqa: E501

        The return number.  # noqa: E501

        :return: The ro_r of this PerformanceReturn.  # noqa: E501
        :rtype: float
        """
        return self._ro_r
    ...
    @ro_r.setter
    def ro_r(self, ro_r):
        """Sets the ro_r of this PerformanceReturn.

        The return number.  # noqa: E501

        :param ro_r: The ro_r of this PerformanceReturn.  # noqa: E501
        :type: float
        """
        if ro_r is None:
            raise ValueError("Invalid value for `ro_r`, must not be `None`")  # noqa: E501
