...
class GroupFilterStepAllOf(object):
    ...
    def __init__(self, label=None, limit_check_parameters=None, warning_check_parameters=None, compliance_step_type=None, local_vars_configuration=None):  # noqa: E501
        """GroupFilterStepAllOf - a model defined in OpenAPI"
    ...
    @property
    def label(self):
        """Gets the label of this GroupFilterStepAllOf.  # noqa: E501

        The label of the compliance step  # noqa: E501

        :return: The label of this GroupFilterStepAllOf.  # noqa: E501
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        """Sets the label of this GroupFilterStepAllOf.

        The label of the compliance step  # noqa: E501

        :param label: The label of this GroupFilterStepAllOf.  # noqa: E501
        :type label: str
        """
    ...
    def limit_check_parameters(self):
        """Gets the limit_check_parameters of this GroupFilterStepAllOf.  # noqa: E501

        Parameters required for an absolute limit check  # noqa: E501

        :return: The limit_check_parameters of this GroupFilterStepAllOf.  # noqa: E501
    ...
    def limit_check_parameters(self, limit_check_parameters):
        """Sets the limit_check_parameters of this GroupFilterStepAllOf.

        Parameters required for an absolute limit check  # noqa: E501

        :param limit_check_parameters: The limit_check_parameters of this GroupFilterStepAllOf.  # noqa: E501
        :type limit_check_parameters: list[lusid.ComplianceTemplateParameter]
        """
    ...
    def warning_check_parameters(self):
        """Gets the warning_check_parameters of this GroupFilterStepAllOf.  # noqa: E501

        Parameters required for a warning limit check  # noqa: E501

        :return: The warning_check_parameters of this GroupFilterStepAllOf.  # noqa: E501
        :rtype: list[lusid.ComplianceTemplateParameter]
        """
    ...
    def warning_check_parameters(self, warning_check_parameters):
        """Sets the warning_check_parameters of this GroupFilterStepAllOf.

        Parameters required for a warning limit check  # noqa: E501

        :param warning_check_parameters: The warning_check_parameters of this GroupFilterStepAllOf.  # noqa: E501
        :type warning_check_parameters: list[lusid.ComplianceTemplateParameter]
        """
    ...
    def compliance_step_type(self):
        """Gets the compliance_step_type of this GroupFilterStepAllOf.  # noqa: E501

        . The available values are: FilterStep, GroupByStep, GroupFilterStep, BranchStep, RecombineStep  # noqa: E501

        :return: The compliance_step_type of this GroupFilterStepAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def compliance_step_type(self, compliance_step_type):
        """Sets the compliance_step_type of this GroupFilterStepAllOf.

        . The available values are: FilterStep, GroupByStep, GroupFilterStep, BranchStep, RecombineStep  # noqa: E501

        :param compliance_step_type: The compliance_step_type of this GroupFilterStepAllOf.  # noqa: E501
        :type compliance_step_type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GroupFilterStepAllOf):
            return False
