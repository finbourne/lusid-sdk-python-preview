...
class FixedSchedule(object):
    ...
    def __init__(self, start_date=None, maturity_date=None, flow_conventions=None, coupon_rate=None, convention_name=None, notional=None, payment_currency=None, stub_type=None, schedule_type=None, local_vars_configuration=None):  # noqa: E501
