...
class JELinesQueryParameters(object):
    ...
    def __init__(self, start_date=None, end_date=None, filter=None, property_keys=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type filter: str
        :param property_keys:  A list of property keys from the 'Instrument', 'Transaction', 'Portfolio' or 'Account' domain to decorate onto the JELine.
    ...
    def property_keys(self):
        ...
        A list of property keys from the 'Instrument', 'Transaction', 'Portfolio' or 'Account' domain to decorate onto the JELine.  # noqa: E501
