...
class StagingRuleSet(object):
    ...
    def __init__(self, entity_type=None, staging_rule_set_id=None, display_name=None, description=None, rules=None, href=None, version=None, local_vars_configuration=None):  # noqa: E501
