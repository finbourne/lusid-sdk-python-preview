...
class AborConfiguration(object):
    ...
    def __init__(self, href=None, id=None, description=None, name=None, recipe_id=None, chart_of_accounts_id=None, posting_module_ids=None, properties=None, version=None, links=None, local_vars_configuration=None):  # noqa: E501
