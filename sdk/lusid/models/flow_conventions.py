...
class FlowConventions(object):
    ...
    def __init__(self, scope=None, code=None, currency=None, payment_frequency=None, day_count_convention=None, roll_convention=None, holiday_calendars=None, settle_days=None, reset_days=None):  # noqa: E501
        """
        ...
        :param day_count_convention:  The available values are: Actual360, Act360, MoneyMarket, Actual365, Act365, Thirty360, ThirtyU360, Bond, ThirtyE360, EuroBond, ActAct, ActualActual, ActActIsda, ActActIsma, ActActIcma, Invalid (required)
        ...
        :param settle_days:  Number of Good Business Days between the trade date and the effective or settlement date of the instrument.
        :type settle_days: int
        :param reset_days:  The number of Good Business Days between determination and payment of reset.
        :type reset_days: int
