...
class FlowConventions(object):
    ...
    def __init__(self, currency=None, payment_frequency=None, day_count_convention=None, roll_convention=None, holiday_calendars=None, local_vars_configuration=None):  # noqa: E501
        """
    ...
    def day_count_convention(self, day_count_convention):
        ...
        if self.local_vars_configuration.client_side_validation and day_count_convention not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def roll_convention(self, roll_convention):
        ...
        if self.local_vars_configuration.client_side_validation and roll_convention not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def holiday_calendars(self, holiday_calendars):
        ...
        :type: list[str]
        """
        if self.local_vars_configuration.client_side_validation and holiday_calendars is None:  # noqa: E501
