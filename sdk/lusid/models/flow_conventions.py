...
class FlowConventions(object):
    ...
    def payment_frequency(self, payment_frequency):
        ...
        if (self.local_vars_configuration.client_side_validation and
                payment_frequency is not None and len(payment_frequency) > 16):
            raise ValueError("Invalid value for `payment_frequency`, length must be less than or equal to `16`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def day_count_convention(self, day_count_convention):
        ...
        if (self.local_vars_configuration.client_side_validation and
                day_count_convention is not None and len(day_count_convention) > 16):
            raise ValueError("Invalid value for `day_count_convention`, length must be less than or equal to `16`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
