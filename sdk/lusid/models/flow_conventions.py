...
class FlowConventions(object):
    ...
    openapi_types = {
        ...
        'coupon_payment_lag': 'RelativeDateOffset',
        'scope': 'str',
        'code': 'str'
    }
    ...
    attribute_map = {
        ...
        'coupon_payment_lag': 'couponPaymentLag',
        'scope': 'scope',
        'code': 'code'
    }
    ...
    def __init__(self, currency=None, payment_frequency=None, day_count_convention=None, roll_convention=None, payment_calendars=None, reset_calendars=None, settle_days=None, reset_days=None, leap_days_included=None, accrual_date_adjustment=None, business_day_convention=None, accrual_day_count_convention=None, coupon_payment_lag=None, scope=None, code=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param accrual_date_adjustment:  Indicates if the accrual dates are adjusted using the business day convention. The default value is 'Adjusted'.    Supported string (enumeration) values are: [Adjusted, Unadjusted].
        ...
        :param coupon_payment_lag: 
        :type coupon_payment_lag: lusid.RelativeDateOffset
        ...
        if coupon_payment_lag is not None:
            self.coupon_payment_lag = coupon_payment_lag
        self.scope = scope
        self.code = code
    ...
    def accrual_date_adjustment(self):
        ...
        Indicates if the accrual dates are adjusted using the business day convention. The default value is 'Adjusted'.    Supported string (enumeration) values are: [Adjusted, Unadjusted].  # noqa: E501
    ...
    @property
    def coupon_payment_lag(self):
        """Gets the coupon_payment_lag of this FlowConventions.  # noqa: E501


        :return: The coupon_payment_lag of this FlowConventions.  # noqa: E501
        :rtype: lusid.RelativeDateOffset
        """
        return self._coupon_payment_lag

    @coupon_payment_lag.setter
    def coupon_payment_lag(self, coupon_payment_lag):
        """Sets the coupon_payment_lag of this FlowConventions.


        :param coupon_payment_lag: The coupon_payment_lag of this FlowConventions.  # noqa: E501
        :type coupon_payment_lag: lusid.RelativeDateOffset
        """

        self._coupon_payment_lag = coupon_payment_lag
