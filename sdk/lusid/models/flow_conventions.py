...
class FlowConventions(object):
    ...
    required_map = {
        ...
        'day_count_basis': 'required',
        'roll_convention': 'required',
        'holiday_calendars': 'required'
    }

    def __init__(self, currency=None, payment_frequency=None, day_count_basis=None, roll_convention=None, holiday_calendars=None):  # noqa: E501
        """
        ...
        :param day_count_basis:  When calculating the fraction of a year between two dates, what convention is used to represent the number of days in a year  and difference between them. (required)
        :type day_count_basis: str
        ...
        :param holiday_calendars:  A comma separated string denoting holiday calendars that apply to generation and payment. (required)
        :type holiday_calendars: str

        """  # noqa: E501

        self._currency = None
        self._payment_frequency = None
        self._day_count_basis = None
    ...
    def day_count_basis(self):
        """Gets the day_count_basis of this FlowConventions.  # noqa: E501
        ...
        :return: The day_count_basis of this FlowConventions.  # noqa: E501
        :rtype: str
        """
        return self._day_count_basis

    @day_count_basis.setter
    def day_count_basis(self, day_count_basis):
        """Sets the day_count_basis of this FlowConventions.

        When calculating the fraction of a year between two dates, what convention is used to represent the number of days in a year  and difference between them.  # noqa: E501

        :param day_count_basis: The day_count_basis of this FlowConventions.  # noqa: E501
        :type: str
        """
        if day_count_basis is None:
            raise ValueError("Invalid value for `day_count_basis`, must not be `None`")  # noqa: E501
        allowed_values = ["Actual360", "Act360", "MoneyMarket", "Actual365", "Act365", "Thirty360", "ThirtyU360", "Bond", "Invalid"]  # noqa: E501
        if day_count_basis not in allowed_values:
            raise ValueError(
                "Invalid value for `day_count_basis` ({0}), must be one of {1}"  # noqa: E501
                .format(day_count_basis, allowed_values)
            )
    ...
    def holiday_calendars(self):
        ...
        A comma separated string denoting holiday calendars that apply to generation and payment.  # noqa: E501
