...
class FeeAccrual(object):
    ...
    def __init__(self, effective_at=None, name=None, calculation_base=None, amount=None, previous_accrual=None, total_accrual=None, local_vars_configuration=None):  # noqa: E501
