...
class FxForwardAllOf(object):
    ...
    def __init__(self, start_date=None, maturity_date=None, dom_amount=None, dom_ccy=None, fgn_amount=None, fgn_ccy=None, ref_spot_rate=None, is_ndf=None, fixing_date=None, settlement_ccy=None, booked_as_spot=None, instrument_type=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param booked_as_spot:  Boolean flag for FX Forward transactions booked with Spot settlement. This will default to False if not provided.  For information purposes only, this is not used by LUSID and does not impact any valuation, analytics, cashflows or events.
    ...
    def booked_as_spot(self):
        ...
        Boolean flag for FX Forward transactions booked with Spot settlement. This will default to False if not provided.  For information purposes only, this is not used by LUSID and does not impact any valuation, analytics, cashflows or events.  # noqa: E501
