...
class FxForwardAllOf(object):
    ...
    required_map = {
        ...
        'booked_as_spot': 'optional',
        'instrument_type': 'required'
    }

    def __init__(self, start_date=None, maturity_date=None, dom_amount=None, dom_ccy=None, fgn_amount=None, fgn_ccy=None, ref_spot_rate=None, is_ndf=None, fixing_date=None, settlement_ccy=None, booked_as_spot=None, instrument_type=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param fgn_ccy:  The foreign (other) currency of the instrument. In the NDF case, only payments are made in the domestic currency.  For the outright forward, currencies are exchanged. (required)
        :type fgn_ccy: str
        ...
        if booked_as_spot is not None:
            self.booked_as_spot = booked_as_spot
    ...
    def fgn_ccy(self):
        ...
        The foreign (other) currency of the instrument. In the NDF case, only payments are made in the domestic currency.  For the outright forward, currencies are exchanged.  # noqa: E501
    ...
    @property
    def booked_as_spot(self):
        """Gets the booked_as_spot of this FxForwardAllOf.  # noqa: E501

        Boolean flag for FX Forward transactions booked with Spot settlement. This will default to False if not provided.  For information purposes only, this does not impact LUSID valuation, analytics, cashflows or events, but may be used by third party vendors.  # noqa: E501

        :return: The booked_as_spot of this FxForwardAllOf.  # noqa: E501
        :rtype: bool
        """
        return self._booked_as_spot

    @booked_as_spot.setter
    def booked_as_spot(self, booked_as_spot):
        """Sets the booked_as_spot of this FxForwardAllOf.

        Boolean flag for FX Forward transactions booked with Spot settlement. This will default to False if not provided.  For information purposes only, this does not impact LUSID valuation, analytics, cashflows or events, but may be used by third party vendors.  # noqa: E501

        :param booked_as_spot: The booked_as_spot of this FxForwardAllOf.  # noqa: E501
        :type booked_as_spot: bool
        """

        self._booked_as_spot = booked_as_spot
