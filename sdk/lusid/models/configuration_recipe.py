...
class ConfigurationRecipe(object):
    ...
    def __init__(self, code=None, market=None, pricing=None, aggregation=None, inherited_recipes=None, description=None):  # noqa: E501
        """
        ...
        :param description:  User can assign a description to understand more humanly the recipe. (required)
        ...
        if inherited_recipes is not None:
