...
class WeightedInstrument(object):
    ...
    openapi_types = {
        ...
        'in_line_lookup_identifiers': 'WeightedInstrumentInLineLookupIdentifiers',
    ...
    attribute_map = {
        ...
        'in_line_lookup_identifiers': 'inLineLookupIdentifiers',
    ...
    required_map = {
        ...
        'instrument': 'optional',
        'in_line_lookup_identifiers': 'optional',
        'instrument_scope': 'optional'
    }

    def __init__(self, quantity=None, holding_identifier=None, instrument=None, in_line_lookup_identifiers=None, instrument_scope=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param in_line_lookup_identifiers: 
        :type in_line_lookup_identifiers: lusid.WeightedInstrumentInLineLookupIdentifiers
        :param instrument_scope:  The scope in which to resolve the instrument, if no inlined definition is provided.  If left empty, the default scope will be used.
        ...
        self._in_line_lookup_identifiers = None
        ...
        self.in_line_lookup_identifiers = in_line_lookup_identifiers
    ...
    @property
    def in_line_lookup_identifiers(self):
        """Gets the in_line_lookup_identifiers of this WeightedInstrument.  # noqa: E501


        :return: The in_line_lookup_identifiers of this WeightedInstrument.  # noqa: E501
        :rtype: lusid.WeightedInstrumentInLineLookupIdentifiers
        """
        return self._in_line_lookup_identifiers

    @in_line_lookup_identifiers.setter
    def in_line_lookup_identifiers(self, in_line_lookup_identifiers):
        """Sets the in_line_lookup_identifiers of this WeightedInstrument.


        :param in_line_lookup_identifiers: The in_line_lookup_identifiers of this WeightedInstrument.  # noqa: E501
        :type in_line_lookup_identifiers: lusid.WeightedInstrumentInLineLookupIdentifiers
        """

        self._in_line_lookup_identifiers = in_line_lookup_identifiers

    @property
    def instrument_scope(self):
        """Gets the instrument_scope of this WeightedInstrument.  # noqa: E501

        The scope in which to resolve the instrument, if no inlined definition is provided.  If left empty, the default scope will be used.  # noqa: E501

        :return: The instrument_scope of this WeightedInstrument.  # noqa: E501
        :rtype: str
        """
    ...
    def instrument_scope(self, instrument_scope):
        """Sets the instrument_scope of this WeightedInstrument.

        The scope in which to resolve the instrument, if no inlined definition is provided.  If left empty, the default scope will be used.  # noqa: E501

        :param instrument_scope: The instrument_scope of this WeightedInstrument.  # noqa: E501
        :type instrument_scope: str
        """
        if (self.local_vars_configuration.client_side_validation and
                instrument_scope is not None and len(instrument_scope) > 256):
            raise ValueError("Invalid value for `instrument_scope`, length must be less than or equal to `256`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
