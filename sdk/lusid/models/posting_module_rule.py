...
class PostingModuleRule(object):
    ...
    def __init__(self, rule_id=None, account=None, rule_filter=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type account: str
        :param rule_filter:  The filter syntax for the rule. See KB for filter syntax https://support.lusid.com/knowledgebase/article/KA-02140 (required)
    ...
    def rule_filter(self):
        ...
        The filter syntax for the rule. See KB for filter syntax https://support.lusid.com/knowledgebase/article/KA-02140  # noqa: E501
