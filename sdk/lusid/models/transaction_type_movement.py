...
class TransactionTypeMovement(object):
    ...
    def __init__(self, movement_types=None, side=None, direction=None, properties=None, mappings=None, name=None, movement_options=None, settlement_date_override=None, condition=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param condition:  The condition that the transaction must satisfy to generate the movement, such as: Portfolio.BaseCurrency eq 'GBP'. The condition can contain fields and properties from transactions and portfolios. If no condition is provided, the movement will apply for all transactions of this type.
        :type condition: str
    ...
    @property
    def condition(self):
        """Gets the condition of this TransactionTypeMovement.  # noqa: E501

        The condition that the transaction must satisfy to generate the movement, such as: Portfolio.BaseCurrency eq 'GBP'. The condition can contain fields and properties from transactions and portfolios. If no condition is provided, the movement will apply for all transactions of this type.  # noqa: E501

        :return: The condition of this TransactionTypeMovement.  # noqa: E501
        :rtype: str
        """
    ...
    def condition(self, condition):
        """Sets the condition of this TransactionTypeMovement.

        The condition that the transaction must satisfy to generate the movement, such as: Portfolio.BaseCurrency eq 'GBP'. The condition can contain fields and properties from transactions and portfolios. If no condition is provided, the movement will apply for all transactions of this type.  # noqa: E501

        :param condition: The condition of this TransactionTypeMovement.  # noqa: E501
        :type condition: str
        """
        if (self.local_vars_configuration.client_side_validation and
                condition is not None and len(condition) > 16384):
            raise ValueError("Invalid value for `condition`, length must be less than or equal to `16384`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
        ...
        if (self.local_vars_configuration.client_side_validation and
                condition is not None and not re.search(r'^[\s\S]*$', condition)):  # noqa: E501
            raise ValueError(r"Invalid value for `condition`, must be a follow pattern or equal to `/^[\s\S]*$/`")  # noqa: E501
