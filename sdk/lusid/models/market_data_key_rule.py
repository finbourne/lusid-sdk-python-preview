...
class MarketDataKeyRule(object):
    ...
    def __init__(self, key=None, supplier=None, data_scope=None, quote_type=None, field=None, quote_interval=None, as_at=None, price_source=None, mask=None, source_system=None, fall_through_on_access_denied=None, local_vars_configuration=None):  # noqa: E501
    ...
    def fall_through_on_access_denied(self):
        """Gets the fall_through_on_access_denied of this MarketDataKeyRule.  # noqa: E501
        ...
        :return: The fall_through_on_access_denied of this MarketDataKeyRule.  # noqa: E501
        :rtype: bool
        """
    ...
    def fall_through_on_access_denied(self, fall_through_on_access_denied):
        """Sets the fall_through_on_access_denied of this MarketDataKeyRule.

        When a user attempts to use a rule to access data to which they are not entitled,  the rule will fail to resolve any market data.  By default, such an access denied failure will stop any further attempts to resolve market data.  This is so that differently entitled users always receive the same market data from market data resolution,  if they have sufficient entitlements to retrieve the required data.  If set to true, then an access denied failure will not stop further market data resolution,  and resolution will continue with the next specified MarketDataKeyRule.  Optional, and defaults to false.  # noqa: E501

        :param fall_through_on_access_denied: The fall_through_on_access_denied of this MarketDataKeyRule.  # noqa: E501
        :type fall_through_on_access_denied: bool
        """
