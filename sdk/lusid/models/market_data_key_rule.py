...
class MarketDataKeyRule(object):
    ...
    def __init__(self, key=None, supplier=None, data_scope=None, quote_type=None, field=None, quote_interval=None, as_at=None):  # noqa: E501
    ...
    def quote_interval(self, quote_interval):
        ...
        :type: str
        """
        if quote_interval is None:
            raise ValueError("Invalid value for `quote_interval`, must not be `None`")  # noqa: E501
