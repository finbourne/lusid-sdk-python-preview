...
class CreatePropertyDefinitionRequest(object):
    ...
    def __init__(self, domain=None, scope=None, code=None, value_required=None, display_name=None, data_type_id=None, life_time=None, constraint_style=None, property_description=None, collection_type=None, local_vars_configuration=None):  # noqa: E501
        """CreatePropertyDefinitionRequest - a model defined in OpenAPI"
        
        :param domain:  The domain that the property exists in. The available values are: NotDefined, Transaction, Portfolio, Holding, ReferenceHolding, TransactionConfiguration, Instrument, CutLabelDefinition, Analytic, PortfolioGroup, Person, AccessMetadata, Order, UnitResult, MarketData, ConfigurationRecipe, Allocation, Calendar, LegalEntity, Placement, Execution, Block, Participation, Package, OrderInstruction, NextBestAction, CustomEntity, InstrumentEvent, Account, ChartOfAccounts, CustodianAccount, Abor, AborConfiguration, Fund, FundConfiguration, Fee, Reconciliation, PropertyDefinition, Compliance, DiaryEntry, Leg, DerivedValuation (required)
        :type domain: str
        ...
        :param collection_type:  Describes whether a collection property should behave as a set or as an array.
    ...
    def domain(self):
        ...
        The domain that the property exists in. The available values are: NotDefined, Transaction, Portfolio, Holding, ReferenceHolding, TransactionConfiguration, Instrument, CutLabelDefinition, Analytic, PortfolioGroup, Person, AccessMetadata, Order, UnitResult, MarketData, ConfigurationRecipe, Allocation, Calendar, LegalEntity, Placement, Execution, Block, Participation, Package, OrderInstruction, NextBestAction, CustomEntity, InstrumentEvent, Account, ChartOfAccounts, CustodianAccount, Abor, AborConfiguration, Fund, FundConfiguration, Fee, Reconciliation, PropertyDefinition, Compliance, DiaryEntry, Leg, DerivedValuation  # noqa: E501
    ...
    def collection_type(self):
        """Gets the collection_type of this CreatePropertyDefinitionRequest.  # noqa: E501

        Describes whether a collection property should behave as a set or as an array.  # noqa: E501

        :return: The collection_type of this CreatePropertyDefinitionRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def collection_type(self, collection_type):
        """Sets the collection_type of this CreatePropertyDefinitionRequest.

        Describes whether a collection property should behave as a set or as an array.  # noqa: E501

        :param collection_type: The collection_type of this CreatePropertyDefinitionRequest.  # noqa: E501
        :type collection_type: str
        """
