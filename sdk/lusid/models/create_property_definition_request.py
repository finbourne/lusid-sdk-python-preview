...
class CreatePropertyDefinitionRequest(object):
    ...
    def __init__(self, domain=None, scope=None, code=None, value_required=None, display_name=None, data_type_id=None, life_time=None):  # noqa: E501
    ...
    def domain(self, domain):
        ...
        allowed_values = ["NotDefined", "Transaction", "Portfolio", "Holding", "ReferenceHolding", "TransactionConfiguration", "Instrument", "CutLabelDefinition", "Analytic"]  # noqa: E501
    ...
    def value_required(self):
        ...
        Whether or not a value is always required for this property. Defaults to false if not specified.  # noqa: E501
    ...
    def life_time(self):
        ...
        Controls how the property's values can change over time. Defaults to \"Perpetual\" if not specified.  # noqa: E501
