...
class Account(object):
    ...
    def __init__(self, code=None, description=None, type=None, status=None, control=None, properties=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type type: str
        :param status:  The Account status. Can be Active, Inactive or Deleted. The available values are: Active, Inactive, Deleted (required)
        :type status: str
    ...
    def status(self):
        ...
        The Account status. Can be Active, Inactive or Deleted. The available values are: Active, Inactive, Deleted  # noqa: E501
