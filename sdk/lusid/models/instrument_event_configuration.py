...
class InstrumentEventConfiguration(object):
    ...
    def transaction_template_scopes(self, transaction_template_scopes):
        ...
        if (self.local_vars_configuration.client_side_validation and
                transaction_template_scopes is not None and len(transaction_template_scopes) > 1):
            raise ValueError("Invalid value for `transaction_template_scopes`, number of items must be less than or equal to `1`")  # noqa: E501
