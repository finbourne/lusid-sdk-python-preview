...
class InstrumentPaymentDiaryLeg(object):
    ...
    def __init__(self, leg_index=None, leg_id=None, rows=None, local_vars_configuration=None):  # noqa: E501
        """InstrumentPaymentDiaryLeg - a model defined in OpenAPI"
        
        :param leg_index:  Index (integer) for the leg of a payment diary.
        :type leg_index: int
        :param leg_id:  Identifier string for the leg of a payment diary.
        :type leg_id: str
    ...
    @property
    def leg_index(self):
        """Gets the leg_index of this InstrumentPaymentDiaryLeg.  # noqa: E501

        Index (integer) for the leg of a payment diary.  # noqa: E501

        :return: The leg_index of this InstrumentPaymentDiaryLeg.  # noqa: E501
        :rtype: int
        """
        return self._leg_index

    @leg_index.setter
    def leg_index(self, leg_index):
        """Sets the leg_index of this InstrumentPaymentDiaryLeg.

        Index (integer) for the leg of a payment diary.  # noqa: E501

        :param leg_index: The leg_index of this InstrumentPaymentDiaryLeg.  # noqa: E501
        :type leg_index: int
        """
    ...
    def leg_id(self):
        ...
        Identifier string for the leg of a payment diary.  # noqa: E501
