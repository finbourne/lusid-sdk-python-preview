...
class DividendReinvestmentEvent(object):
    ...
    def __init__(self, announcement_date=None, cash_elections=None, ex_date=None, payment_date=None, record_date=None, security_elections=None, security_settlement_date=None, instrument_event_type=None, local_vars_configuration=None):  # noqa: E501
        """DividendReinvestmentEvent - a model defined in OpenAPI"
    ...
    def announcement_date(self):
        """Gets the announcement_date of this DividendReinvestmentEvent.  # noqa: E501

        Date on which the dividend was announced / declared.  # noqa: E501

        :return: The announcement_date of this DividendReinvestmentEvent.  # noqa: E501
        :rtype: datetime
        """
    ...
    def announcement_date(self, announcement_date):
        """Sets the announcement_date of this DividendReinvestmentEvent.

        Date on which the dividend was announced / declared.  # noqa: E501

        :param announcement_date: The announcement_date of this DividendReinvestmentEvent.  # noqa: E501
        :type announcement_date: datetime
        """
    ...
    def cash_elections(self):
        """Gets the cash_elections of this DividendReinvestmentEvent.  # noqa: E501

        CashElection for this DividendReinvestmentEvent  # noqa: E501

        :return: The cash_elections of this DividendReinvestmentEvent.  # noqa: E501
    ...
    def cash_elections(self, cash_elections):
        """Sets the cash_elections of this DividendReinvestmentEvent.

        CashElection for this DividendReinvestmentEvent  # noqa: E501

        :param cash_elections: The cash_elections of this DividendReinvestmentEvent.  # noqa: E501
        :type cash_elections: list[lusid.CashElection]
        """
    ...
    @property
    def ex_date(self):
        """Gets the ex_date of this DividendReinvestmentEvent.  # noqa: E501
        ...
        :return: The ex_date of this DividendReinvestmentEvent.  # noqa: E501
        :rtype: datetime
        """
    ...
    def ex_date(self, ex_date):
        """Sets the ex_date of this DividendReinvestmentEvent.

        The first business day on which the dividend is not owed to the buying party.  Typically this is T-1 from the RecordDate.  # noqa: E501

        :param ex_date: The ex_date of this DividendReinvestmentEvent.  # noqa: E501
        :type ex_date: datetime
        """
    ...
    def payment_date(self):
        """Gets the payment_date of this DividendReinvestmentEvent.  # noqa: E501

        The date the company pays out dividends to shareholders.  # noqa: E501

        :return: The payment_date of this DividendReinvestmentEvent.  # noqa: E501
        :rtype: datetime
        """
    ...
    def payment_date(self, payment_date):
        """Sets the payment_date of this DividendReinvestmentEvent.

        The date the company pays out dividends to shareholders.  # noqa: E501

        :param payment_date: The payment_date of this DividendReinvestmentEvent.  # noqa: E501
        :type payment_date: datetime
        """
    ...
    def record_date(self):
        """Gets the record_date of this DividendReinvestmentEvent.  # noqa: E501

        Date you have to be the holder of record in order to participate in the tender.  # noqa: E501

        :return: The record_date of this DividendReinvestmentEvent.  # noqa: E501
        :rtype: datetime
        """
    ...
    def record_date(self, record_date):
        """Sets the record_date of this DividendReinvestmentEvent.

        Date you have to be the holder of record in order to participate in the tender.  # noqa: E501

        :param record_date: The record_date of this DividendReinvestmentEvent.  # noqa: E501
        :type record_date: datetime
        """
    ...
    def security_elections(self):
        """Gets the security_elections of this DividendReinvestmentEvent.  # noqa: E501

        SecurityElection for this DividendReinvestmentEvent  # noqa: E501

        :return: The security_elections of this DividendReinvestmentEvent.  # noqa: E501
    ...
    def security_elections(self, security_elections):
        """Sets the security_elections of this DividendReinvestmentEvent.

        SecurityElection for this DividendReinvestmentEvent  # noqa: E501

        :param security_elections: The security_elections of this DividendReinvestmentEvent.  # noqa: E501
        :type security_elections: list[lusid.SecurityElection]
        """
    ...
    def security_settlement_date(self):
        """Gets the security_settlement_date of this DividendReinvestmentEvent.  # noqa: E501

        The settlement date of the additional units.  Equal to the PaymentDate if not provided.  # noqa: E501

        :return: The security_settlement_date of this DividendReinvestmentEvent.  # noqa: E501
        :rtype: datetime
        """
    ...
    def security_settlement_date(self, security_settlement_date):
        """Sets the security_settlement_date of this DividendReinvestmentEvent.

        The settlement date of the additional units.  Equal to the PaymentDate if not provided.  # noqa: E501

        :param security_settlement_date: The security_settlement_date of this DividendReinvestmentEvent.  # noqa: E501
        :type security_settlement_date: datetime
        """
    ...
    def instrument_event_type(self):
        """Gets the instrument_event_type of this DividendReinvestmentEvent.  # noqa: E501
        ...
        :return: The instrument_event_type of this DividendReinvestmentEvent.  # noqa: E501
        :rtype: str
        """
    ...
    def instrument_event_type(self, instrument_event_type):
        """Sets the instrument_event_type of this DividendReinvestmentEvent.

        The Type of Event. The available values are: TransitionEvent, InformationalEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent, AmortisationEvent, CashFlowEvent, ExerciseEvent, ResetEvent, TriggerEvent, RawVendorEvent, InformationalErrorEvent, BondCouponEvent, DividendReinvestmentEvent, AccumulationEvent, BondPrincipalEvent, DividendOptionEvent, MaturityEvent, FxForwardSettlementEvent, ExpiryEvent, ScripDividendEvent, StockDividendEvent, ReverseStockSplitEvent, CapitalDistributionEvent, SpinOffEvent, MergerEvent, FutureExpiryEvent  # noqa: E501

        :param instrument_event_type: The instrument_event_type of this DividendReinvestmentEvent.  # noqa: E501
        :type instrument_event_type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DividendReinvestmentEvent):
            return False
