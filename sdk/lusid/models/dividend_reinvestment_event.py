...
class DividendReinvestmentEvent(object):
    ...
    def __init__(self, announcement_date=None, cash_elections=None, ex_date=None, payment_date=None, record_date=None, security_elections=None, instrument_event_type=None, local_vars_configuration=None):  # noqa: E501
