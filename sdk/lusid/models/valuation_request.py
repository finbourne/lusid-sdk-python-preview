...
class ValuationRequest(object):
    ...
    def __init__(self, recipe_id=None, as_at=None, metrics=None, group_by=None, filters=None, sort=None, report_currency=None, equip_with_subtotals=None, portfolio_entity_ids=None, valuation_schedule=None, market_data_overrides=None, local_vars_configuration=None):  # noqa: E501
