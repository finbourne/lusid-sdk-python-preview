...
class ValuationRequest(object):
    ...
    def __init__(self, recipe_id=None, as_at=None, metrics=None, group_by=None, filters=None, sort=None, report_currency=None, equip_with_subtotals=None, return_result_as_expanded_types=None, portfolio_entity_ids=None, valuation_schedule=None, market_data_overrides=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param return_result_as_expanded_types:  For complex results or financially meaningful results,  there is a need for a result to contain metadata about its currency and/or units  or to have a more complicated 1D or 2D structure
    ...
    def return_result_as_expanded_types(self):
        ...
        For complex results or financially meaningful results,  there is a need for a result to contain metadata about its currency and/or units  or to have a more complicated 1D or 2D structure  # noqa: E501
