...
class ValuationRequest(object):
    ...
    def __init__(self, recipe_id=None, as_at=None, metrics=None, group_by=None, filters=None, sort=None, report_currency=None, portfolio_entity_ids=None, valuation_schedule=None):  # noqa: E501
        """
        ...
        :param report_currency:  Three letter ISO currency string indicating what currency to report in for ReportCurrency denominated queries.  If not present then the currency of the relevant portfolio will be used in its place where relevant.
        :type report_currency: str
        :param portfolio_entity_ids:  The set of portfolio or portfolio group identifiers that state what is to be valued.
    ...
    def report_currency(self):
        ...
        Three letter ISO currency string indicating what currency to report in for ReportCurrency denominated queries.  If not present then the currency of the relevant portfolio will be used in its place where relevant.  # noqa: E501
    ...
    def portfolio_entity_ids(self):
        ...
        The set of portfolio or portfolio group identifiers that state what is to be valued.  # noqa: E501
