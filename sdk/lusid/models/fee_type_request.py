...
class FeeTypeRequest(object):
    ...
    def __init__(self, code=None, display_name=None, description=None, component_transactions=None, local_vars_configuration=None):  # noqa: E501
        """FeeTypeRequest - a model defined in OpenAPI"
    ...
    @property
    def code(self):
        """Gets the code of this FeeTypeRequest.  # noqa: E501


        :return: The code of this FeeTypeRequest.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this FeeTypeRequest.


        :param code: The code of this FeeTypeRequest.  # noqa: E501
        :type code: str
        """
    ...
    def display_name(self):
        """Gets the display_name of this FeeTypeRequest.  # noqa: E501

        The name of the fee type.  # noqa: E501

        :return: The display_name of this FeeTypeRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def display_name(self, display_name):
        """Sets the display_name of this FeeTypeRequest.

        The name of the fee type.  # noqa: E501

        :param display_name: The display_name of this FeeTypeRequest.  # noqa: E501
        :type display_name: str
        """
    ...
    def description(self):
        """Gets the description of this FeeTypeRequest.  # noqa: E501

        The description of the fee type.  # noqa: E501

        :return: The description of this FeeTypeRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this FeeTypeRequest.

        The description of the fee type.  # noqa: E501

        :param description: The description of this FeeTypeRequest.  # noqa: E501
        :type description: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def component_transactions(self):
        """Gets the component_transactions of this FeeTypeRequest.  # noqa: E501

        A set of component transactions that relate to the fee type to be created.  # noqa: E501

        :return: The component_transactions of this FeeTypeRequest.  # noqa: E501
    ...
    def component_transactions(self, component_transactions):
        """Sets the component_transactions of this FeeTypeRequest.

        A set of component transactions that relate to the fee type to be created.  # noqa: E501

        :param component_transactions: The component_transactions of this FeeTypeRequest.  # noqa: E501
        :type component_transactions: list[lusid.ComponentTransaction]
        """
        ...
        if (self.local_vars_configuration.client_side_validation and
                component_transactions is not None and len(component_transactions) > 1000):
            raise ValueError("Invalid value for `component_transactions`, number of items must be less than or equal to `1000`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FeeTypeRequest):
            return False
