...
class FeeTypeRequest(object):
    ...
    def __init__(self, code=None, name=None, description=None, component_transactions=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this FeeTypeRequest.  # noqa: E501

        The name of the fee type.  # noqa: E501

        :return: The name of this FeeTypeRequest.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this FeeTypeRequest.

        The name of the fee type.  # noqa: E501

        :param name: The name of this FeeTypeRequest.  # noqa: E501
        :type name: str
        """
