...
class UpsertInstrumentsResponse(object):
    ...
    def values(self):
        ...
        The collection of upserted instruments with their latest parameters.  # noqa: E501
    ...
    def failed(self):
        ...
        If any instruments failed to be upserted, they will be listed in 'Failed', along  with a reason why.  # noqa: E501
