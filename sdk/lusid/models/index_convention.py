...
class IndexConvention(object):
    ...
    def __init__(self, scope=None, code=None, fixing_reference=None, publication_day_lag=None, payment_tenor=None, day_count_convention=None, currency=None):  # noqa: E501
        """
