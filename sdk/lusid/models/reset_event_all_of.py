...
class ResetEventAllOf(object):
    ...
    def __init__(self, value=None, reset_type=None, fixing_source=None, event_status=None, fixing_date=None, instrument_event_type=None, local_vars_configuration=None):  # noqa: E501
        """ResetEventAllOf - a model defined in OpenAPI"
    ...
    def value(self, value):
        """Sets the value of this ResetEventAllOf.

        The quantity associated with the reset. This will only be populated if the information is known.  # noqa: E501

        :param value: The value of this ResetEventAllOf.  # noqa: E501
        :type value: float
        """
    ...
    @property
    def reset_type(self):
        """Gets the reset_type of this ResetEventAllOf.  # noqa: E501

        The type of the reset; e.g. RIC, Currency-pair  # noqa: E501

        :return: The reset_type of this ResetEventAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def reset_type(self, reset_type):
        """Sets the reset_type of this ResetEventAllOf.

        The type of the reset; e.g. RIC, Currency-pair  # noqa: E501

        :param reset_type: The reset_type of this ResetEventAllOf.  # noqa: E501
        :type reset_type: str
        """
    ...
    def fixing_source(self):
        """Gets the fixing_source of this ResetEventAllOf.  # noqa: E501

        Fixing identification source, if available.  # noqa: E501

        :return: The fixing_source of this ResetEventAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def fixing_source(self, fixing_source):
        """Sets the fixing_source of this ResetEventAllOf.

        Fixing identification source, if available.  # noqa: E501

        :param fixing_source: The fixing_source of this ResetEventAllOf.  # noqa: E501
        :type fixing_source: str
        """
    ...
    def event_status(self):
        """Gets the event_status of this ResetEventAllOf.  # noqa: E501

        What is the event status, is it a known (ie historic) or unknown (ie projected) event?  # noqa: E501

        :return: The event_status of this ResetEventAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def event_status(self, event_status):
        """Sets the event_status of this ResetEventAllOf.

        What is the event status, is it a known (ie historic) or unknown (ie projected) event?  # noqa: E501

        :param event_status: The event_status of this ResetEventAllOf.  # noqa: E501
        :type event_status: str
        """
    ...
    def fixing_date(self):
        """Gets the fixing_date of this ResetEventAllOf.  # noqa: E501

        The date the reset fixes, or is observed upon.  # noqa: E501

        :return: The fixing_date of this ResetEventAllOf.  # noqa: E501
        :rtype: datetime
        """
    ...
    def fixing_date(self, fixing_date):
        """Sets the fixing_date of this ResetEventAllOf.

        The date the reset fixes, or is observed upon.  # noqa: E501

        :param fixing_date: The fixing_date of this ResetEventAllOf.  # noqa: E501
        :type fixing_date: datetime
        """
    ...
    def instrument_event_type(self):
        """Gets the instrument_event_type of this ResetEventAllOf.  # noqa: E501
        ...
        :return: The instrument_event_type of this ResetEventAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def instrument_event_type(self, instrument_event_type):
        """Sets the instrument_event_type of this ResetEventAllOf.

        The Type of Event. The available values are: TransitionEvent, InformationalEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent, AmortisationEvent, CashFlowEvent, ExerciseEvent, ResetEvent, TriggerEvent, RawVendorEvent, InformationalErrorEvent  # noqa: E501

        :param instrument_event_type: The instrument_event_type of this ResetEventAllOf.  # noqa: E501
        :type instrument_event_type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResetEventAllOf):
            return False
