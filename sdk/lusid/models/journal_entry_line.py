...
class JournalEntryLine(object):
    ...
    attribute_map = {
        ...
        'economic_bucket_component': 'economicBucketComponent',
        'levels': 'levels',
    ...
    def __init__(self, accounting_date=None, activity_date=None, portfolio_id=None, instrument_id=None, instrument_scope=None, sub_holding_keys=None, tax_lot_id=None, general_ledger_account_code=None, local=None, base=None, units=None, posting_module_code=None, posting_rule=None, as_at_date=None, activities_description=None, source_type=None, source_id=None, properties=None, movement_name=None, holding_type=None, economic_bucket=None, economic_bucket_component=None, levels=None, source_levels=None, movement_sign=None, holding_sign=None, ledger_column=None, journal_entry_line_type=None, links=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param units:  Units held for the Journal Entry Line. (required)
        :type units: float
        ...
        :param economic_bucket_component:  Sub bucket of the economic bucket.
        :type economic_bucket_component: str
        ...
        self._economic_bucket_component = None
        self._levels = None
        ...
        self.economic_bucket_component = economic_bucket_component
        self.levels = levels
    ...
    @property
    def units(self):
        """Gets the units of this JournalEntryLine.  # noqa: E501

        Units held for the Journal Entry Line.  # noqa: E501

        :return: The units of this JournalEntryLine.  # noqa: E501
        :rtype: float
        """
        return self._units
    ...
    def units(self, units):
        """Sets the units of this JournalEntryLine.

        Units held for the Journal Entry Line.  # noqa: E501

        :param units: The units of this JournalEntryLine.  # noqa: E501
        :type units: float
        """
    ...
    @property
    def economic_bucket_component(self):
        """Gets the economic_bucket_component of this JournalEntryLine.  # noqa: E501

        Sub bucket of the economic bucket.  # noqa: E501

        :return: The economic_bucket_component of this JournalEntryLine.  # noqa: E501
        :rtype: str
        """
        return self._economic_bucket_component

    @economic_bucket_component.setter
    def economic_bucket_component(self, economic_bucket_component):
        """Sets the economic_bucket_component of this JournalEntryLine.

        Sub bucket of the economic bucket.  # noqa: E501

        :param economic_bucket_component: The economic_bucket_component of this JournalEntryLine.  # noqa: E501
        :type economic_bucket_component: str
        """

        self._economic_bucket_component = economic_bucket_component
