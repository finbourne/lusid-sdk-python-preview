...
class CdsInstrumentAllOf(object):
    ...
    def __init__(self, ticker=None, flow_conventions=None, coupon_rate=None, protection_detail_specification=None, start_date=None, maturity_date=None, dom_ccy=None, instrument_type=None):  # noqa: E501
        ...
        :type dom_ccy: str
        :param instrument_type:  The available values are: QuotedSecurity, InterestRateSwap, FxForward, Exotic, FxOption, CreditDefaultSwap, InterestRateSwaption, Bond, EquityOption, FixedRateLeg, FloatingRateLeg, BespokeCashflowLeg, Unknown (required)
    ...
    def instrument_type(self):
        ...
        The available values are: QuotedSecurity, InterestRateSwap, FxForward, Exotic, FxOption, CreditDefaultSwap, InterestRateSwaption, Bond, EquityOption, FixedRateLeg, FloatingRateLeg, BespokeCashflowLeg, Unknown  # noqa: E501
    ...
    def instrument_type(self, instrument_type):
        ...
        allowed_values = ["QuotedSecurity", "InterestRateSwap", "FxForward", "Exotic", "FxOption", "CreditDefaultSwap", "InterestRateSwaption", "Bond", "EquityOption", "FixedRateLeg", "FloatingRateLeg", "BespokeCashflowLeg", "Unknown"]  # noqa: E501
