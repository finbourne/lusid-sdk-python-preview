...
class CustomEntityResponse(object):
    ...
    def __init__(self, href=None, entity_type=None, version=None, display_name=None, description=None, identifiers=None, fields=None, links=None, local_vars_configuration=None):  # noqa: E501
