...
class SwapInstrument(object):
    ...
    required_map = {
        ...
        'notional_exchange': 'required',
        'instrument_type': 'required'
    }

    def __init__(self, start_date=None, maturity_date=None, legs=None, notional=None, is_amortizing=None, notional_exchange=None, instrument_type=None):  # noqa: E501
        """
    ...
    def notional_exchange(self):
        """Gets the notional_exchange of this SwapInstrument.  # noqa: E501

        True notional exchange type.  # noqa: E501

        :return: The notional_exchange of this SwapInstrument.  # noqa: E501
        :rtype: str
        """
        return self._notional_exchange

    @notional_exchange.setter
    def notional_exchange(self, notional_exchange):
        """Sets the notional_exchange of this SwapInstrument.

        True notional exchange type.  # noqa: E501

        :param notional_exchange: The notional_exchange of this SwapInstrument.  # noqa: E501
        :type: str
        """
        if notional_exchange is None:
            raise ValueError("Invalid value for `notional_exchange`, must not be `None`")  # noqa: E501
        allowed_values = ["None", "Initial", "Final", "Both"]  # noqa: E501
        if notional_exchange not in allowed_values:
            raise ValueError(
                "Invalid value for `notional_exchange` ({0}), must be one of {1}"  # noqa: E501
                .format(notional_exchange, allowed_values)
            )
