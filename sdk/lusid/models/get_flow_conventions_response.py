...
class GetFlowConventionsResponse(object):
    ...
    def __init__(self, href=None, value=None, failed=None, links=None):  # noqa: E501
        ...
        :param failed:  The identifiers which did not resolve to a conventions along with the nature of the failure.
    ...
    def failed(self):
        ...
        The identifiers which did not resolve to a conventions along with the nature of the failure.  # noqa: E501
