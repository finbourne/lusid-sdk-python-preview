...
class PropertyDefinition(object):
    ...
    def __init__(self, href=None, key=None, value_type=None, value_required=None, display_name=None, data_type_id=None, life_time=None, type=None, unit_schema=None, domain=None, scope=None, code=None, links=None):  # noqa: E501
