...
class PropertyDefinition(object):
    ...
    def __init__(self, href=None, key=None, value_type=None, display_name=None, data_type_id=None, type=None, unit_schema=None, domain=None, scope=None, code=None, value_required=None, life_time=None, constraint_style=None, property_definition_type=None, property_description=None, links=None):  # noqa: E501
        ...
        :type key: str
        :param value_type:  The type of values that can be associated with this property. This is defined by the property's data type. The available values are: String, Int, Decimal, DateTime, Boolean, Map, List, PropertyArray, Percentage, Code, Id, Uri, CurrencyAndAmount, Currency, MetricValue, ResourceId, ResultValue, CutLocalTime, DateOrCutLabel
        :type value_type: str
