...
class FxForwardCurveData(object):
    ...
    def __init__(self, base_date=None, dom_ccy=None, fgn_ccy=None, dates=None, rates=None, lineage=None, market_data_type=None, local_vars_configuration=None):  # noqa: E501
