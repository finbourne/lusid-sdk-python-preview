...
class MbsInterestDeferralEventAllOf(object):
    ...
    def __init__(self, ex_date=None, payment_date=None, currency=None, interest_per_unit=None, instrument_event_type=None, local_vars_configuration=None):  # noqa: E501
        """MbsInterestDeferralEventAllOf - a model defined in OpenAPI"
        ...
        :type currency: str
        :param interest_per_unit:  The interest amount to be deferred and capitalised for each unit of the instrument held on the ex date (required)
    ...
    @property
    def ex_date(self):
        """Gets the ex_date of this MbsInterestDeferralEventAllOf.  # noqa: E501

        The ex date (entitlement date) of the interest payment, usually several weeks prior to the payment date  # noqa: E501

        :return: The ex_date of this MbsInterestDeferralEventAllOf.  # noqa: E501
        :rtype: datetime
        """
    ...
    def ex_date(self, ex_date):
        """Sets the ex_date of this MbsInterestDeferralEventAllOf.

        The ex date (entitlement date) of the interest payment, usually several weeks prior to the payment date  # noqa: E501

        :param ex_date: The ex_date of this MbsInterestDeferralEventAllOf.  # noqa: E501
        :type ex_date: datetime
        """
    ...
    def payment_date(self):
        """Gets the payment_date of this MbsInterestDeferralEventAllOf.  # noqa: E501

        The payment date of the interest that is deferred and capitalised  # noqa: E501

        :return: The payment_date of this MbsInterestDeferralEventAllOf.  # noqa: E501
        :rtype: datetime
        """
    ...
    def payment_date(self, payment_date):
        """Sets the payment_date of this MbsInterestDeferralEventAllOf.

        The payment date of the interest that is deferred and capitalised  # noqa: E501

        :param payment_date: The payment_date of this MbsInterestDeferralEventAllOf.  # noqa: E501
        :type payment_date: datetime
        """
    ...
    @property
    def currency(self):
        """Gets the currency of this MbsInterestDeferralEventAllOf.  # noqa: E501

        The currency in which the interest amount is notated  # noqa: E501

        :return: The currency of this MbsInterestDeferralEventAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def currency(self, currency):
        """Sets the currency of this MbsInterestDeferralEventAllOf.

        The currency in which the interest amount is notated  # noqa: E501

        :param currency: The currency of this MbsInterestDeferralEventAllOf.  # noqa: E501
        :type currency: str
        """
    ...
    def interest_per_unit(self):
        """Gets the interest_per_unit of this MbsInterestDeferralEventAllOf.  # noqa: E501

        The interest amount to be deferred and capitalised for each unit of the instrument held on the ex date  # noqa: E501

        :return: The interest_per_unit of this MbsInterestDeferralEventAllOf.  # noqa: E501
        :rtype: float
        """
    ...
    def interest_per_unit(self, interest_per_unit):
        """Sets the interest_per_unit of this MbsInterestDeferralEventAllOf.

        The interest amount to be deferred and capitalised for each unit of the instrument held on the ex date  # noqa: E501

        :param interest_per_unit: The interest_per_unit of this MbsInterestDeferralEventAllOf.  # noqa: E501
        :type interest_per_unit: float
        """
    ...
    def instrument_event_type(self):
        """Gets the instrument_event_type of this MbsInterestDeferralEventAllOf.  # noqa: E501

        The Type of Event. The available values are: TransitionEvent, InformationalEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent, AmortisationEvent, CashFlowEvent, ExerciseEvent, ResetEvent, TriggerEvent, RawVendorEvent, InformationalErrorEvent, BondCouponEvent, DividendReinvestmentEvent, AccumulationEvent, BondPrincipalEvent, DividendOptionEvent, MaturityEvent, FxForwardSettlementEvent, ExpiryEvent, ScripDividendEvent, StockDividendEvent, ReverseStockSplitEvent, CapitalDistributionEvent, SpinOffEvent, MergerEvent, FutureExpiryEvent, SwapCashFlowEvent, SwapPrincipalEvent, CreditPremiumCashFlowEvent, CdsCreditEvent, CdxCreditEvent, MbsCouponEvent, MbsPrincipalEvent, BonusIssueEvent, MbsPrincipalWriteOffEvent, MbsInterestDeferralEvent, MbsInterestShortfallEvent, TenderEvent, CallOnIntermediateSecuritiesEvent  # noqa: E501

        :return: The instrument_event_type of this MbsInterestDeferralEventAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def instrument_event_type(self, instrument_event_type):
        """Sets the instrument_event_type of this MbsInterestDeferralEventAllOf.

        The Type of Event. The available values are: TransitionEvent, InformationalEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent, AmortisationEvent, CashFlowEvent, ExerciseEvent, ResetEvent, TriggerEvent, RawVendorEvent, InformationalErrorEvent, BondCouponEvent, DividendReinvestmentEvent, AccumulationEvent, BondPrincipalEvent, DividendOptionEvent, MaturityEvent, FxForwardSettlementEvent, ExpiryEvent, ScripDividendEvent, StockDividendEvent, ReverseStockSplitEvent, CapitalDistributionEvent, SpinOffEvent, MergerEvent, FutureExpiryEvent, SwapCashFlowEvent, SwapPrincipalEvent, CreditPremiumCashFlowEvent, CdsCreditEvent, CdxCreditEvent, MbsCouponEvent, MbsPrincipalEvent, BonusIssueEvent, MbsPrincipalWriteOffEvent, MbsInterestDeferralEvent, MbsInterestShortfallEvent, TenderEvent, CallOnIntermediateSecuritiesEvent  # noqa: E501

        :param instrument_event_type: The instrument_event_type of this MbsInterestDeferralEventAllOf.  # noqa: E501
        :type instrument_event_type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MbsInterestDeferralEventAllOf):
            return False
