...
class CdxCreditEventAllOf(object):
    ...
    def __init__(self, effective_date=None, auction_date=None, recovery_rate=None, constituent_weight=None, constituent_reference=None, instrument_event_type=None, local_vars_configuration=None):  # noqa: E501
        """CdxCreditEventAllOf - a model defined in OpenAPI"
    ...
    def effective_date(self):
        """Gets the effective_date of this CdxCreditEventAllOf.  # noqa: E501

        The date of the credit default - i.e. date on which the debt issuer defaulted on its repayment obligation.  # noqa: E501

        :return: The effective_date of this CdxCreditEventAllOf.  # noqa: E501
        :rtype: datetime
        """
    ...
    def effective_date(self, effective_date):
        """Sets the effective_date of this CdxCreditEventAllOf.

        The date of the credit default - i.e. date on which the debt issuer defaulted on its repayment obligation.  # noqa: E501

        :param effective_date: The effective_date of this CdxCreditEventAllOf.  # noqa: E501
        :type effective_date: datetime
        """
    ...
    def auction_date(self):
        """Gets the auction_date of this CdxCreditEventAllOf.  # noqa: E501
        ...
        :return: The auction_date of this CdxCreditEventAllOf.  # noqa: E501
        :rtype: datetime
        """
    ...
    def auction_date(self, auction_date):
        """Sets the auction_date of this CdxCreditEventAllOf.

        The date of the credit event auction - i.e. date on which the defaulted debt is sold via auction, and a recovery rate determined.  # noqa: E501

        :param auction_date: The auction_date of this CdxCreditEventAllOf.  # noqa: E501
        :type auction_date: datetime
        """
    ...
    def recovery_rate(self):
        """Gets the recovery_rate of this CdxCreditEventAllOf.  # noqa: E501

        The fraction of the defaulted debt that can be recovered.  # noqa: E501

        :return: The recovery_rate of this CdxCreditEventAllOf.  # noqa: E501
        :rtype: float
        """
    ...
    def recovery_rate(self, recovery_rate):
        """Sets the recovery_rate of this CdxCreditEventAllOf.

        The fraction of the defaulted debt that can be recovered.  # noqa: E501

        :param recovery_rate: The recovery_rate of this CdxCreditEventAllOf.  # noqa: E501
        :type recovery_rate: float
        """
    ...
    def constituent_weight(self):
        """Gets the constituent_weight of this CdxCreditEventAllOf.  # noqa: E501

        The relative weight of the CDX constituent.  # noqa: E501

        :return: The constituent_weight of this CdxCreditEventAllOf.  # noqa: E501
        :rtype: float
        """
    ...
    def constituent_weight(self, constituent_weight):
        """Sets the constituent_weight of this CdxCreditEventAllOf.

        The relative weight of the CDX constituent.  # noqa: E501

        :param constituent_weight: The constituent_weight of this CdxCreditEventAllOf.  # noqa: E501
        :type constituent_weight: float
        """
    ...
    def constituent_reference(self):
        """Gets the constituent_reference of this CdxCreditEventAllOf.  # noqa: E501

        Reference value used to identify the CDX constituent.  # noqa: E501

        :return: The constituent_reference of this CdxCreditEventAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def constituent_reference(self, constituent_reference):
        """Sets the constituent_reference of this CdxCreditEventAllOf.

        Reference value used to identify the CDX constituent.  # noqa: E501

        :param constituent_reference: The constituent_reference of this CdxCreditEventAllOf.  # noqa: E501
        :type constituent_reference: str
        """
    ...
    def instrument_event_type(self):
        """Gets the instrument_event_type of this CdxCreditEventAllOf.  # noqa: E501

        The Type of Event. The available values are: TransitionEvent, InformationalEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent, AmortisationEvent, CashFlowEvent, ExerciseEvent, ResetEvent, TriggerEvent, RawVendorEvent, InformationalErrorEvent, BondCouponEvent, DividendReinvestmentEvent, AccumulationEvent, BondPrincipalEvent, DividendOptionEvent, MaturityEvent, FxForwardSettlementEvent, ExpiryEvent, ScripDividendEvent, StockDividendEvent, ReverseStockSplitEvent, CapitalDistributionEvent, SpinOffEvent, MergerEvent, FutureExpiryEvent, SwapCashFlowEvent, SwapPrincipalEvent, CreditPremiumCashFlowEvent, CdsCreditEvent, CdxCreditEvent, MbsCouponEvent, MbsPrincipalEvent, BonusIssueEvent, MbsPrincipalWriteOffEvent, MbsInterestDeferralEvent, MbsInterestShortfallEvent, TenderEvent, CallOnIntermediateSecuritiesEvent  # noqa: E501

        :return: The instrument_event_type of this CdxCreditEventAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def instrument_event_type(self, instrument_event_type):
        """Sets the instrument_event_type of this CdxCreditEventAllOf.

        The Type of Event. The available values are: TransitionEvent, InformationalEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent, AmortisationEvent, CashFlowEvent, ExerciseEvent, ResetEvent, TriggerEvent, RawVendorEvent, InformationalErrorEvent, BondCouponEvent, DividendReinvestmentEvent, AccumulationEvent, BondPrincipalEvent, DividendOptionEvent, MaturityEvent, FxForwardSettlementEvent, ExpiryEvent, ScripDividendEvent, StockDividendEvent, ReverseStockSplitEvent, CapitalDistributionEvent, SpinOffEvent, MergerEvent, FutureExpiryEvent, SwapCashFlowEvent, SwapPrincipalEvent, CreditPremiumCashFlowEvent, CdsCreditEvent, CdxCreditEvent, MbsCouponEvent, MbsPrincipalEvent, BonusIssueEvent, MbsPrincipalWriteOffEvent, MbsInterestDeferralEvent, MbsInterestShortfallEvent, TenderEvent, CallOnIntermediateSecuritiesEvent  # noqa: E501

        :param instrument_event_type: The instrument_event_type of this CdxCreditEventAllOf.  # noqa: E501
        :type instrument_event_type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CdxCreditEventAllOf):
            return False
