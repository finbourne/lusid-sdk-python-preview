...
class DataMapping(object):
    ...
    """
    openapi_types = {
        'data_field_name_mappings': 'dict(str, str)',
        'links': 'list[Link]'
    }
    ...
    def __init__(self, data_field_name_mappings=None, links=None):  # noqa: E501
        """DataMapping - a model defined in OpenAPI"""  # noqa: E501
