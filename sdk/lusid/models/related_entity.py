...
class RelatedEntity(object):
    ...
    def __init__(self, entity_type=None, entity_id=None, display_name=None, properties=None, scope=None, identifiers=None, href=None, local_vars_configuration=None):  # noqa: E501
