...
class IndustryClassifier(object):
    ...
    def classification_system_name(self, classification_system_name):
        ...
        if (self.local_vars_configuration.client_side_validation and
                classification_system_name is not None and len(classification_system_name) < 1):
            raise ValueError("Invalid value for `classification_system_name`, length must be greater than or equal to `1`")  # noqa: E501
