...
class TargetTaxLotRequest(object):
    ...
    openapi_types = {
        ...
        'variation_margin_portfolio_ccy': 'float'
    }
    ...
    def __init__(self, units=None, cost=None, portfolio_cost=None, price=None, purchase_date=None, settlement_date=None, notional_cost=None, variation_margin=None, variation_margin_portfolio_ccy=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param notional_cost:  The notional cost of the tax-lot's opening transaction.
        :type notional_cost: float
        :param variation_margin:  The variation margin of the tax-lot's opening transaction.
        :type variation_margin: float
        :param variation_margin_portfolio_ccy:  The variation margin in portfolio currency of the tax-lot's opening transaction.
        :type variation_margin_portfolio_ccy: float
    ...
    def notional_cost(self):
        """Gets the notional_cost of this TargetTaxLotRequest.  # noqa: E501

        The notional cost of the tax-lot's opening transaction.  # noqa: E501

        :return: The notional_cost of this TargetTaxLotRequest.  # noqa: E501
        :rtype: float
        """
    ...
    def notional_cost(self, notional_cost):
        """Sets the notional_cost of this TargetTaxLotRequest.

        The notional cost of the tax-lot's opening transaction.  # noqa: E501

        :param notional_cost: The notional_cost of this TargetTaxLotRequest.  # noqa: E501
        :type notional_cost: float
        """
    ...
    def variation_margin(self):
        """Gets the variation_margin of this TargetTaxLotRequest.  # noqa: E501

        The variation margin of the tax-lot's opening transaction.  # noqa: E501

        :return: The variation_margin of this TargetTaxLotRequest.  # noqa: E501
        :rtype: float
        """
    ...
    def variation_margin(self, variation_margin):
        """Sets the variation_margin of this TargetTaxLotRequest.

        The variation margin of the tax-lot's opening transaction.  # noqa: E501

        :param variation_margin: The variation_margin of this TargetTaxLotRequest.  # noqa: E501
        :type variation_margin: float
        """
    ...
    def variation_margin_portfolio_ccy(self):
        """Gets the variation_margin_portfolio_ccy of this TargetTaxLotRequest.  # noqa: E501

        The variation margin in portfolio currency of the tax-lot's opening transaction.  # noqa: E501

        :return: The variation_margin_portfolio_ccy of this TargetTaxLotRequest.  # noqa: E501
        :rtype: float
        """
    ...
    def variation_margin_portfolio_ccy(self, variation_margin_portfolio_ccy):
        """Sets the variation_margin_portfolio_ccy of this TargetTaxLotRequest.

        The variation margin in portfolio currency of the tax-lot's opening transaction.  # noqa: E501

        :param variation_margin_portfolio_ccy: The variation_margin_portfolio_ccy of this TargetTaxLotRequest.  # noqa: E501
        :type variation_margin_portfolio_ccy: float
        """
