...
class ShareClassDetails(object):
    ...
    attribute_map = {
        ...
        'class_currency': 'classCurrency'
    }

    required_map = {
        'lusid_instrument_id': 'optional',
        'instrument_scope': 'optional',
        'class_currency': 'optional'
    }

    def __init__(self, lusid_instrument_id=None, instrument_scope=None, class_currency=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param class_currency:  The domestic currency of the share class instrument
        :type class_currency: str
    ...
    @property
    def class_currency(self):
        """Gets the class_currency of this ShareClassDetails.  # noqa: E501

        The domestic currency of the share class instrument  # noqa: E501

        :return: The class_currency of this ShareClassDetails.  # noqa: E501
        :rtype: str
        """
        return self._class_currency

    @class_currency.setter
    def class_currency(self, class_currency):
        """Sets the class_currency of this ShareClassDetails.

        The domestic currency of the share class instrument  # noqa: E501

        :param class_currency: The class_currency of this ShareClassDetails.  # noqa: E501
        :type class_currency: str
        """

        self._class_currency = class_currency
