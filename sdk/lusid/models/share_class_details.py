...
class ShareClassDetails(object):
    ...
    def __init__(self, lusid_instrument_id=None, instrument_scope=None, short_code=None, dom_currency=None, instrument_active=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param short_code:  The unique code within the fund for the share class instrument.
        :type short_code: str
    ...
    @property
    def short_code(self):
        """Gets the short_code of this ShareClassDetails.  # noqa: E501

        The unique code within the fund for the share class instrument.  # noqa: E501

        :return: The short_code of this ShareClassDetails.  # noqa: E501
        :rtype: str
        """
    ...
    def short_code(self, short_code):
        """Sets the short_code of this ShareClassDetails.

        The unique code within the fund for the share class instrument.  # noqa: E501

        :param short_code: The short_code of this ShareClassDetails.  # noqa: E501
        :type short_code: str
        """
        if (self.local_vars_configuration.client_side_validation and
                short_code is not None and len(short_code) > 64):
            raise ValueError("Invalid value for `short_code`, length must be less than or equal to `64`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
        ...
        if (self.local_vars_configuration.client_side_validation and
                short_code is not None and not re.search(r'^[a-zA-Z0-9\-_]+$', short_code)):  # noqa: E501
            raise ValueError(r"Invalid value for `short_code`, must be a follow pattern or equal to `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
