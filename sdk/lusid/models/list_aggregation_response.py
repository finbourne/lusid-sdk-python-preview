...
class ListAggregationResponse(object):
    ...
    def __init__(self, aggregation_effective_at=None, aggregation_as_at=None, href=None, data=None, aggregation_currency=None, data_schema=None, aggregation_failures=None, manifest=None, links=None, local_vars_configuration=None):  # noqa: E501
        """
        ...
        if data is not None:
            self.data = data
        if aggregation_currency is not None:
            self.aggregation_currency = aggregation_currency
        if data_schema is not None:
            self.data_schema = data_schema
        if aggregation_failures is not None:
