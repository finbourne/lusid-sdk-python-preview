...
class EquityOptionAllOf(object):
    ...
    def __init__(self, code=None, strike=None, option_maturity_date=None, option_settlement_date=None, start_date=None, option_type=None, delivery_type=None, underlying_identifier=None, dom_ccy=None, instrument_type=None):  # noqa: E501
        """
        ...
        :param option_type:  Type of optionality for the option (required)
        :type option_type: str
        :param delivery_type:  is the option cash settled or physical delivery of option (required)
        :type delivery_type: str
        :param underlying_identifier:  external market codes and identifiers for the option, e.g. RIC. (required)
    ...
    def option_type(self):
        ...
        Type of optionality for the option  # noqa: E501
    ...
    def delivery_type(self):
        ...
        is the option cash settled or physical delivery of option  # noqa: E501
    ...
    def underlying_identifier(self):
        ...
        external market codes and identifiers for the option, e.g. RIC.  # noqa: E501
