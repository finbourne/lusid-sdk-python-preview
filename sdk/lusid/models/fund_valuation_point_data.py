...
class FundValuationPointData(object):
    ...
    def __init__(self, back_out=None, dealing=None, pn_l=None, gav=None, fees=None, nav=None, miscellaneous=None, previous_valuation_point_data=None, local_vars_configuration=None):  # noqa: E501
