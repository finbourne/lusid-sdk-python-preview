...
class ValuationSchedule(object):
    ...
    def __init__(self, effective_from=None, effective_at=None, tenor=None, roll_convention=None, holiday_calendars=None, valuation_date_times=None):  # noqa: E501
        """
        ...
        :type tenor: str
        :param roll_convention:  When Tenor is given and is not equal to \"1D\", there may be cases where \"date + tenor\" ends up hitting non business days around month end. In that case,  what convention, e.g. modified following \"MF\" should be applied to determine the next GBD.
        :type roll_convention: str
        :param holiday_calendars:  What holiday calendars should be considered effective in determining the date schedule. Note that where these are not available, perhaps because the user  has insufficient permissions, a recipe setting will be used to determine whether the whole batch should then fail or whether the calendar not being available  should simply be ignored.
        :type holiday_calendars: list[str]
        :param valuation_date_times:  If given, the exact set of dates on which to perform a valuation. This will replace/override all other specified values if given
    ...
    def roll_convention(self):
        ...
        When Tenor is given and is not equal to \"1D\", there may be cases where \"date + tenor\" ends up hitting non business days around month end. In that case,  what convention, e.g. modified following \"MF\" should be applied to determine the next GBD.  # noqa: E501
    ...
    def valuation_date_times(self):
        ...
        If given, the exact set of dates on which to perform a valuation. This will replace/override all other specified values if given  # noqa: E501
