...
class ComplexBondAllOf(object):
    ...
    def __init__(self, identifiers=None, calculation_type=None, schedules=None, rounding_conventions=None, asset_backed=None, asset_pool_identifier=None, instrument_type=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param asset_pool_identifier:  Identifier used to retrieve pool factor information about this bond from the quote store. This is typically  the bond's ISIN, but can also be ClientInternal. Please ensure you align the MarketDataKeyRule with the  correct Quote (Quote.ClientInternal.* or Quote.Isin.*)
    ...
    def rounding_conventions(self):
        """Gets the rounding_conventions of this ComplexBondAllOf.  # noqa: E501

        Rounding conventions for analytics, if any.  # noqa: E501

        :return: The rounding_conventions of this ComplexBondAllOf.  # noqa: E501
    ...
    def rounding_conventions(self, rounding_conventions):
        """Sets the rounding_conventions of this ComplexBondAllOf.

        Rounding conventions for analytics, if any.  # noqa: E501

        :param rounding_conventions: The rounding_conventions of this ComplexBondAllOf.  # noqa: E501
        :type rounding_conventions: list[lusid.RoundingConvention]
        """
    ...
    def asset_backed(self):
        """Gets the asset_backed of this ComplexBondAllOf.  # noqa: E501

        If this flag is set to true, then the outstanding notional and principal repayments will be calculated based  on pool factors in the quote store. Usually AssetBacked bonds also require a RollConvention setting of   within the FlowConventions any given rates schedule (to ensure payment dates always happen on the same day  of the month) and US Agency MBSs with Pay Delay features also require their rates schedules to include an  ExDividendConfiguration to drive the lag between interest accrual and payment.  # noqa: E501

        :return: The asset_backed of this ComplexBondAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def asset_backed(self, asset_backed):
        """Sets the asset_backed of this ComplexBondAllOf.

        If this flag is set to true, then the outstanding notional and principal repayments will be calculated based  on pool factors in the quote store. Usually AssetBacked bonds also require a RollConvention setting of   within the FlowConventions any given rates schedule (to ensure payment dates always happen on the same day  of the month) and US Agency MBSs with Pay Delay features also require their rates schedules to include an  ExDividendConfiguration to drive the lag between interest accrual and payment.  # noqa: E501

        :param asset_backed: The asset_backed of this ComplexBondAllOf.  # noqa: E501
        :type asset_backed: bool
        """
    ...
    def asset_pool_identifier(self):
        """Gets the asset_pool_identifier of this ComplexBondAllOf.  # noqa: E501

        Identifier used to retrieve pool factor information about this bond from the quote store. This is typically  the bond's ISIN, but can also be ClientInternal. Please ensure you align the MarketDataKeyRule with the  correct Quote (Quote.ClientInternal.* or Quote.Isin.*)  # noqa: E501

        :return: The asset_pool_identifier of this ComplexBondAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def asset_pool_identifier(self, asset_pool_identifier):
        """Sets the asset_pool_identifier of this ComplexBondAllOf.

        Identifier used to retrieve pool factor information about this bond from the quote store. This is typically  the bond's ISIN, but can also be ClientInternal. Please ensure you align the MarketDataKeyRule with the  correct Quote (Quote.ClientInternal.* or Quote.Isin.*)  # noqa: E501

        :param asset_pool_identifier: The asset_pool_identifier of this ComplexBondAllOf.  # noqa: E501
        :type asset_pool_identifier: str
        """
        if (self.local_vars_configuration.client_side_validation and
