...
class ApplicableInstrumentEvent(object):
    ...
    def __init__(self, portfolio_id=None, holding_id=None, lusid_instrument_id=None, instrument_scope=None, instrument_type=None, instrument_event_type=None, instrument_event_id=None, generated_event=None, loaded_event=None, transactions=None, local_vars_configuration=None):  # noqa: E501
