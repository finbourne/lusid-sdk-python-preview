...
class InstrumentIdTypeDescriptor(object):
    ...
    openapi_types = {
        'id_name': 'str',
        'property_key_value': 'str',
        'is_unique_identifier': 'bool'
    }

    attribute_map = {
        'id_name': 'idName',
        'property_key_value': 'propertyKeyValue',
        'is_unique_identifier': 'isUniqueIdentifier'
    }

    def __init__(self, id_name=None, property_key_value=None, is_unique_identifier=None):  # noqa: E501
        """InstrumentIdTypeDescriptor - a model defined in OpenAPI"""  # noqa: E501

        self._id_name = None
        self._property_key_value = None
        self._is_unique_identifier = None
        self.discriminator = None

        self.id_name = id_name
        self.property_key_value = property_key_value
        self.is_unique_identifier = is_unique_identifier

    @property
    def id_name(self):
        """Gets the id_name of this InstrumentIdTypeDescriptor.  # noqa: E501

        The name of the identifier type  # noqa: E501

        :return: The id_name of this InstrumentIdTypeDescriptor.  # noqa: E501
        :rtype: str
        """
    ...
    def id_name(self, id_name):
        """Sets the id_name of this InstrumentIdTypeDescriptor.

        The name of the identifier type  # noqa: E501

        :param id_name: The id_name of this InstrumentIdTypeDescriptor.  # noqa: E501
        :type: str
        """
        if id_name is None:
            raise ValueError("Invalid value for `id_name`, must not be `None`")  # noqa: E501

        self._id_name = id_name

    @property
    def property_key_value(self):
        """Gets the property_key_value of this InstrumentIdTypeDescriptor.  # noqa: E501

        The property key that corresponds to this instrument identifier type  # noqa: E501

        :return: The property_key_value of this InstrumentIdTypeDescriptor.  # noqa: E501
        :rtype: str
        """
        return self._property_key_value

    @property_key_value.setter
    def property_key_value(self, property_key_value):
        """Sets the property_key_value of this InstrumentIdTypeDescriptor.

        The property key that corresponds to this instrument identifier type  # noqa: E501

        :param property_key_value: The property_key_value of this InstrumentIdTypeDescriptor.  # noqa: E501
        :type: str
        """
        if property_key_value is None:
            raise ValueError("Invalid value for `property_key_value`, must not be `None`")  # noqa: E501

        self._property_key_value = property_key_value

    @property
    def is_unique_identifier(self):
        """Gets the is_unique_identifier of this InstrumentIdTypeDescriptor.  # noqa: E501

        The cardinality of the identifier type (i.e., how many instruments may share an identifer  of this identifier type)  # noqa: E501

        :return: The is_unique_identifier of this InstrumentIdTypeDescriptor.  # noqa: E501
        :rtype: bool
        """
        return self._is_unique_identifier

    @is_unique_identifier.setter
    def is_unique_identifier(self, is_unique_identifier):
        """Sets the is_unique_identifier of this InstrumentIdTypeDescriptor.

        The cardinality of the identifier type (i.e., how many instruments may share an identifer  of this identifier type)  # noqa: E501

        :param is_unique_identifier: The is_unique_identifier of this InstrumentIdTypeDescriptor.  # noqa: E501
        :type: bool
        """
        if is_unique_identifier is None:
            raise ValueError("Invalid value for `is_unique_identifier`, must not be `None`")  # noqa: E501

        self._is_unique_identifier = is_unique_identifier
