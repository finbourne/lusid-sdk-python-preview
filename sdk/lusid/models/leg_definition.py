...
class LegDefinition(object):
    ...
    def __init__(self, rate_or_spread=None, index_convention=None, stub_type=None, pay_receive=None, notional_exchange_type=None, conventions=None):  # noqa: E501
        ...
        :param stub_type:  If a stub is required should it be at the front or back of the leg. (required)
        :type stub_type: str
        :param pay_receive:  Is the leg to be paid or received (required)
        :type pay_receive: str
        :param notional_exchange_type:  what type of notional exchange does the leg have (required)
    ...
    def stub_type(self):
        ...
        If a stub is required should it be at the front or back of the leg.  # noqa: E501
    ...
    def pay_receive(self):
        ...
        Is the leg to be paid or received  # noqa: E501
    ...
    def notional_exchange_type(self):
        ...
        what type of notional exchange does the leg have  # noqa: E501
