...
class LegDefinition(object):
    ...
    def __init__(self, convention_name=None, conventions=None, index_convention=None, index_convention_name=None, notional_exchange_type=None, pay_receive=None, rate_or_spread=None, reset_convention=None, stub_type=None):  # noqa: E501
        ...
        :param reset_convention:  Control how resets are generated relative to swap payment convention(s).  Supported string (enumeration) values are: [InAdvance, InArrears]. (required)
    ...
    def convention_name(self, convention_name):
        ...
        if convention_name is None:
            raise ValueError("Invalid value for `convention_name`, must not be `None`")  # noqa: E501
    ...
    def index_convention(self, index_convention):
        ...
        if index_convention is None:
            raise ValueError("Invalid value for `index_convention`, must not be `None`")  # noqa: E501
    ...
    def index_convention_name(self, index_convention_name):
        ...
        :type: FlowConventionName
        """
        if index_convention_name is None:
    ...
    def reset_convention(self, reset_convention):
        ...
        :type: str
        """
        if reset_convention is None:
            raise ValueError("Invalid value for `reset_convention`, must not be `None`")  # noqa: E501
