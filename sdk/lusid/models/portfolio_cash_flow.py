...
class PortfolioCashFlow(object):
    ...
    openapi_types = {
        'sequence_number': 'int',
        'sub_holdings': 'dict(str, PerpetualProperty)',
        'type': 'str',
        'movement_name': 'str',
    ...
    def __init__(self, sequence_number=None, sub_holdings=None, type=None, movement_name=None, cashflow=None, balance=None, fx_rate=None, cashflow_reporting_currency=None, balance_reporting_currency=None, translation_gain_loss=None, cost_basis_reporting_currency=None, transaction=None):  # noqa: E501
        """
        PortfolioCashFlow - a model defined in OpenAPI

        :param sequence_number:  (required)
        :type sequence_number: int
        :param sub_holdings: 
        :type sub_holdings: dict[str, lusid.PerpetualProperty]
        :param type:  (required)
        :type type: str
        :param movement_name:  (required)
        ...
        self.sub_holdings = sub_holdings
        self.type = type
    ...
    @property
    def sub_holdings(self):
        """Gets the sub_holdings of this PortfolioCashFlow.  # noqa: E501


        :return: The sub_holdings of this PortfolioCashFlow.  # noqa: E501
        :rtype: dict(str, PerpetualProperty)
        """
        return self._sub_holdings

    @sub_holdings.setter
    def sub_holdings(self, sub_holdings):
        """Sets the sub_holdings of this PortfolioCashFlow.


        :param sub_holdings: The sub_holdings of this PortfolioCashFlow.  # noqa: E501
        :type: dict(str, PerpetualProperty)
        """

        self._sub_holdings = sub_holdings
