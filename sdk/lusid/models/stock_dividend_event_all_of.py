...
class StockDividendEventAllOf(object):
    ...
    def __init__(self, announcement_date=None, ex_date=None, payment_date=None, record_date=None, fractional_units_cash_price=None, fractional_units_cash_currency=None, units_ratio=None, instrument_event_type=None, local_vars_configuration=None):  # noqa: E501
        """StockDividendEventAllOf - a model defined in OpenAPI"
    ...
    def announcement_date(self):
        """Gets the announcement_date of this StockDividendEventAllOf.  # noqa: E501

        Date on which the dividend was announced / declared.  # noqa: E501

        :return: The announcement_date of this StockDividendEventAllOf.  # noqa: E501
        :rtype: datetime
        """
    ...
    def announcement_date(self, announcement_date):
        """Sets the announcement_date of this StockDividendEventAllOf.

        Date on which the dividend was announced / declared.  # noqa: E501

        :param announcement_date: The announcement_date of this StockDividendEventAllOf.  # noqa: E501
        :type announcement_date: datetime
        """
    ...
    @property
    def ex_date(self):
        """Gets the ex_date of this StockDividendEventAllOf.  # noqa: E501
        ...
        :return: The ex_date of this StockDividendEventAllOf.  # noqa: E501
        :rtype: datetime
        """
    ...
    def ex_date(self, ex_date):
        """Sets the ex_date of this StockDividendEventAllOf.

        The first business day on which the dividend is not owed to the buying party.  Typically this is T-1 from the RecordDate.  # noqa: E501

        :param ex_date: The ex_date of this StockDividendEventAllOf.  # noqa: E501
        :type ex_date: datetime
        """
    ...
    def payment_date(self):
        """Gets the payment_date of this StockDividendEventAllOf.  # noqa: E501

        The date the company pays out dividends to shareholders.  # noqa: E501

        :return: The payment_date of this StockDividendEventAllOf.  # noqa: E501
        :rtype: datetime
        """
    ...
    def payment_date(self, payment_date):
        """Sets the payment_date of this StockDividendEventAllOf.

        The date the company pays out dividends to shareholders.  # noqa: E501

        :param payment_date: The payment_date of this StockDividendEventAllOf.  # noqa: E501
        :type payment_date: datetime
        """
    ...
    def record_date(self):
        """Gets the record_date of this StockDividendEventAllOf.  # noqa: E501

        Date you have to be the holder of record in order to participate in the tender.  # noqa: E501

        :return: The record_date of this StockDividendEventAllOf.  # noqa: E501
        :rtype: datetime
        """
    ...
    def record_date(self, record_date):
        """Sets the record_date of this StockDividendEventAllOf.

        Date you have to be the holder of record in order to participate in the tender.  # noqa: E501

        :param record_date: The record_date of this StockDividendEventAllOf.  # noqa: E501
        :type record_date: datetime
        """
    ...
    def fractional_units_cash_price(self):
        """Gets the fractional_units_cash_price of this StockDividendEventAllOf.  # noqa: E501

        The cash price paid in lieu of fractionalUnits.  # noqa: E501

        :return: The fractional_units_cash_price of this StockDividendEventAllOf.  # noqa: E501
        :rtype: float
        """
    ...
    def fractional_units_cash_price(self, fractional_units_cash_price):
        """Sets the fractional_units_cash_price of this StockDividendEventAllOf.

        The cash price paid in lieu of fractionalUnits.  # noqa: E501

        :param fractional_units_cash_price: The fractional_units_cash_price of this StockDividendEventAllOf.  # noqa: E501
        :type fractional_units_cash_price: float
        """
    ...
    def fractional_units_cash_currency(self):
        """Gets the fractional_units_cash_currency of this StockDividendEventAllOf.  # noqa: E501

        The currency of the cash paid in lieu of fractionalUnits.  # noqa: E501

        :return: The fractional_units_cash_currency of this StockDividendEventAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def fractional_units_cash_currency(self, fractional_units_cash_currency):
        """Sets the fractional_units_cash_currency of this StockDividendEventAllOf.

        The currency of the cash paid in lieu of fractionalUnits.  # noqa: E501

        :param fractional_units_cash_currency: The fractional_units_cash_currency of this StockDividendEventAllOf.  # noqa: E501
        :type fractional_units_cash_currency: str
        """
    ...
    def units_ratio(self):
        """Gets the units_ratio of this StockDividendEventAllOf.  # noqa: E501


        :return: The units_ratio of this StockDividendEventAllOf.  # noqa: E501
    ...
    def units_ratio(self, units_ratio):
        """Sets the units_ratio of this StockDividendEventAllOf.


        :param units_ratio: The units_ratio of this StockDividendEventAllOf.  # noqa: E501
        :type units_ratio: lusid.UnitsRatio
        """
    ...
    def instrument_event_type(self):
        """Gets the instrument_event_type of this StockDividendEventAllOf.  # noqa: E501

        The Type of Event. The available values are: TransitionEvent, InformationalEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent, AmortisationEvent, CashFlowEvent, ExerciseEvent, ResetEvent, TriggerEvent, RawVendorEvent, InformationalErrorEvent, BondCouponEvent, DividendReinvestmentEvent, AccumulationEvent, BondPrincipalEvent, DividendOptionEvent, MaturityEvent, FxForwardSettlementEvent, ExpiryEvent, ScripDividendEvent, StockDividendEvent, ReverseStockSplitEvent, CapitalDistributionEvent, SpinOffEvent, MergerEvent, FutureExpiryEvent, SwapCashFlowEvent, SwapPrincipalEvent, CreditPremiumCashFlowEvent, CdsCreditEvent, CdxCreditEvent, MbsCouponEvent, MbsPrincipalEvent, BonusIssueEvent, MbsPrincipalWriteOffEvent, MbsInterestDeferralEvent, MbsInterestShortfallEvent, TenderEvent, CallOnIntermediateSecuritiesEvent, IntermediateSecuritiesDistributionEvent  # noqa: E501

        :return: The instrument_event_type of this StockDividendEventAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def instrument_event_type(self, instrument_event_type):
        """Sets the instrument_event_type of this StockDividendEventAllOf.

        The Type of Event. The available values are: TransitionEvent, InformationalEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent, AmortisationEvent, CashFlowEvent, ExerciseEvent, ResetEvent, TriggerEvent, RawVendorEvent, InformationalErrorEvent, BondCouponEvent, DividendReinvestmentEvent, AccumulationEvent, BondPrincipalEvent, DividendOptionEvent, MaturityEvent, FxForwardSettlementEvent, ExpiryEvent, ScripDividendEvent, StockDividendEvent, ReverseStockSplitEvent, CapitalDistributionEvent, SpinOffEvent, MergerEvent, FutureExpiryEvent, SwapCashFlowEvent, SwapPrincipalEvent, CreditPremiumCashFlowEvent, CdsCreditEvent, CdxCreditEvent, MbsCouponEvent, MbsPrincipalEvent, BonusIssueEvent, MbsPrincipalWriteOffEvent, MbsInterestDeferralEvent, MbsInterestShortfallEvent, TenderEvent, CallOnIntermediateSecuritiesEvent, IntermediateSecuritiesDistributionEvent  # noqa: E501

        :param instrument_event_type: The instrument_event_type of this StockDividendEventAllOf.  # noqa: E501
        :type instrument_event_type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StockDividendEventAllOf):
            return False
