...
class FieldSchema(object):
    ...
    def __init__(self, id=None, display_name=None, description=None, type=None, display_order=None):  # noqa: E501
        ...
        :param type:  The available values are: String, Int, Decimal, DateTime, Boolean, Map, List, PropertyArray, Percentage, Code, Id, Uri, Currency, MetricValue, ResourceId, ResultValue, CutLocalTime, DateOrCutLabel
        :type type: str
        :param display_order: 
