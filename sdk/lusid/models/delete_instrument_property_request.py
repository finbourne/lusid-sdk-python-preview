...
class DeleteInstrumentPropertyRequest(object):
    ...
    def instrument_property_key(self):
        ...
        The property key of the property to be removed from the instrument, e.g 'Instrument/default/Cusip`  # noqa: E501
    ...
    def effective_from(self):
        ...
        The date at which the property removal should be effective from. If no value is set, then 'now' is used.  # noqa: E501
