...
class DeleteInstrumentPropertyRequest(object):
    ...
    """
    openapi_types = {
        'instrument_property_key': 'str',
        'effective_from': 'datetime'
    }

    attribute_map = {
        'instrument_property_key': 'instrumentPropertyKey',
        'effective_from': 'effectiveFrom'
    }

    def __init__(self, instrument_property_key=None, effective_from=None):  # noqa: E501
        """DeleteInstrumentPropertyRequest - a model defined in OpenAPI"""  # noqa: E501

        self._instrument_property_key = None
        self._effective_from = None
        self.discriminator = None

        if instrument_property_key is not None:
            self.instrument_property_key = instrument_property_key
        if effective_from is not None:
            self.effective_from = effective_from

    @property
    def instrument_property_key(self):
        """Gets the instrument_property_key of this DeleteInstrumentPropertyRequest.  # noqa: E501

        The key of the property to be removed from the instrument. This takes the format {domain}/{scope}/{code} e.g. 'Instrument/CreditScope/CreditRating'.  # noqa: E501

        :return: The instrument_property_key of this DeleteInstrumentPropertyRequest.  # noqa: E501
        :rtype: str
        """
        return self._instrument_property_key

    @instrument_property_key.setter
    def instrument_property_key(self, instrument_property_key):
        """Sets the instrument_property_key of this DeleteInstrumentPropertyRequest.

        The key of the property to be removed from the instrument. This takes the format {domain}/{scope}/{code} e.g. 'Instrument/CreditScope/CreditRating'.  # noqa: E501

        :param instrument_property_key: The instrument_property_key of this DeleteInstrumentPropertyRequest.  # noqa: E501
        :type: str
        """

        self._instrument_property_key = instrument_property_key

    @property
    def effective_from(self):
        """Gets the effective_from of this DeleteInstrumentPropertyRequest.  # noqa: E501

        The effective datetime from which the property should be removed. Defaults to the current LUSID system datetime if not specified.  # noqa: E501

        :return: The effective_from of this DeleteInstrumentPropertyRequest.  # noqa: E501
        :rtype: datetime
        """
    ...
    def effective_from(self, effective_from):
        """Sets the effective_from of this DeleteInstrumentPropertyRequest.

        The effective datetime from which the property should be removed. Defaults to the current LUSID system datetime if not specified.  # noqa: E501

        :param effective_from: The effective_from of this DeleteInstrumentPropertyRequest.  # noqa: E501
        :type: datetime
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteInstrumentPropertyRequest):
            return False
