...
class CustomEntityType(object):
    ...
    def __init__(self, href=None, entity_type_name=None, display_name=None, description=None, entity_type=None, field_schema=None, version=None, links=None, local_vars_configuration=None):  # noqa: E501
