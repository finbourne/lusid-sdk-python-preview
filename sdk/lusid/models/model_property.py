...
class ModelProperty(object):
    ...
    def __init__(self, key=None, value=None, effective_from=None, effective_until=None):  # noqa: E501
        ...
        :param effective_until:  The effective datetime until which the property is valid. If not supplied this will be valid indefinitely, potentially overwriting values with EffectiveFrom's in the future.
    ...
    def effective_until(self):
        ...
        The effective datetime until which the property is valid. If not supplied this will be valid indefinitely, potentially overwriting values with EffectiveFrom's in the future.  # noqa: E501
