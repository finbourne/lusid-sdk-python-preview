...
class PricingModel(object):
    ...
    allowable_values = [SIMPLESTATIC, DISCOUNTING, VENDORDEFAULT, BLACKSCHOLES, CONSTANTTIMEVALUEOFMONEY, BACHELIER, FORWARDWITHPOINTS, FORWARDWITHPOINTSUNDISCOUNTED]  # noqa: E501
