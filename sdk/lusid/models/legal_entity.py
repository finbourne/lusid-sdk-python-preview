...
class LegalEntity(object):
    ...
    def __init__(self, href=None, lusid_legal_entity_id=None, identifiers=None, properties=None, version=None, links=None):  # noqa: E501
        """
        LegalEntity - a model defined in OpenAPI

        :param href:  The specific Uniform Resource Identifier (URI) for this resource at the requested effective and asAt datetime.
        :type href: str
        :param lusid_legal_entity_id:  The unique LUSID Legal Entity Identifier (LULEID) of the Legal Entity.
    ...
    def lusid_legal_entity_id(self):
        ...
        The unique LUSID Legal Entity Identifier (LULEID) of the Legal Entity.  # noqa: E501
