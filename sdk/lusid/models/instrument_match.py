...
class InstrumentMatch(object):
    ...
    def __init__(self, mastered_instruments=None, external_instruments=None):  # noqa: E501
        """InstrumentMatch - a model defined in OpenAPI"""  # noqa: E501

        self._mastered_instruments = None
        self._external_instruments = None
        self.discriminator = None

        if mastered_instruments is not None:
    ...
    def mastered_instruments(self):
        ...
        A collection of instruments that have met some criteria that have been previously  mastered within LUSID  # noqa: E501
    ...
    def external_instruments(self):
        ...
        A collection of instruments that have met some criteria, but that have not been  mastered within LUSID.  # noqa: E501
