...
class FeeRequest(object):
    ...
    def __init__(self, code=None, fee_type_id=None, display_name=None, description=None, origin=None, calculation_base=None, accrual_currency=None, treatment=None, total_annual_accrual_amount=None, fee_rate_percentage=None, payable_frequency=None, business_day_convention=None, start_date=None, end_date=None, anchor_date=None, properties=None, portfolio_id=None, share_classes=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param business_day_convention:  The business day convention to use for Fee calculations on weekends or holidays. Supported string values are: [Previous, P, Following, F, None]. (required)
        ...
        :param share_classes:  The short codes of the ShareClasses that the Fee should be applied to. Optional: if this is null or empty, then the Fee will be divided between all the ShareClasses of the Fund according to the capital ratio.
        :type share_classes: list[str]
    ...
    @property
    def code(self):
        """Gets the code of this FeeRequest.  # noqa: E501

        The code of the Fee.  # noqa: E501

        :return: The code of this FeeRequest.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this FeeRequest.

        The code of the Fee.  # noqa: E501

        :param code: The code of this FeeRequest.  # noqa: E501
        :type code: str
        """
    ...
    def business_day_convention(self):
        ...
        The business day convention to use for Fee calculations on weekends or holidays. Supported string values are: [Previous, P, Following, F, None].  # noqa: E501
    ...
    def share_classes(self):
        """Gets the share_classes of this FeeRequest.  # noqa: E501

        The short codes of the ShareClasses that the Fee should be applied to. Optional: if this is null or empty, then the Fee will be divided between all the ShareClasses of the Fund according to the capital ratio.  # noqa: E501

        :return: The share_classes of this FeeRequest.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def share_classes(self, share_classes):
        """Sets the share_classes of this FeeRequest.

        The short codes of the ShareClasses that the Fee should be applied to. Optional: if this is null or empty, then the Fee will be divided between all the ShareClasses of the Fund according to the capital ratio.  # noqa: E501

        :param share_classes: The share_classes of this FeeRequest.  # noqa: E501
        :type share_classes: list[str]
        """
