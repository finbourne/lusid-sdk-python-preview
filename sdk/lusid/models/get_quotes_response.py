...
class GetQuotesResponse(object):
    ...
    def values(self):
        ...
        The collection of requested quote series with their latest values  # noqa: E501
    ...
    def not_found(self):
        ...
        If any quotes could not be retrieved, they will be listed in 'NotFound', along  with a reason why.  # noqa: E501
    ...
    def failed(self):
        ...
        If any quotes could not be requested, due to errors in the structure of the   QuoteSeriesId, they will be listed in 'Failed', along with the reason(s) why.  # noqa: E501
