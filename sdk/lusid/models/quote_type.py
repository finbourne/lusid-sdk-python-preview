...
class QuoteType(object):
    ...
    allowable_values = [PRICE, SPREAD, RATE, LOGNORMALVOL, NORMALVOL, PARSPREAD, ISDASPREAD, UPFRONT, INDEX, RATIO, DELTA, POOLFACTOR, INFLATIONASSUMPTION, DIRTYPRICE]  # noqa: E501
