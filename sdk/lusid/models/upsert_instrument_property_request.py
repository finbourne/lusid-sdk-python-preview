...
class UpsertInstrumentPropertyRequest(object):
    ...
    def lusid_instrument_id(self):
        ...
        The unique Lusid Instrument Identifier (LUID) of the instrument to update or insert properties on.  # noqa: E501
    ...
    def deleted_properties(self):
        ...
        Set of unique instrument properties to delete from the instrument.  # noqa: E501
