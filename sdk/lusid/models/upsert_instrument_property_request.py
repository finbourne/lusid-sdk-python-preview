...
class UpsertInstrumentPropertyRequest(object):
    ...
    openapi_types = {
        ...
        'properties': 'list[InstrumentProperty]',
        'deleted_properties': 'list[DeleteInstrumentPropertyRequest]'
    }
    ...
    def __init__(self, lusid_instrument_id=None, properties=None, deleted_properties=None):  # noqa: E501
        """UpsertInstrumentPropertyRequest - a model defined in OpenAPI"""  # noqa: E501

        self._lusid_instrument_id = None
        self._properties = None
        self._deleted_properties = None
        ...
        if deleted_properties is not None:
            self.deleted_properties = deleted_properties

    @property
    def lusid_instrument_id(self):
        """Gets the lusid_instrument_id of this UpsertInstrumentPropertyRequest.  # noqa: E501

        Unique instrument identifier  # noqa: E501

        :return: The lusid_instrument_id of this UpsertInstrumentPropertyRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def lusid_instrument_id(self, lusid_instrument_id):
        """Sets the lusid_instrument_id of this UpsertInstrumentPropertyRequest.

        Unique instrument identifier  # noqa: E501

        :param lusid_instrument_id: The lusid_instrument_id of this UpsertInstrumentPropertyRequest.  # noqa: E501
        :type: str
        """
    ...
    def properties(self):
        ...
        A collection of properties to create or update  # noqa: E501

        :return: The properties of this UpsertInstrumentPropertyRequest.  # noqa: E501
        :rtype: list[InstrumentProperty]
        """
    ...
    def deleted_properties(self):
        """Gets the deleted_properties of this UpsertInstrumentPropertyRequest.  # noqa: E501

        A collection of property keys to remove property values from, if any are set for the instrument  # noqa: E501

        :return: The deleted_properties of this UpsertInstrumentPropertyRequest.  # noqa: E501
        :rtype: list[DeleteInstrumentPropertyRequest]
        """
        return self._deleted_properties

    @deleted_properties.setter
    def deleted_properties(self, deleted_properties):
        """Sets the deleted_properties of this UpsertInstrumentPropertyRequest.

        A collection of property keys to remove property values from, if any are set for the instrument  # noqa: E501

        :param deleted_properties: The deleted_properties of this UpsertInstrumentPropertyRequest.  # noqa: E501
        :type: list[DeleteInstrumentPropertyRequest]
        """

        self._deleted_properties = deleted_properties
