...
class Person(object):
    ...
    def __init__(self, display_name=None, description=None, href=None, lusid_person_id=None, identifiers=None, properties=None, relationships=None, version=None, links=None, local_vars_configuration=None):  # noqa: E501
