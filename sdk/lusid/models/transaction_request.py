...
class TransactionRequest(object):
    ...
    def transaction_group_id(self):
        """Gets the transaction_group_id of this TransactionRequest.  # noqa: E501

        The identifier for grouping economic events across multiple transactions  # noqa: E501

        :return: The transaction_group_id of this TransactionRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def transaction_group_id(self, transaction_group_id):
        """Sets the transaction_group_id of this TransactionRequest.

        The identifier for grouping economic events across multiple transactions  # noqa: E501

        :param transaction_group_id: The transaction_group_id of this TransactionRequest.  # noqa: E501
        :type transaction_group_id: str
        """
        if (self.local_vars_configuration.client_side_validation and
                transaction_group_id is not None and len(transaction_group_id) > 64):
            raise ValueError("Invalid value for `transaction_group_id`, length must be less than or equal to `64`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                transaction_group_id is not None and len(transaction_group_id) < 1):
            raise ValueError("Invalid value for `transaction_group_id`, length must be greater than or equal to `1`")  # noqa: E501
