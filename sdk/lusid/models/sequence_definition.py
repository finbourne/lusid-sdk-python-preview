...
class SequenceDefinition(object):
    ...
    def __init__(self, id=None, increment=None, min_value=None, max_value=None, start=None, value=None, cycle=None, links=None, local_vars_configuration=None):  # noqa: E501
        """SequenceDefinition - a model defined in OpenAPI"
        
        :param id:  (required)
        :type id: lusid.ResourceId
        :param increment:  Size of the increment (required)
        :type increment: int
        :param min_value:  Minimum value (required)
        :type min_value: int
        :param max_value:  Maximum value (required)
        :type max_value: int
        :param start:  Start value (required)
        :type start: int
        :param value:  Current value of the sequence (required)
        :type value: int
        :param cycle:  Indicate whether the sequence will cycle (required)
        :type cycle: bool
    ...
    def increment(self):
        ...
        Size of the increment  # noqa: E501
    ...
    def value(self):
        ...
        Current value of the sequence  # noqa: E501
    ...
    def cycle(self):
        ...
        Indicate whether the sequence will cycle  # noqa: E501
