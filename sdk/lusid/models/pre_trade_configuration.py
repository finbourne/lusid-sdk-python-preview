...
class PreTradeConfiguration(object):
    ...
    def __init__(self, include_entity_types=None, local_vars_configuration=None):  # noqa: E501
        """PreTradeConfiguration - a model defined in OpenAPI"
        
        :param include_entity_types:  Controls whether Orders and Allocations orders are included in the Portfolio valuation done for this compliance run.  Valid values are:  None (to account for Transactions only), Allocations (to include Allocations and Transactions) and  OrdersAndAllocations (to include Orders, Allocations and Transactions). (required)
    ...
    def include_entity_types(self):
        """Gets the include_entity_types of this PreTradeConfiguration.  # noqa: E501

        Controls whether Orders and Allocations orders are included in the Portfolio valuation done for this compliance run.  Valid values are:  None (to account for Transactions only), Allocations (to include Allocations and Transactions) and  OrdersAndAllocations (to include Orders, Allocations and Transactions).  # noqa: E501

        :return: The include_entity_types of this PreTradeConfiguration.  # noqa: E501
        :rtype: str
        """
    ...
    def include_entity_types(self, include_entity_types):
        """Sets the include_entity_types of this PreTradeConfiguration.

        Controls whether Orders and Allocations orders are included in the Portfolio valuation done for this compliance run.  Valid values are:  None (to account for Transactions only), Allocations (to include Allocations and Transactions) and  OrdersAndAllocations (to include Orders, Allocations and Transactions).  # noqa: E501

        :param include_entity_types: The include_entity_types of this PreTradeConfiguration.  # noqa: E501
        :type include_entity_types: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PreTradeConfiguration):
            return False
