...
class PostingModuleResponse(object):
    ...
    def __init__(self, href=None, posting_module_code=None, chart_of_accounts_id=None, display_name=None, description=None, rule_count=None, status=None, version=None, links=None, local_vars_configuration=None):  # noqa: E501
