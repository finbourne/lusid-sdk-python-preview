...
class QueryTradeTicketsRequest(object):
    ...
    def __init__(self, as_at=None, window_start=None, window_end=None, portfolio_entity_ids=None, recipe_id=None, effective_at=None, local_vars_configuration=None):  # noqa: E501
        """QueryTradeTicketsRequest - a model defined in OpenAPI"
        
        :param as_at:  The time of the system at which to query for tradetickets.
        :type as_at: datetime
        ...
        :param effective_at:  The Effective date used in the valuation of the tradetickets. (required)
    ...
    @property
    def as_at(self):
        """Gets the as_at of this QueryTradeTicketsRequest.  # noqa: E501

        The time of the system at which to query for tradetickets.  # noqa: E501

        :return: The as_at of this QueryTradeTicketsRequest.  # noqa: E501
        :rtype: datetime
        """
        return self._as_at
    ...
    def as_at(self, as_at):
        """Sets the as_at of this QueryTradeTicketsRequest.

        The time of the system at which to query for tradetickets.  # noqa: E501

        :param as_at: The as_at of this QueryTradeTicketsRequest.  # noqa: E501
        :type as_at: datetime
        """
    ...
    def window_start(self):
        """Gets the window_start of this QueryTradeTicketsRequest.  # noqa: E501

        The start date of the window.  # noqa: E501

        :return: The window_start of this QueryTradeTicketsRequest.  # noqa: E501
        :rtype: datetime
        """
    ...
    def window_start(self, window_start):
        """Sets the window_start of this QueryTradeTicketsRequest.

        The start date of the window.  # noqa: E501

        :param window_start: The window_start of this QueryTradeTicketsRequest.  # noqa: E501
        :type window_start: datetime
        """
    ...
    @property
    def window_end(self):
        """Gets the window_end of this QueryTradeTicketsRequest.  # noqa: E501

        The end date of the window.  # noqa: E501

        :return: The window_end of this QueryTradeTicketsRequest.  # noqa: E501
        :rtype: datetime
        """
    ...
    def window_end(self, window_end):
        """Sets the window_end of this QueryTradeTicketsRequest.

        The end date of the window.  # noqa: E501

        :param window_end: The window_end of this QueryTradeTicketsRequest.  # noqa: E501
        :type window_end: datetime
        """
    ...
    def portfolio_entity_ids(self):
        """Gets the portfolio_entity_ids of this QueryTradeTicketsRequest.  # noqa: E501

        The set of portfolios and portfolio groups to which the instrument events must belong.  # noqa: E501

        :return: The portfolio_entity_ids of this QueryTradeTicketsRequest.  # noqa: E501
    ...
    def portfolio_entity_ids(self, portfolio_entity_ids):
        """Sets the portfolio_entity_ids of this QueryTradeTicketsRequest.

        The set of portfolios and portfolio groups to which the instrument events must belong.  # noqa: E501

        :param portfolio_entity_ids: The portfolio_entity_ids of this QueryTradeTicketsRequest.  # noqa: E501
        :type portfolio_entity_ids: list[lusid.PortfolioEntityId]
        """
    ...
    @property
    def recipe_id(self):
        """Gets the recipe_id of this QueryTradeTicketsRequest.  # noqa: E501


        :return: The recipe_id of this QueryTradeTicketsRequest.  # noqa: E501
    ...
    def recipe_id(self, recipe_id):
        """Sets the recipe_id of this QueryTradeTicketsRequest.


        :param recipe_id: The recipe_id of this QueryTradeTicketsRequest.  # noqa: E501
        :type recipe_id: lusid.ResourceId
        """
    ...
    def effective_at(self):
        """Gets the effective_at of this QueryTradeTicketsRequest.  # noqa: E501

        The Effective date used in the valuation of the tradetickets.  # noqa: E501

        :return: The effective_at of this QueryTradeTicketsRequest.  # noqa: E501
        :rtype: datetime
        """
    ...
    def effective_at(self, effective_at):
        """Sets the effective_at of this QueryTradeTicketsRequest.

        The Effective date used in the valuation of the tradetickets.  # noqa: E501

        :param effective_at: The effective_at of this QueryTradeTicketsRequest.  # noqa: E501
        :type effective_at: datetime
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, QueryTradeTicketsRequest):
            return False
