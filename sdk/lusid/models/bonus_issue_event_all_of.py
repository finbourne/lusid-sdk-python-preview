...
class BonusIssueEventAllOf(object):
    ...
    def __init__(self, announcement_date=None, ex_date=None, record_date=None, payment_date=None, fractional_units_cash_price=None, fractional_units_cash_currency=None, security_offer_elections=None, cash_offer_elections=None, lapse_elections=None, instrument_event_type=None, local_vars_configuration=None):  # noqa: E501
        """BonusIssueEventAllOf - a model defined in OpenAPI"
    ...
    def announcement_date(self):
        """Gets the announcement_date of this BonusIssueEventAllOf.  # noqa: E501

        The date the Bonus Issue is announced.  # noqa: E501

        :return: The announcement_date of this BonusIssueEventAllOf.  # noqa: E501
        :rtype: datetime
        """
    ...
    def announcement_date(self, announcement_date):
        """Sets the announcement_date of this BonusIssueEventAllOf.

        The date the Bonus Issue is announced.  # noqa: E501

        :param announcement_date: The announcement_date of this BonusIssueEventAllOf.  # noqa: E501
        :type announcement_date: datetime
        """
    ...
    @property
    def ex_date(self):
        """Gets the ex_date of this BonusIssueEventAllOf.  # noqa: E501

        The ex-date of the Bonus Issue.  # noqa: E501

        :return: The ex_date of this BonusIssueEventAllOf.  # noqa: E501
        :rtype: datetime
        """
    ...
    def ex_date(self, ex_date):
        """Sets the ex_date of this BonusIssueEventAllOf.

        The ex-date of the Bonus Issue.  # noqa: E501

        :param ex_date: The ex_date of this BonusIssueEventAllOf.  # noqa: E501
        :type ex_date: datetime
        """
    ...
    def record_date(self):
        """Gets the record_date of this BonusIssueEventAllOf.  # noqa: E501

        The record date of the Bonus Issue.  # noqa: E501

        :return: The record_date of this BonusIssueEventAllOf.  # noqa: E501
        :rtype: datetime
        """
    ...
    def record_date(self, record_date):
        """Sets the record_date of this BonusIssueEventAllOf.

        The record date of the Bonus Issue.  # noqa: E501

        :param record_date: The record_date of this BonusIssueEventAllOf.  # noqa: E501
        :type record_date: datetime
        """
    ...
    def payment_date(self):
        """Gets the payment_date of this BonusIssueEventAllOf.  # noqa: E501

        The date the Bonus Issue is executed.  # noqa: E501

        :return: The payment_date of this BonusIssueEventAllOf.  # noqa: E501
        :rtype: datetime
        """
    ...
    def payment_date(self, payment_date):
        """Sets the payment_date of this BonusIssueEventAllOf.

        The date the Bonus Issue is executed.  # noqa: E501

        :param payment_date: The payment_date of this BonusIssueEventAllOf.  # noqa: E501
        :type payment_date: datetime
        """
    ...
    def fractional_units_cash_price(self):
        """Gets the fractional_units_cash_price of this BonusIssueEventAllOf.  # noqa: E501

        Optional. Used in calculating cash-in-lieu of fractional shares.  # noqa: E501

        :return: The fractional_units_cash_price of this BonusIssueEventAllOf.  # noqa: E501
        :rtype: float
        """
    ...
    def fractional_units_cash_price(self, fractional_units_cash_price):
        """Sets the fractional_units_cash_price of this BonusIssueEventAllOf.

        Optional. Used in calculating cash-in-lieu of fractional shares.  # noqa: E501

        :param fractional_units_cash_price: The fractional_units_cash_price of this BonusIssueEventAllOf.  # noqa: E501
        :type fractional_units_cash_price: float
        """
    ...
    def fractional_units_cash_currency(self):
        """Gets the fractional_units_cash_currency of this BonusIssueEventAllOf.  # noqa: E501

        Optional. Used in calculating cash-in-lieu of fractional shares.  # noqa: E501

        :return: The fractional_units_cash_currency of this BonusIssueEventAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def fractional_units_cash_currency(self, fractional_units_cash_currency):
        """Sets the fractional_units_cash_currency of this BonusIssueEventAllOf.

        Optional. Used in calculating cash-in-lieu of fractional shares.  # noqa: E501

        :param fractional_units_cash_currency: The fractional_units_cash_currency of this BonusIssueEventAllOf.  # noqa: E501
        :type fractional_units_cash_currency: str
        """
    ...
    def security_offer_elections(self):
        """Gets the security_offer_elections of this BonusIssueEventAllOf.  # noqa: E501

        Possible SecurityElections for this Bonus Issue event, if any.  # noqa: E501

        :return: The security_offer_elections of this BonusIssueEventAllOf.  # noqa: E501
    ...
    def security_offer_elections(self, security_offer_elections):
        """Sets the security_offer_elections of this BonusIssueEventAllOf.

        Possible SecurityElections for this Bonus Issue event, if any.  # noqa: E501

        :param security_offer_elections: The security_offer_elections of this BonusIssueEventAllOf.  # noqa: E501
        :type security_offer_elections: list[lusid.SecurityOfferElection]
        """
    ...
    def cash_offer_elections(self):
        """Gets the cash_offer_elections of this BonusIssueEventAllOf.  # noqa: E501

        Possible CashOfferElections for this Bonus Issue event, if any.  # noqa: E501

        :return: The cash_offer_elections of this BonusIssueEventAllOf.  # noqa: E501
    ...
    def cash_offer_elections(self, cash_offer_elections):
        """Sets the cash_offer_elections of this BonusIssueEventAllOf.

        Possible CashOfferElections for this Bonus Issue event, if any.  # noqa: E501

        :param cash_offer_elections: The cash_offer_elections of this BonusIssueEventAllOf.  # noqa: E501
        :type cash_offer_elections: list[lusid.CashOfferElection]
        """
    ...
    def lapse_elections(self):
        """Gets the lapse_elections of this BonusIssueEventAllOf.  # noqa: E501

        Possible LapseElections for this Bonus Issue event, if any.  # noqa: E501

        :return: The lapse_elections of this BonusIssueEventAllOf.  # noqa: E501
    ...
    def lapse_elections(self, lapse_elections):
        """Sets the lapse_elections of this BonusIssueEventAllOf.

        Possible LapseElections for this Bonus Issue event, if any.  # noqa: E501

        :param lapse_elections: The lapse_elections of this BonusIssueEventAllOf.  # noqa: E501
        :type lapse_elections: list[lusid.LapseElection]
        """
    ...
    def instrument_event_type(self):
        """Gets the instrument_event_type of this BonusIssueEventAllOf.  # noqa: E501

        The Type of Event. The available values are: TransitionEvent, InformationalEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent, AmortisationEvent, CashFlowEvent, ExerciseEvent, ResetEvent, TriggerEvent, RawVendorEvent, InformationalErrorEvent, BondCouponEvent, DividendReinvestmentEvent, AccumulationEvent, BondPrincipalEvent, DividendOptionEvent, MaturityEvent, FxForwardSettlementEvent, ExpiryEvent, ScripDividendEvent, StockDividendEvent, ReverseStockSplitEvent, CapitalDistributionEvent, SpinOffEvent, MergerEvent, FutureExpiryEvent, SwapCashFlowEvent, SwapPrincipalEvent, CreditPremiumCashFlowEvent, CdsCreditEvent, CdxCreditEvent, MbsCouponEvent, MbsPrincipalEvent, BonusIssueEvent, MbsPrincipalWriteOffEvent, MbsInterestDeferralEvent, MbsInterestShortfallEvent, TenderEvent, CallOnIntermediateSecuritiesEvent, IntermediateSecuritiesDistributionEvent, OptionExercisePhysicalEvent, OptionExerciseCashEvent, ProtectionPayoutCashFlowEvent, TermDepositInterestEvent, TermDepositPrincipalEvent  # noqa: E501

        :return: The instrument_event_type of this BonusIssueEventAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def instrument_event_type(self, instrument_event_type):
        """Sets the instrument_event_type of this BonusIssueEventAllOf.

        The Type of Event. The available values are: TransitionEvent, InformationalEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent, AmortisationEvent, CashFlowEvent, ExerciseEvent, ResetEvent, TriggerEvent, RawVendorEvent, InformationalErrorEvent, BondCouponEvent, DividendReinvestmentEvent, AccumulationEvent, BondPrincipalEvent, DividendOptionEvent, MaturityEvent, FxForwardSettlementEvent, ExpiryEvent, ScripDividendEvent, StockDividendEvent, ReverseStockSplitEvent, CapitalDistributionEvent, SpinOffEvent, MergerEvent, FutureExpiryEvent, SwapCashFlowEvent, SwapPrincipalEvent, CreditPremiumCashFlowEvent, CdsCreditEvent, CdxCreditEvent, MbsCouponEvent, MbsPrincipalEvent, BonusIssueEvent, MbsPrincipalWriteOffEvent, MbsInterestDeferralEvent, MbsInterestShortfallEvent, TenderEvent, CallOnIntermediateSecuritiesEvent, IntermediateSecuritiesDistributionEvent, OptionExercisePhysicalEvent, OptionExerciseCashEvent, ProtectionPayoutCashFlowEvent, TermDepositInterestEvent, TermDepositPrincipalEvent  # noqa: E501

        :param instrument_event_type: The instrument_event_type of this BonusIssueEventAllOf.  # noqa: E501
        :type instrument_event_type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BonusIssueEventAllOf):
            return False
