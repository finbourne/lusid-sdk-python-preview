...
class DateAttributes(object):
    ...
    required_map = {
        ...
        'first_open': 'required',
        'last_open': 'required',
        'first_close': 'required',
        'last_close': 'required'
    }

    def __init__(self, irregular=None, irregular_session=None, new_hours=None, activity=None, first_open=None, last_open=None, first_close=None, last_close=None):  # noqa: E501
        """
        ...
        :type activity: str
        :param first_open:  (required)
        :type first_open: str
        :param last_open:  (required)
        :type last_open: str
        :param first_close:  (required)
        :type first_close: str
        :param last_close:  (required)
        :type last_close: str
    ...
    def first_open(self, first_open):
        ...
        if first_open is None:
            raise ValueError("Invalid value for `first_open`, must not be `None`")  # noqa: E501
        if first_open is not None and len(first_open) > 100:
            raise ValueError("Invalid value for `first_open`, length must be less than or equal to `100`")  # noqa: E501
        if first_open is not None and len(first_open) < 0:
    ...
    def last_open(self, last_open):
        ...
        if last_open is None:
            raise ValueError("Invalid value for `last_open`, must not be `None`")  # noqa: E501
        if last_open is not None and len(last_open) > 100:
            raise ValueError("Invalid value for `last_open`, length must be less than or equal to `100`")  # noqa: E501
        if last_open is not None and len(last_open) < 0:
    ...
    def first_close(self, first_close):
        ...
        if first_close is None:
            raise ValueError("Invalid value for `first_close`, must not be `None`")  # noqa: E501
        if first_close is not None and len(first_close) > 100:
            raise ValueError("Invalid value for `first_close`, length must be less than or equal to `100`")  # noqa: E501
        if first_close is not None and len(first_close) < 0:
    ...
    def last_close(self, last_close):
        ...
        if last_close is None:
            raise ValueError("Invalid value for `last_close`, must not be `None`")  # noqa: E501
        if last_close is not None and len(last_close) > 100:
