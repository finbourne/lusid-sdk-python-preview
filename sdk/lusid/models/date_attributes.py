...
class DateAttributes(object):
    ...
    def activity(self, activity):
        ...
        if (activity is not None and not re.search(r'^[a-zA-Z0-9\-_]+$', activity)):  # noqa: E501
    ...
    def first_open(self, first_open):
        ...
        if (first_open is not None and not re.search(r'^[a-zA-Z0-9\-_]+$', first_open)):  # noqa: E501
    ...
    def last_open(self, last_open):
        ...
        if (last_open is not None and not re.search(r'^[a-zA-Z0-9\-_]+$', last_open)):  # noqa: E501
    ...
    def first_close(self, first_close):
        ...
        if (first_close is not None and not re.search(r'^[a-zA-Z0-9\-_]+$', first_close)):  # noqa: E501
    ...
    def last_close(self, last_close):
        ...
        if (last_close is not None and not re.search(r'^[a-zA-Z0-9\-_]+$', last_close)):  # noqa: E501
