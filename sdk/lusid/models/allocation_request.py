...
class AllocationRequest(object):
    ...
    def __init__(self, properties=None, instrument_identifiers=None, quantity=None, portfolio_id=None, allocated_order_id=None, code=None):  # noqa: E501
        """
        ...
        :param code:  Uniquely identifies this allocation. (required)
        :type code: str
    ...
    @property
    def code(self):
        """Gets the code of this AllocationRequest.  # noqa: E501

        Uniquely identifies this allocation.  # noqa: E501

        :return: The code of this AllocationRequest.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this AllocationRequest.

        Uniquely identifies this allocation.  # noqa: E501

        :param code: The code of this AllocationRequest.  # noqa: E501
        :type: str
        """
        if code is None:
