...
class AggregationQuery(object):
    ...
    def __init__(self, address_key=None, description=None, display_name=None, type=None, scales_with_holding_quantity=None, supported_operations=None, life_cycle_status=None, removal_date=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param type:  The available values are: String, Int, Decimal, DateTime, Boolean, ResultValue, Result0D, Array, Map, Json (required)
        :type type: str
    ...
    def type(self):
        ...
        The available values are: String, Int, Decimal, DateTime, Boolean, ResultValue, Result0D, Array, Map, Json  # noqa: E501
    ...
    def type(self, type):
        ...
        allowed_values = ["String", "Int", "Decimal", "DateTime", "Boolean", "ResultValue", "Result0D", "Array", "Map", "Json"]  # noqa: E501
