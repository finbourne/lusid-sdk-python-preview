...
class AggregationQuery(object):
    ...
    def __init__(self, address_key=None, description=None, display_name=None, type=None, flattened_type=None, scales_with_holding_quantity=None, supported_operations=None, life_cycle_status=None, removal_date=None, local_vars_configuration=None):  # noqa: E501
