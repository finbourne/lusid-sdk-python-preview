...
class HoldingAdjustment(object):
    ...
    def __init__(self, instrument_identifiers=None, instrument_uid=None, sub_holding_keys=None, properties=None, tax_lots=None, local_vars_configuration=None):  # noqa: E501
        """
