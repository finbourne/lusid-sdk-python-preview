...
class HoldingAdjustment(object):
    ...
    openapi_types = {
        ...
        'instrument_uid': 'str',
        'sub_holding_keys': 'list[PerpetualProperty]',
    ...
    def __init__(self, instrument_identifiers=None, instrument_uid=None, sub_holding_keys=None, properties=None, tax_lots=None):  # noqa: E501
        """HoldingAdjustment - a model defined in OpenAPI"""  # noqa: E501
    ...
    def sub_holding_keys(self):
        ...
        The set of unique transaction properties and associated values stored with the holding adjustment transactions automatically created by LUSID. Each property will be from the 'Trade' domain.  # noqa: E501
