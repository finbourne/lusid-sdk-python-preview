...
class Counterparty(object):
    ...
    def __init__(self, counterparty_id=None, counterparty_name=None, country_of_risk=None, issuer_ratings=None, industry_scheme=None, scope=None, code=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type issuer_ratings: list[CreditRating]
        :param industry_scheme:  (required)
        :type industry_scheme: IndustryClassificationScheme
    ...
    def counterparty_id(self, counterparty_id):
        ...
        :type counterparty_id: str
        """
        if self.local_vars_configuration.client_side_validation and counterparty_id is None:  # noqa: E501
    ...
    def counterparty_name(self, counterparty_name):
        ...
        :type counterparty_name: str
        """
        if self.local_vars_configuration.client_side_validation and counterparty_name is None:  # noqa: E501
    ...
    def issuer_ratings(self, issuer_ratings):
        ...
        :type issuer_ratings: list[CreditRating]
        """
        if self.local_vars_configuration.client_side_validation and issuer_ratings is None:  # noqa: E501
    ...
    def industry_scheme(self, industry_scheme):
        ...
        :type industry_scheme: IndustryClassificationScheme
        """
        if self.local_vars_configuration.client_side_validation and industry_scheme is None:  # noqa: E501
