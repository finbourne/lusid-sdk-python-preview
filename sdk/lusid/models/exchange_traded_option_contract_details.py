...
class ExchangeTradedOptionContractDetails(object):
    ...
    attribute_map = {
        ...
        'settlement_calendars': 'settlementCalendars'
    }
    ...
    def __init__(self, dom_ccy=None, strike=None, contract_size=None, country=None, delivery_type=None, description=None, exchange_code=None, exercise_date=None, exercise_type=None, option_code=None, option_type=None, underlying=None, underlying_code=None, delivery_days=None, business_day_convention=None, settlement_calendars=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param exercise_date:  The last exercise date of the option. (required)
        ...
        :param delivery_days:  Number of business days between exercise date and settlement of the option payoff or underlying.
        :type delivery_days: int
        :param business_day_convention:  The adjustment type to apply to dates that fall upon a non-business day, e.g. modified following or following.  Supported string (enumeration) values are: [NoAdjustment, Previous, P, Following, F, ModifiedPrevious, MP, ModifiedFollowing, MF, HalfMonthModifiedFollowing, Nearest].
        :type business_day_convention: str
        :param settlement_calendars:  An array of strings denoting calendars used in calculating the option settlement date.
        :type settlement_calendars: list[str]
        ...
        self._settlement_calendars = None
        ...
        self.settlement_calendars = settlement_calendars
    ...
    def exercise_date(self):
        ...
        The last exercise date of the option.  # noqa: E501
    ...
    def option_code(self, option_code):
        ...
        if (self.local_vars_configuration.client_side_validation and
                option_code is not None and len(option_code) < 1):
            raise ValueError("Invalid value for `option_code`, length must be greater than or equal to `1`")  # noqa: E501
    ...
    def underlying_code(self, underlying_code):
        ...
        if (self.local_vars_configuration.client_side_validation and
                underlying_code is not None and len(underlying_code) < 1):
            raise ValueError("Invalid value for `underlying_code`, length must be greater than or equal to `1`")  # noqa: E501

        self._underlying_code = underlying_code

    @property
    def delivery_days(self):
        """Gets the delivery_days of this ExchangeTradedOptionContractDetails.  # noqa: E501

        Number of business days between exercise date and settlement of the option payoff or underlying.  # noqa: E501

        :return: The delivery_days of this ExchangeTradedOptionContractDetails.  # noqa: E501
        :rtype: int
        """
    ...
    def delivery_days(self, delivery_days):
        """Sets the delivery_days of this ExchangeTradedOptionContractDetails.

        Number of business days between exercise date and settlement of the option payoff or underlying.  # noqa: E501

        :param delivery_days: The delivery_days of this ExchangeTradedOptionContractDetails.  # noqa: E501
        :type delivery_days: int
        """
    ...
    def business_day_convention(self):
        """Gets the business_day_convention of this ExchangeTradedOptionContractDetails.  # noqa: E501
        ...
        :return: The business_day_convention of this ExchangeTradedOptionContractDetails.  # noqa: E501
        :rtype: str
        """
    ...
    def business_day_convention(self, business_day_convention):
        """Sets the business_day_convention of this ExchangeTradedOptionContractDetails.

        The adjustment type to apply to dates that fall upon a non-business day, e.g. modified following or following.  Supported string (enumeration) values are: [NoAdjustment, Previous, P, Following, F, ModifiedPrevious, MP, ModifiedFollowing, MF, HalfMonthModifiedFollowing, Nearest].  # noqa: E501

        :param business_day_convention: The business_day_convention of this ExchangeTradedOptionContractDetails.  # noqa: E501
        :type business_day_convention: str
        """
    ...
    def settlement_calendars(self):
        """Gets the settlement_calendars of this ExchangeTradedOptionContractDetails.  # noqa: E501

        An array of strings denoting calendars used in calculating the option settlement date.  # noqa: E501

        :return: The settlement_calendars of this ExchangeTradedOptionContractDetails.  # noqa: E501
        :rtype: list[str]
        """
        return self._settlement_calendars

    @settlement_calendars.setter
    def settlement_calendars(self, settlement_calendars):
        """Sets the settlement_calendars of this ExchangeTradedOptionContractDetails.

        An array of strings denoting calendars used in calculating the option settlement date.  # noqa: E501

        :param settlement_calendars: The settlement_calendars of this ExchangeTradedOptionContractDetails.  # noqa: E501
        :type settlement_calendars: list[str]
        """

        self._settlement_calendars = settlement_calendars
