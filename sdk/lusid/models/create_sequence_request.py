...
class CreateSequenceRequest(object):
    ...
    def pattern(self, pattern):
        ...
        if (self.local_vars_configuration.client_side_validation and
                pattern is not None and not re.search(r'^[a-zA-Z0-9\-_]+$', pattern)):  # noqa: E501
            raise ValueError(r"Invalid value for `pattern`, must be a follow pattern or equal to `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
