...
class CreateSequenceRequest(object):
    ...
    def __init__(self, code=None, increment=None, min_value=None, max_value=None, start=None, cycle=None, links=None, local_vars_configuration=None):  # noqa: E501
        """CreateSequenceRequest - a model defined in OpenAPI"
        
        :param code:  Code of the sequence (required)
        :type code: str
    ...
    def code(self):
        ...
        Code of the sequence  # noqa: E501
