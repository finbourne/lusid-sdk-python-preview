...
class ComplianceRunInfo(object):
    ...
    def __init__(self, run_id=None, instigated_at=None, completed_at=None, schedule=None, all_rules_passed=None, as_at=None, local_vars_configuration=None):  # noqa: E501
