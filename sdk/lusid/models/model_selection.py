...
class ModelSelection(object):
    ...
    def __init__(self, library=None, model=None):  # noqa: E501
        ...
        :param library:  Which library is used for pricing requests (required)
        :type library: str
        :param model:  Which model should be used for pricing requests (required)
        :type model: str
    ...
    def library(self):
        ...
        Which library is used for pricing requests  # noqa: E501
    ...
    def model(self):
        ...
        Which model should be used for pricing requests  # noqa: E501
    ...
    def model(self, model):
        ...
        allowed_values = ["SimpleStatic", "Discounting", "VendorDefault"]  # noqa: E501
