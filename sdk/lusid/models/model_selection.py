...
class ModelSelection(object):
    ...
    def __init__(self, library=None, model=None):  # noqa: E501
        ...
        :type library: str
        :param model:  The available values are: SimpleStatic, Discounting, VendorDefault, BlackScholes, ConstantTimeValueOfMoney, Bachelier (required)
        :type model: str
    ...
    def model(self):
        ...
        The available values are: SimpleStatic, Discounting, VendorDefault, BlackScholes, ConstantTimeValueOfMoney, Bachelier  # noqa: E501
    ...
    def model(self, model):
        ...
        allowed_values = ["SimpleStatic", "Discounting", "VendorDefault", "BlackScholes", "ConstantTimeValueOfMoney", "Bachelier"]  # noqa: E501
