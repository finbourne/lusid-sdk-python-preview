...
class BondAllOf(object):
    ...
    def __init__(self, start_date=None, maturity_date=None, dom_ccy=None, flow_conventions=None, principal=None, coupon_rate=None, identifiers=None, ex_dividend_days=None, initial_coupon_date=None, first_coupon_pay_date=None, calculation_type=None, instrument_type=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param start_date:  The start date of the instrument. This is normally synonymous with the trade-date. If settle days = 0 then this is the initial accrual date of the bond. (required)
        ...
        :param initial_coupon_date:  The initial coupon date is in fact the previous coupon pay date in the bond schedule. This date specifies the start of the coupon period in which the ex-dividend date lies.
    ...
    def start_date(self):
        ...
        The start date of the instrument. This is normally synonymous with the trade-date. If settle days = 0 then this is the initial accrual date of the bond.  # noqa: E501
    ...
    def initial_coupon_date(self):
        ...
        The initial coupon date is in fact the previous coupon pay date in the bond schedule. This date specifies the start of the coupon period in which the ex-dividend date lies.  # noqa: E501
