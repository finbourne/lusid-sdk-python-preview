...
class InformationalEventAllOf(object):
    ...
    def __init__(self, event_type=None, event_status=None, anchor_date=None, event_window_end=None, diagnostics=None, instrument_event_type=None, local_vars_configuration=None):  # noqa: E501
        """InformationalEventAllOf - a model defined in OpenAPI"
    ...
    @property
    def event_type(self):
        """Gets the event_type of this InformationalEventAllOf.  # noqa: E501

        What type of internal event does this represent; reset, exercise, amortisation etc.  # noqa: E501

        :return: The event_type of this InformationalEventAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def event_type(self, event_type):
        """Sets the event_type of this InformationalEventAllOf.

        What type of internal event does this represent; reset, exercise, amortisation etc.  # noqa: E501

        :param event_type: The event_type of this InformationalEventAllOf.  # noqa: E501
        :type event_type: str
        """
    ...
    def event_status(self):
        """Gets the event_status of this InformationalEventAllOf.  # noqa: E501

        What is the event status, is it a known (ie historic) or unknown (ie projected) event?  # noqa: E501

        :return: The event_status of this InformationalEventAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def event_status(self, event_status):
        """Sets the event_status of this InformationalEventAllOf.

        What is the event status, is it a known (ie historic) or unknown (ie projected) event?  # noqa: E501

        :param event_status: The event_status of this InformationalEventAllOf.  # noqa: E501
        :type event_status: str
        """
    ...
    def anchor_date(self):
        """Gets the anchor_date of this InformationalEventAllOf.  # noqa: E501
        ...
        :return: The anchor_date of this InformationalEventAllOf.  # noqa: E501
        :rtype: datetime
        """
    ...
    def anchor_date(self, anchor_date):
        """Sets the anchor_date of this InformationalEventAllOf.

        In the case of a point event, the single date on which the event occurs. In the case of an event which is  spread over a window, e.g. a barrier or American option, the start of that window.  # noqa: E501

        :param anchor_date: The anchor_date of this InformationalEventAllOf.  # noqa: E501
        :type anchor_date: datetime
        """
    ...
    def event_window_end(self):
        """Gets the event_window_end of this InformationalEventAllOf.  # noqa: E501
        ...
        :return: The event_window_end of this InformationalEventAllOf.  # noqa: E501
        :rtype: datetime
        """
    ...
    def event_window_end(self, event_window_end):
        """Sets the event_window_end of this InformationalEventAllOf.

        In the case of a point event this is identical to the anchor date. In the case of an event that is spread over a window,  this is the end of that window.  # noqa: E501

        :param event_window_end: The event_window_end of this InformationalEventAllOf.  # noqa: E501
        :type event_window_end: datetime
        """
    ...
    def diagnostics(self):
        """Gets the diagnostics of this InformationalEventAllOf.  # noqa: E501


        :return: The diagnostics of this InformationalEventAllOf.  # noqa: E501
    ...
    def diagnostics(self, diagnostics):
        """Sets the diagnostics of this InformationalEventAllOf.


        :param diagnostics: The diagnostics of this InformationalEventAllOf.  # noqa: E501
        :type diagnostics: lusid.ResultValueDictionary
        """
    ...
    def instrument_event_type(self):
        """Gets the instrument_event_type of this InformationalEventAllOf.  # noqa: E501
        ...
        :return: The instrument_event_type of this InformationalEventAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def instrument_event_type(self, instrument_event_type):
        """Sets the instrument_event_type of this InformationalEventAllOf.

        The Type of Event. The available values are: TransitionEvent, InformationalEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent, AmortisationEvent, CashFlowEvent, ExerciseEvent, ResetEvent  # noqa: E501

        :param instrument_event_type: The instrument_event_type of this InformationalEventAllOf.  # noqa: E501
        :type instrument_event_type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InformationalEventAllOf):
            return False
