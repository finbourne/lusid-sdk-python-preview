...
class InformationalEventAllOf(object):
    ...
    def __init__(self, event_type=None, anchor_date=None, event_window_end=None, diagnostics=None, instrument_event_type=None, local_vars_configuration=None):  # noqa: E501
