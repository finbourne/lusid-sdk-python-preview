...
class TransactionTemplateSpecification(object):
    ...
    def __init__(self, instrument_event_type=None, supported_instrument_types=None, supported_participation_types=None, supported_election_types=None, supported_template_fields=None, local_vars_configuration=None):  # noqa: E501
