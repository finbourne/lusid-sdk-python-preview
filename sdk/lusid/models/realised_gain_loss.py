...
class RealisedGainLoss(object):
    ...
    def __init__(self, instrument_uid=None, units=None, purchase_trade_date=None, purchase_settlement_date=None, purchase_price=None, cost_trade_ccy=None, cost_portfolio_ccy=None, realised_trade_ccy=None, realised_total=None, realised_market=None, realised_currency=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type cost_trade_ccy: CurrencyAndAmount
        :param cost_portfolio_ccy:  (required)
        :type cost_portfolio_ccy: CurrencyAndAmount
        :param realised_trade_ccy:  (required)
        :type realised_trade_ccy: CurrencyAndAmount
        :param realised_total:  (required)
        :type realised_total: CurrencyAndAmount
        :param realised_market: 
        :type realised_market: CurrencyAndAmount
        :param realised_currency: 
        :type realised_currency: CurrencyAndAmount
