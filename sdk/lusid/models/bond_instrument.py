...
class BondInstrument(object):
    ...
    def __init__(self, start_date=None, maturity_date=None, dom_ccy=None, coupon_rate=None, principal=None, flow_conventions=None, instrument_type=None, local_vars_configuration=None):  # noqa: E501
        """
