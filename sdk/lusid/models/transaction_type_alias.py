...
class TransactionTypeAlias(object):
    ...
    def transaction_roles(self, transaction_roles):
        ...
        if (self.local_vars_configuration.client_side_validation and
                transaction_roles is not None and len(transaction_roles) < 1):
            raise ValueError("Invalid value for `transaction_roles`, length must be greater than or equal to `1`")  # noqa: E501
