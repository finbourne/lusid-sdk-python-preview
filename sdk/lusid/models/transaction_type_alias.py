...
class TransactionTypeAlias(object):
    ...
    def transaction_class(self, transaction_class):
        ...
        if (self.local_vars_configuration.client_side_validation and
                transaction_class is not None and len(transaction_class) > 256):
            raise ValueError("Invalid value for `transaction_class`, length must be less than or equal to `256`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
        ...
        if (self.local_vars_configuration.client_side_validation and
                transaction_class is not None and not re.search(r'^[^\\<>&"]+$', transaction_class)):  # noqa: E501
            raise ValueError(r"Invalid value for `transaction_class`, must be a follow pattern or equal to `/^[^\\<>&"]+$/`")  # noqa: E501
