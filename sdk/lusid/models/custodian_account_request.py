...
class CustodianAccountRequest(object):
    ...
    def __init__(self, scope=None, code=None, status=None, account_number=None, account_name=None, accounting_method=None, currency=None, properties=None, custodian_identifier=None, account_type=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type code: str
        :param status:  The Account status. Can be Active, Inactive or Deleted.
        :type status: str
    ...
    def scope(self, scope):
        ...
        if (self.local_vars_configuration.client_side_validation and
                scope is not None and len(scope) < 0):
            raise ValueError("Invalid value for `scope`, length must be greater than or equal to `0`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def status(self):
        ...
        The Account status. Can be Active, Inactive or Deleted.  # noqa: E501
