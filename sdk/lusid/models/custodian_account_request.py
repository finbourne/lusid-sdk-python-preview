...
class CustodianAccountRequest(object):
    ...
    def __init__(self, scope=None, code=None, status=None, account_number=None, account_name=None, accounting_method=None, currency=None, properties=None, custodian_identifier=None, local_vars_configuration=None):  # noqa: E501
