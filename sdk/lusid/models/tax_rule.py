...
class TaxRule(object):
    ...
    def __init__(self, name=None, description=None, rate=None, criteria=None, links=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param rate:  The rate to be applied if all conditions are met (required)
        :type rate: float
        :param criteria:  A set of conditions to be met for this rule to be applied (required)
        :type criteria: list[lusid.PropertyCriterion]
    ...
    def rate(self):
        ...
        The rate to be applied if all conditions are met  # noqa: E501
    ...
    @property
    def criteria(self):
        """Gets the criteria of this TaxRule.  # noqa: E501

        A set of conditions to be met for this rule to be applied  # noqa: E501

        :return: The criteria of this TaxRule.  # noqa: E501
        :rtype: list[lusid.PropertyCriterion]
        """
        return self._criteria

    @criteria.setter
    def criteria(self, criteria):
        """Sets the criteria of this TaxRule.

        A set of conditions to be met for this rule to be applied  # noqa: E501

        :param criteria: The criteria of this TaxRule.  # noqa: E501
        :type criteria: list[lusid.PropertyCriterion]
        """
