...
class TaxRule(object):
    ...
    def __init__(self, name=None, description=None, rate=None, match_criteria=None, local_vars_configuration=None):  # noqa: E501
    ...
    def match_criteria(self, match_criteria):
        ...
        if (self.local_vars_configuration.client_side_validation and
                match_criteria is not None and len(match_criteria) > 20):
            raise ValueError("Invalid value for `match_criteria`, number of items must be less than or equal to `20`")  # noqa: E501
