...
class CreateDerivedPropertyDefinitionRequest(object):
    ...
    def __init__(self, domain=None, scope=None, code=None, display_name=None, data_type_id=None, derivation=None):  # noqa: E501
        """
        ...
        :param derivation:  The string that contains the rule for the derived property.
        :type derivation: str
    ...
    @property
    def derivation(self):
        """Gets the derivation of this CreateDerivedPropertyDefinitionRequest.  # noqa: E501

        The string that contains the rule for the derived property.  # noqa: E501

        :return: The derivation of this CreateDerivedPropertyDefinitionRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def derivation(self, derivation):
        """Sets the derivation of this CreateDerivedPropertyDefinitionRequest.

        The string that contains the rule for the derived property.  # noqa: E501

        :param derivation: The derivation of this CreateDerivedPropertyDefinitionRequest.  # noqa: E501
        :type: str
        """
