...
class GroupOfMarketDataKeyRules(object):
    ...
    def __init__(self, market_data_key_rule_group_operation=None, market_rules=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param market_data_key_rule_group_operation:  The operation that will be used to process the collection of market data items and failures found on resolution  into a single market data item or failure to be used. (required)
    ...
    def market_data_key_rule_group_operation(self):
        ...
        The operation that will be used to process the collection of market data items and failures found on resolution  into a single market data item or failure to be used.  # noqa: E501
