...
class UpsertInstrumentEventRequest(object):
    ...
    def __init__(self, instrument_event_id=None, instrument_identifiers=None, description=None, event_detail=None, properties=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param event_detail:  (required)
        :type event_detail: lusid.InstrumentEvent
    ...
    def event_detail(self):
        """Gets the event_detail of this UpsertInstrumentEventRequest.  # noqa: E501


        :return: The event_detail of this UpsertInstrumentEventRequest.  # noqa: E501
    ...
    def event_detail(self, event_detail):
        """Sets the event_detail of this UpsertInstrumentEventRequest.


        :param event_detail: The event_detail of this UpsertInstrumentEventRequest.  # noqa: E501
        :type event_detail: lusid.InstrumentEvent
        """
        if self.local_vars_configuration.client_side_validation and event_detail is None:  # noqa: E501
            raise ValueError("Invalid value for `event_detail`, must not be `None`")  # noqa: E501
