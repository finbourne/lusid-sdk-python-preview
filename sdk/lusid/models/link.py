...
class Link(object):
    ...
    def relation(self, relation):
        ...
        allowed_values = ["Root", "Properties", "Transactions", "Details", "Constituents", "Holdings", "Commands", "HoldingsAdjustments", "Parent", "PropertySchema", "EntitySchema", "NextPage", "PreviousPage", "Quote", "ConstituentsAdjustments", "Values"]  # noqa: E501
    ...
    def method(self, method):
        ...
        allowed_values = ["POST", "GET", "PATCH", "DELETE"]  # noqa: E501
