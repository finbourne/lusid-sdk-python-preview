...
class SecurityElection(object):
    ...
    def __init__(self, election_key=None, is_chosen=None, is_default=None, price=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param price:  Price per unit of the security. (required)
        :type price: float
    ...
    def price(self):
        ...
        Price per unit of the security.  # noqa: E501
