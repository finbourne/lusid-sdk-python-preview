...
class SecurityElection(object):
    ...
    def __init__(self, election_key=None, is_chosen=None, is_default=None, price=None, units_ratio=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param price:  Price per unit of the security. At least one of UnitsRatio or Price must be provided. (required)
        :type price: float
        :param units_ratio: 
    ...
    def price(self):
        ...
        Price per unit of the security. At least one of UnitsRatio or Price must be provided.  # noqa: E501
