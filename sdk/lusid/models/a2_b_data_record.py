...
class A2BDataRecord(object):
    ...
    def __init__(self, holding_type=None, instrument_uid=None, sub_holding_keys=None, currency=None, transaction_id=None, start=None, flows=None, gains=None, carry=None, end=None, properties=None, local_vars_configuration=None):  # noqa: E501
