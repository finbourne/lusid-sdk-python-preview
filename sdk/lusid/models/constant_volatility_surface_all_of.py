...
class ConstantVolatilitySurfaceAllOf(object):
    ...
    def __init__(self, base_date=None, asset_type=None, lineage=None, volatility=None, market_data_type=None, local_vars_configuration=None):  # noqa: E501
        """ConstantVolatilitySurfaceAllOf - a model defined in OpenAPI"
    ...
    @property
    def base_date(self):
        """Gets the base_date of this ConstantVolatilitySurfaceAllOf.  # noqa: E501

        Base date of the engine - this is the reference date for resolution of tenors.  # noqa: E501

        :return: The base_date of this ConstantVolatilitySurfaceAllOf.  # noqa: E501
        :rtype: datetime
        """
    ...
    def base_date(self, base_date):
        """Sets the base_date of this ConstantVolatilitySurfaceAllOf.

        Base date of the engine - this is the reference date for resolution of tenors.  # noqa: E501

        :param base_date: The base_date of this ConstantVolatilitySurfaceAllOf.  # noqa: E501
        :type base_date: datetime
        """
    ...
    @property
    def asset_type(self):
        """Gets the asset_type of this ConstantVolatilitySurfaceAllOf.  # noqa: E501
        ...
        :return: The asset_type of this ConstantVolatilitySurfaceAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def asset_type(self, asset_type):
        """Sets the asset_type of this ConstantVolatilitySurfaceAllOf.

        What is the asset that the engine is for.  Supported string (enumeration) values are: [Cash, Commodity, Credit, Equity, Fx, Rates, FxVol, IrVol, EquityVol, HolidayCalendar, IndexConvention, FlowConvention, CdsFlowConvention, CorporateActions, FxForwards, Quote, Inflation, EquityCurve, All, VendorOpaque].  # noqa: E501

        :param asset_type: The asset_type of this ConstantVolatilitySurfaceAllOf.  # noqa: E501
        :type asset_type: str
        """
    ...
    @property
    def lineage(self):
        """Gets the lineage of this ConstantVolatilitySurfaceAllOf.  # noqa: E501


        :return: The lineage of this ConstantVolatilitySurfaceAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def lineage(self, lineage):
        """Sets the lineage of this ConstantVolatilitySurfaceAllOf.


        :param lineage: The lineage of this ConstantVolatilitySurfaceAllOf.  # noqa: E501
        :type lineage: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def volatility(self):
        """Gets the volatility of this ConstantVolatilitySurfaceAllOf.  # noqa: E501

        Volatility value.  # noqa: E501

        :return: The volatility of this ConstantVolatilitySurfaceAllOf.  # noqa: E501
        :rtype: float
        """
    ...
    def volatility(self, volatility):
        """Sets the volatility of this ConstantVolatilitySurfaceAllOf.

        Volatility value.  # noqa: E501

        :param volatility: The volatility of this ConstantVolatilitySurfaceAllOf.  # noqa: E501
        :type volatility: float
        """
    ...
    def market_data_type(self):
        """Gets the market_data_type of this ConstantVolatilitySurfaceAllOf.  # noqa: E501

        The available values are: DiscountFactorCurveData, EquityVolSurfaceData, FxVolSurfaceData, IrVolCubeData, OpaqueMarketData, YieldCurveData, FxForwardCurveData, FxForwardPipsCurveData, FxForwardTenorCurveData, FxForwardTenorPipsCurveData, FxForwardCurveByQuoteReference, CreditSpreadCurveData, EquityCurveByPricesData, ConstantVolatilitySurface  # noqa: E501

        :return: The market_data_type of this ConstantVolatilitySurfaceAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def market_data_type(self, market_data_type):
        """Sets the market_data_type of this ConstantVolatilitySurfaceAllOf.

        The available values are: DiscountFactorCurveData, EquityVolSurfaceData, FxVolSurfaceData, IrVolCubeData, OpaqueMarketData, YieldCurveData, FxForwardCurveData, FxForwardPipsCurveData, FxForwardTenorCurveData, FxForwardTenorPipsCurveData, FxForwardCurveByQuoteReference, CreditSpreadCurveData, EquityCurveByPricesData, ConstantVolatilitySurface  # noqa: E501

        :param market_data_type: The market_data_type of this ConstantVolatilitySurfaceAllOf.  # noqa: E501
        :type market_data_type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConstantVolatilitySurfaceAllOf):
            return False
