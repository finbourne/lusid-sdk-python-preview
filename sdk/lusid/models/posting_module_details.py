...
class PostingModuleDetails(object):
    ...
    def __init__(self, display_name=None, description=None, status=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param status:  The Posting Module status. Can be Active or Inactive. Defaults to Active. (required)
        :type status: str
    ...
    def status(self):
        ...
        The Posting Module status. Can be Active or Inactive. Defaults to Active.  # noqa: E501
