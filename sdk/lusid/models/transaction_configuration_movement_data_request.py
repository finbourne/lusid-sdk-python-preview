...
class TransactionConfigurationMovementDataRequest(object):
    ...
    def __init__(self, movement_types=None, side=None, direction=None, properties=None, mappings=None):  # noqa: E501
        """TransactionConfigurationMovementDataRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    def movement_types(self, movement_types):
        ...
        allowed_values = ["Settlement", "Traded", "ForwardFx", "Commitment", "Receivable", "CashSettlement", "Accrual", "UnsettledCashTypes", "StockMovement", "CashCommitment", "CashReceivable", "CashForward", "CashAccrual"]  # noqa: E501
    ...
    def side(self, side):
        ...
        allowed_values = ["Side1", "Side2", "BondInt"]  # noqa: E501
