...
class MovementType(object):
    ...
    allowable_values = [SETTLEMENT, TRADED, STOCKMOVEMENT, FUTURECASH, COMMITMENT, RECEIVABLE, CASHSETTLEMENT, CASHFORWARD, CASHCOMMITMENT, CASHRECEIVABLE, ACCRUAL, CASHACCRUAL, FORWARDFX, CASHFXFORWARD, UNSETTLEDCASHTYPES]  # noqa: E501
