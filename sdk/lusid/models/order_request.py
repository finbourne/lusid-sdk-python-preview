...
class OrderRequest(object):
    ...
    def __init__(self, properties=None, instrument_identifiers=None, quantity=None, side=None, order_book=None, portfolio=None, code=None, local_vars_configuration=None):  # noqa: E501
        """
        ...
        :type side: str
        :param order_book:  (required)
        :type order_book: lusid.ResourceId
    ...
    @property
    def order_book(self):
        """Gets the order_book of this OrderRequest.  # noqa: E501


        :return: The order_book of this OrderRequest.  # noqa: E501
        :rtype: ResourceId
        """
    ...
    def order_book(self, order_book):
        """Sets the order_book of this OrderRequest.


        :param order_book: The order_book of this OrderRequest.  # noqa: E501
        :type: ResourceId
        """
        if self.local_vars_configuration.client_side_validation and order_book is None:  # noqa: E501
            raise ValueError("Invalid value for `order_book`, must not be `None`")  # noqa: E501
