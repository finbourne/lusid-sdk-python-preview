...
class OrderRequest(object):
    ...
    required_map = {
        ...
        'portfolio': 'required',
        'code': 'required',
        'lusid_instrument': 'required'
    }

    def __init__(self, properties=None, instrument_identifiers=None, quantity=None, portfolio=None, code=None, lusid_instrument=None):  # noqa: E501
        """
        ...
        :type code: str
        :param lusid_instrument:  The LUSID instrument id for the instrument ordered. (required)
        :type lusid_instrument: str
        ...
        self.code = code
        self.lusid_instrument = lusid_instrument
    ...
    @property
    def lusid_instrument(self):
        """Gets the lusid_instrument of this OrderRequest.  # noqa: E501

        The LUSID instrument id for the instrument ordered.  # noqa: E501

        :return: The lusid_instrument of this OrderRequest.  # noqa: E501
        :rtype: str
        """
        return self._lusid_instrument

    @lusid_instrument.setter
    def lusid_instrument(self, lusid_instrument):
        """Sets the lusid_instrument of this OrderRequest.

        The LUSID instrument id for the instrument ordered.  # noqa: E501

        :param lusid_instrument: The lusid_instrument of this OrderRequest.  # noqa: E501
        :type: str
        """
        if lusid_instrument is None:
            raise ValueError("Invalid value for `lusid_instrument`, must not be `None`")  # noqa: E501

        self._lusid_instrument = lusid_instrument
