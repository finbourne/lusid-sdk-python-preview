...
class PricingContext(object):
    ...
    def __init__(self, model_rules=None, model_choice=None, options=None, result_data_rules=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type model_rules: list[VendorModelRule]
        ...
        :type model_choice: dict(str, ModelSelection)
        :param options: 
        :type options: PricingOptions
        ...
        :type result_data_rules: list[ResultDataKeyRule]
