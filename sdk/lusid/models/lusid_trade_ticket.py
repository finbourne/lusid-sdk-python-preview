...
class LusidTradeTicket(object):
    ...
    def counterparty(self):
        """Gets the counterparty of this LusidTradeTicket.  # noqa: E501

        Counterparty  # noqa: E501

        :return: The counterparty of this LusidTradeTicket.  # noqa: E501
        :rtype: str
        """
    ...
    def counterparty(self, counterparty):
        """Sets the counterparty of this LusidTradeTicket.

        Counterparty  # noqa: E501

        :param counterparty: The counterparty of this LusidTradeTicket.  # noqa: E501
        :type counterparty: str
        """
        if (self.local_vars_configuration.client_side_validation and
                counterparty is not None and len(counterparty) > 256):
            raise ValueError("Invalid value for `counterparty`, length must be less than or equal to `256`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                counterparty is not None and len(counterparty) < 0):
            raise ValueError("Invalid value for `counterparty`, length must be greater than or equal to `0`")  # noqa: E501
