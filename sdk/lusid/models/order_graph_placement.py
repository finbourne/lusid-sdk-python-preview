...
class OrderGraphPlacement(object):
    ...
    def __init__(self, placement=None, block_id=None, order_ids=None, allocation_ids=None, execution_ids=None, ordered=None, placed=None, executed=None, allocated=None, derived_state=None, calculated_average_price=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param order_ids:  Identifiers for all orders in the block - DEPRECATED: see Ordered. (required)
        :type order_ids: list[lusid.ResourceId]
        :param allocation_ids:  Identifiers for all allocations relating to this placement - DEPRECATED: see Allocated. (required)
        :type allocation_ids: list[lusid.ResourceId]
        :param execution_ids:  Identifiers of all executions against this placement - DEPRECATED: see Executed. (required)
    ...
    def order_ids(self):
        ...
        Identifiers for all orders in the block - DEPRECATED: see Ordered.  # noqa: E501
    ...
    def allocation_ids(self):
        ...
        Identifiers for all allocations relating to this placement - DEPRECATED: see Allocated.  # noqa: E501
    ...
    def execution_ids(self):
        ...
        Identifiers of all executions against this placement - DEPRECATED: see Executed.  # noqa: E501
