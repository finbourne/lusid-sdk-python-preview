...
*TransactionConfigurationApi* | [**list_sides_definition**](docs/TransactionConfigurationApi.md#list_sides_definition) | **GET** /api/transactionconfiguration/sides | [EXPERIMENTAL] ListSidesDefinition: List the side definitions
