...
*CorporateActionSourcesApi* | [**delete_instrument_events**](docs/CorporateActionSourcesApi.md#delete_instrument_events) | **DELETE** /api/corporateactionsources/{scope}/{code}/instrumentevents | [EXPERIMENTAL] DeleteInstrumentEvents: Delete corporate actions (instrument transition events) from the corporate action source.
...
*CorporateActionSourcesApi* | [**get_instrument_events**](docs/CorporateActionSourcesApi.md#get_instrument_events) | **GET** /api/corporateactionsources/{scope}/{code}/instrumentevents | [EXPERIMENTAL] GetInstrumentEvents: Get extrinsic instrument events out of a given corporate actions source.
...
*CorporateActionSourcesApi* | [**upsert_instrument_events**](docs/CorporateActionSourcesApi.md#upsert_instrument_events) | **POST** /api/corporateactionsources/{scope}/{code}/instrumentevents | [EXPERIMENTAL] UpsertInstrumentEvents: Upsert instrument events to the provided corporate actions source.
...
*CustomEntitiesApi* | [**upsert_custom_entities**](docs/CustomEntitiesApi.md#upsert_custom_entities) | **POST** /api/customentities/{entityType}/$batchUpsert | [EXPERIMENTAL] UpsertCustomEntities: Batch upsert instances of Custom Entities
...
*CustomEntityDefinitionsApi* | [**list_custom_entity_definitions**](docs/CustomEntityDefinitionsApi.md#list_custom_entity_definitions) | **GET** /api/customentities/entitytypes | [EXPERIMENTAL] ListCustomEntityDefinitions: List the Custom Entity type definitions
*CustomEntityDefinitionsApi* | [**update_custom_entity_definition**](docs/CustomEntityDefinitionsApi.md#update_custom_entity_definition) | **PUT** /api/customentities/entitytypes/{entityType} | [EXPERIMENTAL] UpdateCustomEntityDefinition: Modify an existing Custom Entity type.
...
*InstrumentsApi* | [**delete_instruments**](docs/InstrumentsApi.md#delete_instruments) | **POST** /api/instruments/$delete | [EXPERIMENTAL] DeleteInstruments: Soft or hard delete multiple instruments
...
*TransactionTaxRulesApi* | [**create_tax_rule_set**](docs/TransactionTaxRulesApi.md#create_tax_rule_set) | **POST** /api/transactions/taxrules | [EXPERIMENTAL] CreateTaxRuleSet: Create a tax rule set.
*TransactionTaxRulesApi* | [**delete_tax_rule_set**](docs/TransactionTaxRulesApi.md#delete_tax_rule_set) | **DELETE** /api/transactions/taxrules/{scope}/{code} | [EXPERIMENTAL] DeleteTaxRuleSet: Deletes a tax rule.
*TransactionTaxRulesApi* | [**get_tax_rule_set**](docs/TransactionTaxRulesApi.md#get_tax_rule_set) | **GET** /api/transactions/taxrules/{scope}/{code} | [EXPERIMENTAL] GetTaxRuleSet: Retrieve the definition of single tax rule set.
*TransactionTaxRulesApi* | [**list_tax_rule_sets**](docs/TransactionTaxRulesApi.md#list_tax_rule_sets) | **GET** /api/transactions/taxrules | [EXPERIMENTAL] ListTaxRuleSets: List tax rules.
*TransactionTaxRulesApi* | [**update_tax_rule_set**](docs/TransactionTaxRulesApi.md#update_tax_rule_set) | **PUT** /api/transactions/taxrules/{scope}/{code} | [EXPERIMENTAL] UpdateTaxRuleSet: Update a tax rule set.
...
## Documentation For Models
 ...
 - [CouponEvent](docs/CouponEvent.md)
 - [CouponEventAllOf](docs/CouponEventAllOf.md)
 ...
 - [CriterionOp](docs/CriterionOp.md)
 ...
 - [InternalEvent](docs/InternalEvent.md)
 - [InternalEventAllOf](docs/InternalEventAllOf.md)
 ...
 - [PropertyCriterion](docs/PropertyCriterion.md)
 ...
 - [StringEqualsCriterion](docs/StringEqualsCriterion.md)
 - [StringEqualsCriterionAllOf](docs/StringEqualsCriterionAllOf.md)
 - [StringInCriterion](docs/StringInCriterion.md)
 - [StringInCriterionAllOf](docs/StringInCriterionAllOf.md)
